...
import {Comune, GetProvince, ISTAT_GetCAP_Request, Provincia} from '../../Model/MetaschemaModel';
...
export class GiasIstatService {
  ...
  constructor(protected apiService: AjaxAgronicaAPIService,) { }
  ...
  /**
   * @deprecated use readProvinces() instead
   */
  ...
  /**
   * @deprecated use readZipCode() instead
   */
  ...
  readZipCode(province: string, city: string): Observable<string> {
