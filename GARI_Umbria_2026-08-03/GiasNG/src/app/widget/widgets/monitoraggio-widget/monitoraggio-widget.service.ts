...
@Injectable()
export class MonitoraggioWidgetService {
    ...
    ApriPlugInMonitoraggio(stazioniDaPassare: Array<any>, stazione: any) {
        ...
        this.gestioneRichiesteService.gestionePassaggioAltroSito_Aperto_in_Iframe(
            ...
            enum_PagineAgenda_2010.Pagina_PlugIn_Monitoraggio,
            ParametriAggiuntivi,
            objParametriAgenda,
            true,
            -1,
