import {enum_LAVCOD} from "./TipiEnumerativi";
...
export const PIVA_LENGTH: number = 11;

export const LOCALIZATION_LANGUAGES: string[] = ['it', 'en', 'fr', 'pt'];

export const TUTTI_CENTRI_AZIENDALI = 0;
...
export const SESSION_LINK_CORE_API = "CoreAPI";
export const SESSION_LINK_NETCORE = "NetCoreAPI";
export const SESSION_LINK_QDCA_COMPLIANCE  = "QdCACompliance";
export const SESSION_LINK_GIAS_BASE = "GiasBase";
export const SESSION_LINK_NETCORE_DATA_EXCHANGE = "NetCoreDataExchange";
export const SESSION_VARIABILISESSIONE = "VariabiliInSessione";
export const SESSION_LINGUA = "lingua";
export const SESSION_TIMEZONEOFFSET = "serverTimeZoneOffset";

export const SESSION_OBJP_SERVER = "objPServer";
export const SESSION_OBJP_UTENTI = "objPUtenti";
export const SESSION_OBJP_SUPER_SERVER = "objPSuperServer";

export const COOKIE_LINGUA = "UserLng";

export const NessunaSpecieQdC = -10;

export const ElencoLavCodRilieviSenzaImpianti: enum_LAVCOD[] = [enum_LAVCOD.RILIEVO_INDICI_MATURITA, enum_LAVCOD.DANNI_RACCOLTA];

//**Operazioni Colturali**//
export const CAU_TRATTAMENTO = "2050";
export const CAU_RILIEVO_CAMPO = "2100";
export const CAU_RILIEVO_RACCOLTA = "2200";
export const CAU_LAVORAZIONE = "2300";
export const CAU_COSTI_ACCESSORI = "2600";
