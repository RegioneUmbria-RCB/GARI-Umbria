...
L.OWM = L.TileLayer.extend({
	options: {
        appId: '4347e6c6d761ee6cd0cc43e68a747058', /* pass your own AppId as parameter when creating the layer. Get your own AppId at https://www.openweathermap.org/appid */
...
L.OWM.Current = L.Class.extend({
	...
	options: {
        appId: '4347e6c6d761ee6cd0cc43e68a747058', // get your free Application ID at www.openweathermap.org
	...
	_createPopup: function(station) {
		...
		if (showLink) {
            ...
            // modificato per non fare il link ad openweather map per il meteo della città
			txt += '<a style="cursor: initial; color: black;" title="' + this.i18n('owmlinktitle', '') + '">';
		}
		txt += station.name;
		if (showLink) {
			txt += '</a>';
...
L.OWM.Utils = {
	...
	i18n: {
		...
		// weather conditions, see https://openweathermap.org/weather-conditions
			, id200: 'Temporale con Pioggia Debole'
			, id201: 'Temporale con Pioggia'
			, id202: 'Temporale con Pioggia Forte'
			, id210: 'Temporale con Schiarite'
			, id211: 'Temporale'
			, id212: 'Forte Temporale'
			, id221: 'Temporale Passeggero'
			, id230: 'Temporale con Pioggerella'
			, id231: 'Temporale con Pioviggine'
			, id232: 'Temporale con Scroscio'

            , id300: 'Acquerugiola'
			, id301: 'Pioggerella'
            , id302: 'Pioggia Debole'
            , id310: 'Pioggerella'
            , id311: 'Pioviggine'
            , id312: 'Pioggia Debole'
			, id321: 'Scroscio'

			, id500: 'Pioggia Debole'
			, id501: 'Pioggia Moderata'
			, id502: 'Pioggia ad Alta Intensità'
			, id503: 'Rovescio'
			, id504: 'Nubifragio'
			, id511: 'Pioggia mista Ghiaccio'
			, id520: 'Acquazzone Leggero'
			, id521: 'Acquazzone'
			, id522: 'Forte Acquazzone'
            ...
            , id611: 'Nevischio'
			, id621: 'Acquaneve'
			, id622: 'Forte Acquaneve'

			, id701: 'Foschia'
			, id711: 'Fumo'
            , id721: 'Nebbiolina'
			, id731: 'Vortice di Sabbia/Polvere'
			, id741: 'Nebbia'
			, id751: 'Sabbia'

			, id800: 'Cielo Limpido'
			, id801: 'Leggermente Nuvoloso'
            , id802: 'Parzialmente Nuvoloso'
			, id803: 'Nuvoloso'
			, id804: 'Coperto'
