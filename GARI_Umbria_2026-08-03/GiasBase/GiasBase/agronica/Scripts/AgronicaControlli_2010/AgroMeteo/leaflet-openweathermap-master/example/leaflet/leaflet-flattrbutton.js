...
L.FlattrButton = L.Control.extend({
	...
	_createButtonImageOrText: function() {
		if (this.options.buttonContent == 'badge') {
			return '<img src="https://api.flattr.com/button/flattr-badge-large.png" '
					+ 'width="93" height="20" '
					+ 'alt="Flattr this" title="Flattr this" border="0" />';
		}
		if (this.options.buttonContent == 'icon') {
			return '<img src="https://api.flattr.com/button/flattr-badge-small.png" '
					+ 'width="16" height="16" '
					+ 'alt="Flattr this" title="Flattr this" border="0" />';
		}
	...
	_createFlattrButtonStatic: function() {
		...
		if (this.options.autosubmit) {
			...
			txt = 'https://flattr.com/thing/' + encodeURIComponent(this.options.flattrId);
		}
	...
	_createFlattrButtonWidget: function() {
		...
		return '<iframe src="https://tools.flattr.net/widgets/thing.html?'
	...
	_counterFunction: function() {
		...
		s.async = true;
		s.src = 'https://api.flattr.com/js/0.6/load.js?mode=auto' + popout + button + params;
		t.appendChild(s);
		this._script = s;
	},
