...
Public Class Rpt_EC_Imballi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_EC_Imballi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_EC_Imballi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_EC_Imballi = New Rpt_EC_Imballi()
        rpt.Site = Me.Site
        Return rpt
    End Function
