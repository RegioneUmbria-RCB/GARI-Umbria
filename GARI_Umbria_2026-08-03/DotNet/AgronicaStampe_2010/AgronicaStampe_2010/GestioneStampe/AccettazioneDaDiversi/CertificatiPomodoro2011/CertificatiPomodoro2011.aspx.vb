...
Public Class CertificatiPomodoro2011
...
#End Region
        ...
        For i = 0 To Num_IdAgenda - 1
            ...
            If Not Me.IsPostBack Then
                ...
                Try
                    ...
                    Stampa_CertificatoPomodoro_2011(DS, _
            ...
            If PrintToPrinter = 0 Then
                ...
                'strPath = PathFileTemporanei & "\" + Nome_Documento + "_" + CStr(Session("ASG_Utente_Username")) + "_" & Session.SessionID.ToString & ".pdf"
                ...
                'Response.AddHeader("Content-Disposition", "inline; filename = CertificatiPomodoro.pdf")
    ...
    Private Sub Salva_Log(ByRef Log_Errori As String, _
        ...
        If Log_Errori <> "" Then
            ...
            objLog.Gestione_LogErrori_Stampe(objParametri_Server, _
                                             ...
                                             "CertificatiPomodoro2011.aspx", _
                                             Log_Errori)
    ...
    '#####################################################################################################
    Private Sub RinominaCaselleDiTesto_2011()

        CType(rptCertificato.Section10.ReportObjects("TxtTitolo"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "INFORMAZIONI RELATIVE ALLA CONSEGNA ALLE INDUSTRIE DI PRODOTTI ORTOFRUTTICOLI - RACCOLTO "
        CType(rptCertificato.Section10.ReportObjects("TxtRegolamento"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = ""

        CType(rptCertificato.Section2.ReportObjects("TxtCodAgreaContratto"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = ""
        CType(rptCertificato.Section2.ReportObjects("TxtClausolaAggiuntiva"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = ""
        CType(rptCertificato.Section2.ReportObjects("TxtClausolaAggiuntiva2"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = ""

        CType(rptCertificato.Section2.ReportObjects("TxtTipologia"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = ""
        CType(rptCertificato.Section2.ReportObjects("TxtTondo"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = ""
        CType(rptCertificato.Section2.ReportObjects("TxtAllungato"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = ""

        CType(rptCertificato.Section2.ReportObjects("TxtPesoLordo"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Peso Lordo Q.li:"
        CType(rptCertificato.Section2.ReportObjects("TxtTaraVeicolo"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Tara Veicolo Q.li:"
        CType(rptCertificato.Section2.ReportObjects("TxtTaraImballi"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Tara Imballi Q.li:"
        CType(rptCertificato.Section2.ReportObjects("TxtPesoNetto"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Peso Netto Q.li:"

        CType(rptCertificato.Section6.ReportObjects("TxtScarto"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Pari ad uno scarto di Q.li:"
        CType(rptCertificato.Section6.ReportObjects("TxtNettoPagamento"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Peso netto a pagamento Q.li:"

        CType(rptCertificato.Section7.ReportObjects("TxtScarto2"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Pari ad uno scarto di Q.li:"
        CType(rptCertificato.Section7.ReportObjects("TxtNettoPagamento2"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Peso netto a pagamento Q.li:"

        'CType(rptCertificato.Section8.ReportObjects("TxtEuro"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Euro/10 Q."
        'CType(rptCertificato.Section8.ReportObjects("TxtEuro2"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = "Euro/10 Q."

    End Sub

    '#####################################################################################################
    Private Sub RinominaCaselleDiTesto_2012()
    ...
    '#####################################################################################################
    Private Sub Stampa_CertificatoPomodoro_2011(ByRef DS As DS_CertificatoPomodoro, _
                ...
                For i = 0 To DT.Rows.Count - 1
                    ...
                    With DT.Rows(i)
                        ...
                        If i = 0 Then
                            ...
                            Select Case CDate(Dr.Data_Accettazione).Year
                                Case 2011, 2012
                                    ...
                                    Dr.Num_Certificato = Ricava_NumeroDocumento_Con_Sequenza( _
                                                            x_Doc_Numero_Sin_Cert, _
                                                            x_Doc_Numero_Cert, _
                            ...
                            Dr.Varieta_Distretto = .Item("Varieta_Distretto")
                        ...
                        If i = DT.Rows.Count - 1 Then
                            ...
                            'Calcola_Dati_Certificato_Pomodoro_2011_TEMP(Peso_Lordo, _
                            '                                            Tara_Veicolo, _
                            '                                            Tara_Imballi, _
                            '                                            Peso_Netto, _
                            '                                            Perc_Marcio, _
