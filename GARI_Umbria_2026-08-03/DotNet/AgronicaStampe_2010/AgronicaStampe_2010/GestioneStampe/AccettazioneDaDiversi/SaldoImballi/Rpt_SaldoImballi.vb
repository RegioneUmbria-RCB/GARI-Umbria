...
Public Class Rpt_SaldoImballi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_SaldoImballi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SaldoImballi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SaldoImballi = New Rpt_SaldoImballi()
        rpt.Site = Me.Site
        Return rpt
    End Function
