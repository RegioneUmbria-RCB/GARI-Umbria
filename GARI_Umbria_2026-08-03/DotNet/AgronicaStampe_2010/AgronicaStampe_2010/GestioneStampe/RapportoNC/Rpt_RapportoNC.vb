...
Public Class Rpt_RapportoNC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaGlobalGap.Rpt_RapportoNC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_RapportoNC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_RapportoNC = New Rpt_RapportoNC()
        rpt.Site = Me.Site
        Return rpt
    End Function
