...
Public Class Rpt_GlobalGap
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaGlobalGap.Rpt_GlobalGap.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property SectionNote() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedRpt_GlobalGap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GlobalGap = New Rpt_GlobalGap()
        rpt.Site = Me.Site
        Return rpt
    End Function
