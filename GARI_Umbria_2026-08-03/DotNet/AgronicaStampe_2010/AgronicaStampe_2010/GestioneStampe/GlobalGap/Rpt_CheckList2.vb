...
Public Class Rpt_CheckList2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaGlobalGap.Rpt_CheckList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_CheckList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CheckList2 = New Rpt_CheckList()
        rpt.Site = Me.Site
        Return rpt
    End Function
