...
Public Class Rpt_Punteggio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaGlobalGap.Rpt_Punteggio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Punteggio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Punteggio = New Rpt_Punteggio()
        rpt.Site = Me.Site
        Return rpt
    End Function
