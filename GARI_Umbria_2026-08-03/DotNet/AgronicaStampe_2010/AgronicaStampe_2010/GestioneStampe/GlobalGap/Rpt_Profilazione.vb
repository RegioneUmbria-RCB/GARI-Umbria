...
Public Class Rpt_Profilazione
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaGlobalGap.Rpt_Profilazione.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Profilazione
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Profilazione = New Rpt_Profilazione()
        rpt.Site = Me.Site
        Return rpt
    End Function
