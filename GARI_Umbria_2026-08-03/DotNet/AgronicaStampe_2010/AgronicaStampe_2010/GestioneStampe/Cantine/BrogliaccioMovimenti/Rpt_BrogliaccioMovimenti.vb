...
Public Class Rpt_BrogliaccioMovimenti
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_BrogliaccioMovimenti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_BrogliaccioMovimenti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FiltroStampa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_BrogliaccioMovimenti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_BrogliaccioMovimenti = New Rpt_BrogliaccioMovimenti()
        rpt.Site = Me.Site
        Return rpt
    End Function
