...
Public Class Rpt_ConsistenzeEnologiche
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_ConsistenzeEnologiche.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_ConsistenzeEnologiche.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ConsistenzeEnologiche
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ConsistenzeEnologiche = New Rpt_ConsistenzeEnologiche()
        rpt.Site = Me.Site
        Return rpt
    End Function
