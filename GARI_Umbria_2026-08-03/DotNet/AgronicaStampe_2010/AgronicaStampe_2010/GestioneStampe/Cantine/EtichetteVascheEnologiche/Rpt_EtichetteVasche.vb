...
Public Class Rpt_EtichetteVasche
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_EtichetteVasche.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_EtichetteVasche.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_EtichetteVasche
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_EtichetteVasche = New Rpt_EtichetteVasche()
        rpt.Site = Me.Site
        Return rpt
    End Function
