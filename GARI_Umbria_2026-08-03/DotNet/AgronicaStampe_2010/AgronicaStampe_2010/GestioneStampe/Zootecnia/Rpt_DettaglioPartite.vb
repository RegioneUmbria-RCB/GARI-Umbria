...
Public Class Rpt_DettaglioPartite
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_DettaglioPartite.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_DettaglioPartite.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_DettaglioPartite
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_DettaglioPartite = New Rpt_DettaglioPartite()
        rpt.Site = Me.Site
        Return rpt
    End Function
