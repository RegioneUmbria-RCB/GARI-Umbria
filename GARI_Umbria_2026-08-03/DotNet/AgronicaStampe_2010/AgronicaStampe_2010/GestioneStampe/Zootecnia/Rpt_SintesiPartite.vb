...
Public Class Rpt_SintesiPartite
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_SintesiPartite.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SintesiPartite
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SintesiPartite = New Rpt_SintesiPartite()
        rpt.Site = Me.Site
        Return rpt
    End Function
