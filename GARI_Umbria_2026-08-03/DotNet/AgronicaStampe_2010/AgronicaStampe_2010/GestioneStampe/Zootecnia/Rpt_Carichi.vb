...
Public Class Rpt_Carichi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Carichi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Carichi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Carichi = New Rpt_Carichi()
        rpt.Site = Me.Site
        Return rpt
    End Function
