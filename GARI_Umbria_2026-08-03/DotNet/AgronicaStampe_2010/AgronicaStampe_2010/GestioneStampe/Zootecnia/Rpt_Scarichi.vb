...
Public Class Rpt_Scarichi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Scarichi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Scarichi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Scarichi = New Rpt_Scarichi()
        rpt.Site = Me.Site
        Return rpt
    End Function
