...
Public Class Rpt_AttoNotorio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_AttoNotorio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_AttoNotorio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_AttoNotorio = New Rpt_AttoNotorio()
        rpt.Site = Me.Site
        Return rpt
    End Function
