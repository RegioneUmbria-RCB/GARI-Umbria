...
Public Class Rpt_SchedaTracciabilita
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_SchedaTracciabilita.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_SchedaTracciabilita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SchedaTracciabilita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SchedaTracciabilita = New Rpt_SchedaTracciabilita()
        rpt.Site = Me.Site
        Return rpt
    End Function
