...
Public Class SottoRpt_Agenda
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.SottoRpt_Agenda.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSottoRpt_Agenda
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SottoRpt_Agenda = New SottoRpt_Agenda()
        rpt.Site = Me.Site
        Return rpt
    End Function
