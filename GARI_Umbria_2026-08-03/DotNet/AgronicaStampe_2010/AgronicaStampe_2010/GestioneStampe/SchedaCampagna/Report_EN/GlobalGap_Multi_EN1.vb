...
Public Class GlobalGap_Multi_EN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.GlobalGap_Multi_EN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGlobalGap_Multi_EN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GlobalGap_Multi_EN = New GlobalGap_Multi_EN()
        rpt.Site = Me.Site
        Return rpt
    End Function
