...
Public Class Rpt_SemineVerticale
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_SemineVerticale.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_SemineVerticale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SemineVerticale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SemineVerticale = New Rpt_SemineVerticale()
        rpt.Site = Me.Site
        Return rpt
    End Function
