...
Public Class Rpt_UsoNonAgricolo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_UsoNonAgricolo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_UsoNonAgricolo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_UsoNonAgricolo = New Rpt_UsoNonAgricolo()
        rpt.Site = Me.Site
        Return rpt
    End Function
