...
Public Class Rpt_Patentino
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Patentino.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Patentino
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Patentino = New Rpt_Patentino()
        rpt.Site = Me.Site
        Return rpt
    End Function
