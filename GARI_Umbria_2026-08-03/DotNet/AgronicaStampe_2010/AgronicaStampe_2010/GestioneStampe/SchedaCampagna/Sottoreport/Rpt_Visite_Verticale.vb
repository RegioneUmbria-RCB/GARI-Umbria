...
Public Class Rpt_Visite_Verticale
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_Visite_Verticale.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Visite_Verticale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Visite_Verticale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Visite_Verticale = New Rpt_Visite_Verticale()
        rpt.Site = Me.Site
        Return rpt
    End Function
