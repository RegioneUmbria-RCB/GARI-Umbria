...
Public Class Rpt_Catasto_Verticale
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_Catasto_Verticale.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Catasto_Verticale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Catasto_Verticale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Catasto_Verticale = New Rpt_Catasto_Verticale()
        rpt.Site = Me.Site
        Return rpt
    End Function
