...
Public Class Rpt_Erbacee
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Erbacee.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Erbacee
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Erbacee = New Rpt_Erbacee()
        rpt.Site = Me.Site
        Return rpt
    End Function
