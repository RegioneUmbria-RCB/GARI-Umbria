...
Public Class Rpt_ParcoMacchine
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_ParcoMacchine.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ParcoMacchine
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ParcoMacchine = New Rpt_ParcoMacchine()
        rpt.Site = Me.Site
        Return rpt
    End Function
