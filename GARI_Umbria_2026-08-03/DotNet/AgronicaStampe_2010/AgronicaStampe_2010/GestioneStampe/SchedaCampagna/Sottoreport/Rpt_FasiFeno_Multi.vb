...
Public Class Rpt_FasiFeno_Multi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_FasiFeno_Multi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_FasiFeno_Multi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_FasiFeno_Multi = New Rpt_FasiFeno_Multi()
        rpt.Site = Me.Site
        Return rpt
    End Function
