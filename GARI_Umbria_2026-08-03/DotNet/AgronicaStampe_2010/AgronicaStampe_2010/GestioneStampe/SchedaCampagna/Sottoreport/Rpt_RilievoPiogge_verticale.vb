...
Public Class Rpt_RilievoPiogge_verticale
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_RilievoPiogge_verticale.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_RilievoPiogge_verticale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_RilievoPiogge_verticale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_RilievoPiogge_verticale = New Rpt_RilievoPiogge_verticale()
        rpt.Site = Me.Site
        Return rpt
    End Function
