...
Public Class Rpt_Catasto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Catasto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Catasto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Catasto = New Rpt_Catasto()
        rpt.Site = Me.Site
        Return rpt
    End Function
