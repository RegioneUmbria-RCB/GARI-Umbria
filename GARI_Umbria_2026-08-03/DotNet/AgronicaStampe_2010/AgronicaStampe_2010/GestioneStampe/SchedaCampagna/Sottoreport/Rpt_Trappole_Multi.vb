...
Public Class Rpt_Trappole_Multi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Trappole_Multi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Trappole_Multi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Trappole_Multi = New Rpt_Trappole_Multi()
        rpt.Site = Me.Site
        Return rpt
    End Function
