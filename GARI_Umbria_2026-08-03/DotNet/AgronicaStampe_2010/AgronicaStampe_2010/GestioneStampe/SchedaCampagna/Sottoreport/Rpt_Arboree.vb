...
Public Class Rpt_Arboree
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Arboree.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Arboree
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Arboree = New Rpt_Arboree()
        rpt.Site = Me.Site
        Return rpt
    End Function
