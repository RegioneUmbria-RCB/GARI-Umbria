...
Public Class report_etichetta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.report_etichetta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_etichetta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_etichetta = New report_etichetta()
        rpt.Site = Me.Site
        Return rpt
    End Function
