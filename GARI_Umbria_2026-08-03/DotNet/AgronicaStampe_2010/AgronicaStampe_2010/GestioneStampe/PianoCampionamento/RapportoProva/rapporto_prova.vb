...
Public Class rapporto_prova
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.rapporto_prova.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrapporto_prova
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rapporto_prova = New rapporto_prova()
        rpt.Site = Me.Site
        Return rpt
    End Function
