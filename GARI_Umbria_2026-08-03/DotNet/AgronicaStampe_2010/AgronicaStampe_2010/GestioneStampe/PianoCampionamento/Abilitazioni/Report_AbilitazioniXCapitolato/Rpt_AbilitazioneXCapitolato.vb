...
Public Class Rpt_AbilitazioneXCapitolato
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_AbilitazioneXCapitolato.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_AbilitazioneXCapitolato.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FiltroRicerca() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_AbilitazioneXCapitolato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_AbilitazioneXCapitolato = New Rpt_AbilitazioneXCapitolato()
        rpt.Site = Me.Site
        Return rpt
    End Function
