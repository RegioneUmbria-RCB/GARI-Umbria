...
Public Class Rpt_RappVerificaIspettiva
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_RappVerificaIspettiva.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaGlobalGap.Rpt_RappVerificaIspettiva.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property IntestazioneDettagliNonConformita() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property DettagliNonConformita() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedRpt_RappVerificaIspettiva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_RappVerificaIspettiva = New Rpt_RappVerificaIspettiva()
        rpt.Site = Me.Site
        Return rpt
    End Function
