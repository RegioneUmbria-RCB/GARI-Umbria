...
Public Class Rpt_LibroConferimenti
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_LibroConferimenti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_LibroConferimenti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_LibroConferimenti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_LibroConferimenti = New Rpt_LibroConferimenti()
        rpt.Site = Me.Site
        Return rpt
    End Function
