...
Public Class Analisi_Progetti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Analisi_Progetti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SopprimiDettaglio() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAnalisi_Progetti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Analisi_Progetti = New Analisi_Progetti()
        rpt.Site = Me.Site
        Return rpt
    End Function
