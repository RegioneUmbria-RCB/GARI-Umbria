...
Public Class Rpt_RegistroRiBa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_RegistroRiBa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_RegistroRiBa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_RegistroRiBa = New Rpt_RegistroRiBa()
        rpt.Site = Me.Site
        Return rpt
    End Function
