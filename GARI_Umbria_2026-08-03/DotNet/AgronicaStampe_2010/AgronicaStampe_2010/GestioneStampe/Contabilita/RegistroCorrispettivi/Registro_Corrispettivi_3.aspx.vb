...
Public Class Registro_Corrispettivi_3
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Me.IsPostBack Then
            ...
            If Log_Errori <> "" Then
                ...
                Log_Errori = Nome_Documento & ", Partita Iva = " & CStr(Piva) & vbCrLf & vbCrLf & Log_Errori
    ...
    Private Sub Stampa_RegistroCorrispettivi(ByRef DSRegCorr As DS_RegistroCorrispettivi)
        ...
        ' Dim Tot_Imponibile_4 As Decimal = 0
        ' Dim Tot_Imponibile_10 As Decimal = 0
        ' Dim Tot_Imponibile_12 As Decimal = 0
        ' Dim Tot_Imponibile_21 As Decimal = 0

        ' Dim Tot_Iva_4 As Decimal = 0
        ' Dim Tot_Iva_10 As Decimal = 0
        ' Dim Tot_Iva_12 As Decimal = 0
        ' Dim Tot_Iva_21 As Decimal = 0

        ' Dim Tot_Importo_4 As Decimal = 0
        ' Dim Tot_Importo_10 As Decimal = 0
        ' Dim Tot_Importo_12 As Decimal = 0
        ' Dim Tot_Importo_21 As Decimal = 0

        ' Dim Importo4 As Decimal
        ' Dim Importo10 As Decimal
        ' Dim Importo12 As Decimal
        ' Dim Importo21 As Decimal

        ' Dim Imponibile4 As Decimal
        ' Dim Imponibile10 As Decimal
        ' Dim Imponibile12 As Decimal
        ' Dim Imponibile21 As Decimal

        ' Dim Imposta4 As Decimal
        ' Dim Imposta10 As Decimal
        ' Dim Imposta12 As Decimal
        'Dim Imposta21 As Decimal

        'Dim Esente As Decimal
        'Dim Tot_Esente As Decimal

        'Dim Totale_Riga_Importi As Decimal
        'Dim Totale_Importi As Decimal
    ...
    Public Function CaricaGriglia_DtGlobale() As DataTable
        ...
        DtGlobale.Columns.Add(New DataColumn("iva", GetType(Decimal)))
        ...
        DtGlobale.Columns.Add(New DataColumn("imponibile_netto", GetType(Decimal)))
        DtGlobale.Columns.Add(New DataColumn("importo", GetType(Decimal)))
    ...
    Public Sub InserisciRiga_DtGlobale(ByRef DT_Globale As DataTable, _
        ...
        Dim importo As Decimal = iva + imponibile_netto
    ...
    Private Sub Elabora_Dt_Globale(ByRef DSRegCorr As DS_RegistroCorrispettivi, _
        ...
        Dim Totale_Importo_Data As Decimal

        Dim Tot_Importo_Col1 As Decimal
        Dim Tot_Importo_Col2 As Decimal
        Dim Tot_Importo_Col3 As Decimal
        Dim Tot_Importo_Col4 As Decimal

        Dim Tot_Imposta_Col1 As Decimal
        Dim Tot_Imposta_Col2 As Decimal
        Dim Tot_Imposta_Col3 As Decimal
        Dim Tot_Imposta_Col4 As Decimal

        Dim Tot_Imponibile_Col1 As Decimal
        Dim Tot_Imponibile_Col2 As Decimal
        Dim Tot_Imponibile_Col3 As Decimal
        Dim Tot_Imponibile_Col4 As Decimal

        Dim Tot_Non_Imp_Col1 As Decimal
        Dim Tot_Non_Imp_Col2 As Decimal
        Dim Tot_Esenz_Col1 As Decimal
        Dim Tot_Esenz_Col2 As Decimal


        Dim Riepilogo_Importo_Data As Decimal
        Dim Riepilogo_Importo_Col1 As Decimal
        Dim Riepilogo_Importo_Col2 As Decimal
        Dim Riepilogo_Importo_Col3 As Decimal
        Dim Riepilogo_Importo_Col4 As Decimal
        Dim Riepilogo_Imposta_Col1 As Decimal
        Dim Riepilogo_Imposta_Col2 As Decimal
        Dim Riepilogo_Imposta_Col3 As Decimal
        Dim Riepilogo_Imposta_Col4 As Decimal
        Dim Riepilogo_Imponibile_Col1 As Decimal
        Dim Riepilogo_Imponibile_Col2 As Decimal
        Dim Riepilogo_Imponibile_Col3 As Decimal
        Dim Riepilogo_Imponibile_Col4 As Decimal
        Dim Riepilogo_Non_Imp_Col1 As Decimal
        Dim Riepilogo_Non_Imp_Col2 As Decimal
        Dim Riepilogo_Esenz_Col1 As Decimal
        Dim Riepilogo_Esenz_Col2 As Decimal
