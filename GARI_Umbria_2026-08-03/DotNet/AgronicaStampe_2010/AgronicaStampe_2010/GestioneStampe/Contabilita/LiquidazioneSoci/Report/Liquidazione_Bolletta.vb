...
Public Class Liquidazione_Bolletta
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Liquidazione_Bolletta.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Liquidazione_Bolletta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLiquidazione_Bolletta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Liquidazione_Bolletta = New Liquidazione_Bolletta()
        rpt.Site = Me.Site
        Return rpt
    End Function
