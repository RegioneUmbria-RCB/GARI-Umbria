...
Public Class Rpt_Pagamenti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_Pagamenti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Pagamenti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Pagamenti = New Rpt_Pagamenti()
        rpt.Site = Me.Site
        Return rpt
    End Function
