...
Public Class Rpt_SP_Attivita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_SP_Attivita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SP_Attivita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SP_Attivita = New Rpt_SP_Attivita()
        rpt.Site = Me.Site
        Return rpt
    End Function
