...
Public Class Rpt_CE_CostiRicavi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_CE_CostiRicavi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Lbl_Totale() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_CE_CostiRicavi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CE_CostiRicavi = New Rpt_CE_CostiRicavi()
        rpt.Site = Me.Site
        Return rpt
    End Function
