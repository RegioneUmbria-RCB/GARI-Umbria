...
Public Class Rpt_SP_Passivita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_SP_Passivita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SP_Passivita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SP_Passivita = New Rpt_SP_Passivita()
        rpt.Site = Me.Site
        Return rpt
    End Function
