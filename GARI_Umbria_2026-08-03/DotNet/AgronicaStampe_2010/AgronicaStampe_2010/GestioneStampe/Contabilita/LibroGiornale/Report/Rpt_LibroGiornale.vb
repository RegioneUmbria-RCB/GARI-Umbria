...
Public Class Rpt_LibroGiornale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_LibroGiornale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_LibroGiornale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_LibroGiornale = New Rpt_LibroGiornale()
        rpt.Site = Me.Site
        Return rpt
    End Function
