...
Public Class Stat12MesiOrdVal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Stat12MesiOrdVal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStat12MesiOrdVal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Stat12MesiOrdVal = New Stat12MesiOrdVal()
        rpt.Site = Me.Site
        Return rpt
    End Function
