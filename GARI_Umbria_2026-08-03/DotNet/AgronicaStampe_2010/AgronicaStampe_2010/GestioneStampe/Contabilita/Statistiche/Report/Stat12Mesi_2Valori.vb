...
Public Class Stat12Mesi_2Valori
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Stat12Mesi_2Valori.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStat12Mesi_2Valori
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Stat12Mesi_2Valori = New Stat12Mesi_2Valori()
        rpt.Site = Me.Site
        Return rpt
    End Function
