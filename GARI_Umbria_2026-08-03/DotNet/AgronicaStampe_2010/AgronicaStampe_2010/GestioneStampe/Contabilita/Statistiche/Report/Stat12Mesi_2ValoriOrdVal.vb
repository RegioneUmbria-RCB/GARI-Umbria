...
Public Class Stat12Mesi_2ValoriOrdVal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Stat12Mesi_2ValoriOrdVal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Stat12Mesi_2ValoriOrdVal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStat12Mesi_2ValoriOrdVal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Stat12Mesi_2ValoriOrdVal = New Stat12Mesi_2ValoriOrdVal()
        rpt.Site = Me.Site
        Return rpt
    End Function
