...
Public Class Rpt_RiepilogoImballi
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_RiepilogoImballi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_RiepilogoImballi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_RiepilogoImballi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_RiepilogoImballi = New Rpt_RiepilogoImballi()
        rpt.Site = Me.Site
        Return rpt
    End Function
