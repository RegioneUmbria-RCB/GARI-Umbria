...
Public Class CRBuonoAccettazione
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRBuonoAccettazione.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.CRBuonoAccettazione.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRBuonoAccettazione
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBuonoAccettazione = New CRBuonoAccettazione()
        rpt.Site = Me.Site
        Return rpt
    End Function
