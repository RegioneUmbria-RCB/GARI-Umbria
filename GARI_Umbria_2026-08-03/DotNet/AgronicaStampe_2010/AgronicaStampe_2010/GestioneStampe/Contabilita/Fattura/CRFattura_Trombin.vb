...
Public Class CRFattura_Trombin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.CRFattura_Trombin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRFattura_Trombin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRFattura_Trombin = New CRFattura_Trombin()
        rpt.Site = Me.Site
        Return rpt
    End Function
