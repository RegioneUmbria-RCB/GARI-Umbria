...
Public Class Rpt_ImballiUscita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_ImballiUscita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ImballiUscita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ImballiUscita = New Rpt_ImballiUscita()
        rpt.Site = Me.Site
        Return rpt
    End Function
