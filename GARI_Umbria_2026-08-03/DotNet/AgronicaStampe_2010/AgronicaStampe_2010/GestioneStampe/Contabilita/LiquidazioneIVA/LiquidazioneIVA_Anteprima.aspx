<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LiquidazioneIVA_Anteprima.aspx.vb" Inherits="AgronicaStampe_2010.LiquidazioneIVA_Anteprima"  %>
...
<asp:label style="Z-INDEX: 106; POSITION: absolute; TOP: 10px; LEFT: 8px" id="lbl_AnnoContabile"
					runat="server" Width="104px" Height="14px" CssClass="testo_08_nero_bold"
...
<asp:label style="Z-INDEX: 110; POSITION: absolute; TOP: 10px; LEFT: 208px" id="Label24" runat="server"
					Width="120px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Riclassificazione :</asp:label>
...
<asp:label style="Z-INDEX: 113; POSITION: absolute; TOP: 42px; LEFT: 8px" id="Label25" runat="server"
					Width="54px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Conto :</asp:label></ASP:PANEL>
				...
				<TR>
					<TD class="Testo_08_Nero" bgColor="#5c9ccc">&nbsp; Impresa :
						<ASP:TEXTBOX id="Txt_RagioneSociale" runat="server" Height="17px" Width="712px" BackColor="#5C9CCC"
							CssClass="Testo_08_Nero_Bold" BorderStyle="None" MAXLENGTH="120" ReadOnly="True"></ASP:TEXTBOX>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
				</TR>
			</TABLE>
			<ASP:IMAGE style="Z-INDEX: 103; POSITION: absolute; TOP: 8px; LEFT: 8px" id="ImageLogo" runat="server"
				...
				MS_POSITIONING="GridLayout" runat="server" Height="514px" Width="994px" BackColor="#E6F4FF" BORDERWIDTH="1px" BORDERCOLOR="#0000C0" BORDERSTYLE="Solid">&nbsp; 
<asp:Panel style="Z-INDEX: 101; POSITION: absolute; SCROLLBAR-FACE-COLOR: #e6f4ff; OVERFLOW: auto; TOP: 90px; LEFT: 8px"
					...
					<asp:label style="Z-INDEX: 100; POSITION: absolute; TOP: 8px; LEFT: 112px" id="Label5" runat="server"
						Width="168px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#C0FFC0">IVA A CREDITO (Acquisti)</asp:label>
					...
					<asp:label style="Z-INDEX: 102; POSITION: absolute; TOP: 216px; LEFT: 8px" id="Label11" runat="server"
						Width="264px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Numero movimenti con IVA a Credito :</asp:label>
					...
					<asp:label style="Z-INDEX: 110; POSITION: absolute; TOP: 184px; LEFT: 8px" id="Label22" runat="server"
						Width="152px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Totale IVA a credito :</asp:label>
...
<ASP:PANEL style="Z-INDEX: 102; POSITION: absolute; SCROLLBAR-FACE-COLOR: #e6f4ff; OVERFLOW: auto; TOP: 3px; LEFT: 8px"
					...
					Height="80px" BackColor="#E6F4FF" BORDERWIDTH="1px" BORDERCOLOR="#0000C0"
					BORDERSTYLE="None">&nbsp; 
...
<ASP:LABEL style="Z-INDEX: 104; POSITION: absolute; TOP: 22px; LEFT: 8px" id="LABEL3" runat="server"
						Width="24px" Height="8px" CssClass="Testo_08_Nero_Bold" BackColor="#E6F4FF">Dal :</ASP:LABEL>
<ASP:LABEL style="Z-INDEX: 105; POSITION: absolute; TOP: 45px; LEFT: 8px" id="LABEL4" runat="server"
						Width="24px" Height="8px" CssClass="Testo_08_Nero_Bold" BackColor="#E6F4FF">Al :</ASP:LABEL>
<asp:label style="Z-INDEX: 109; POSITION: absolute; TOP: 3px; LEFT: 8px" id="Label1" runat="server"
						Width="164px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Periodo di Competenza :</asp:label>
<asp:label style="Z-INDEX: 114; POSITION: absolute; TOP: 3px; LEFT: 264px" id="Label27" runat="server"
						Width="112px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Sezionale:</asp:label>
...
<asp:Panel style="Z-INDEX: 103; POSITION: absolute; SCROLLBAR-FACE-COLOR: #e6f4ff; OVERFLOW: auto; TOP: 90px; LEFT: 416px"
					...
					<asp:label style="Z-INDEX: 100; POSITION: absolute; TOP: 8px; LEFT: 128px" id="Label6" runat="server"
						Width="168px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#FFC0C0">IVA A DEBITO (Vendite)</asp:label>
					<asp:label style="Z-INDEX: 101; POSITION: absolute; TOP: 216px; LEFT: 8px" id="Label16" runat="server"
						Width="264px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Numero movimenti con IVA a Debito :</asp:label>
					...
					<asp:label style="Z-INDEX: 110; POSITION: absolute; TOP: 184px; LEFT: 8px" id="Label23" runat="server"
						Width="136px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Totale IVA a debito :</asp:label>
...
<asp:label style="Z-INDEX: 105; POSITION: absolute; TOP: 48px; LEFT: 560px" id="Label2" runat="server"
					Width="84px" Height="14px" CssClass="testo_08_blue_bold" BackColor="#E6F4FF">Carica i dati</asp:label>
<asp:label style="Z-INDEX: 106; POSITION: absolute; TOP: 119px; LEFT: 840px; height: 25px; width: 118px;" 
                    id="Label33" runat="server" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">IVA a credito da liquidazione precedente:</asp:label>
...
<asp:label style="Z-INDEX: 108; POSITION: absolute; TOP: 234px; LEFT: 840px" id="Label9" runat="server"
					Width="104px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">IVA a debito :</asp:label>
...
<ASP:TEXTBOX style="Z-INDEX: 110; POSITION: absolute; TEXT-ALIGN: right; TOP: 389px; LEFT: 840px"
                    ...
                    id="Label88" runat="server" Height="14px" CssClass="testo_08_nero_bold" 
                    ...
                    id="Label8" runat="server" Height="14px" CssClass="testo_08_nero_bold" 
...
<asp:label style="Z-INDEX: 111; POSITION: absolute; TOP: 371px; LEFT: 840px" id="Label10" runat="server"
					Width="104px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Saldo:</asp:label>
...
<asp:label style="Z-INDEX: 113; POSITION: absolute; TOP: 16px; LEFT: 728px" id="Label21" runat="server"
					Width="84px" Height="14px" CssClass="testo_08_blue_bold" BackColor="#E6F4FF">Stampa</asp:label>
<asp:CheckBox style="Z-INDEX: 114; POSITION: absolute; TOP: 75px; LEFT: 840px" id="Chk_IVA_Precedente"
...
<asp:label style="Z-INDEX: 116; POSITION: absolute; TOP: 48px; LEFT: 672px" id="Label30" runat="server"
					Width="132px" Height="14px" CssClass="testo_08_nero_bold" BackColor="#E6F4FF">Numero di pagina:</asp:label>
...
<asp:Button style="Z-INDEX: 121; POSITION: absolute; TOP: 337px; LEFT: 848px" id="Btn_CalcolaSaldo"
                ...
                <asp:Label ID="Label34" runat="server" BackColor="#E6F4FF" 
                    CssClass="testo_08_nero_bold" Height="14px" 
                ...
                <asp:TextBox ID="Txt_InteresseDebito_Perc" runat="server" BackColor="#FFFFC0" 
                   ...
                   <asp:label style="Z-INDEX: 111; POSITION: absolute; TOP: 429px; LEFT: 882px; width: 16px;" 
                    id="LblPerc" runat="server" Height="14px" CssClass="testo_08_nero_bold" 
                    BackColor="#E6F4FF">%</asp:label>
