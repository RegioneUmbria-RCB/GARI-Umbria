...
Public Class Rpt_GruppiColturali
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_GruppiColturali.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_GruppiColturali.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GruppiColturali
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GruppiColturali = New Rpt_GruppiColturali()
        rpt.Site = Me.Site
        Return rpt
    End Function
