...
Public Class Rpt_RichiesteAllevamenti
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_RichiesteAllevamenti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_RichiesteAllevamenti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_RichiesteAllevamenti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_RichiesteAllevamenti = New Rpt_RichiesteAllevamenti()
        rpt.Site = Me.Site
        Return rpt
    End Function
