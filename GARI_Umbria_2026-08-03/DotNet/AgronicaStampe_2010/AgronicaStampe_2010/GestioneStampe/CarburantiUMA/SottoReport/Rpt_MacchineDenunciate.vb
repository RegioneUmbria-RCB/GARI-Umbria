...
Public Class Rpt_MacchineDenunciate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_MacchineDenunciate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_MacchineDenunciate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_MacchineDenunciate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_MacchineDenunciate = New Rpt_MacchineDenunciate()
        rpt.Site = Me.Site
        Return rpt
    End Function
