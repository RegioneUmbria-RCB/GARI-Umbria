...
Public Class Rpt_OrdiniVivaio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_OrdiniVivaio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_OrdiniVivaio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_OrdiniVivaio = New Rpt_OrdiniVivaio()
        rpt.Site = Me.Site
        Return rpt
    End Function
