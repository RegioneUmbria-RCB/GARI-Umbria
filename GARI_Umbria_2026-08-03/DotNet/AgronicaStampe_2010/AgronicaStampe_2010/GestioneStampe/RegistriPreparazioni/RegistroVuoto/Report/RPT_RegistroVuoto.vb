...
Public Class RPT_RegistroVuoto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.RPT_RegistroVuoto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_RegistroVuoto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_RegistroVuoto = New RPT_RegistroVuoto()
        rpt.Site = Me.Site
        Return rpt
    End Function
