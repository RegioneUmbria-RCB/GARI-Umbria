...
Public Class Rpt_DAA_GaranzieCircolanti
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_DAA_GaranzieCircolanti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_DAA_GaranzieCircolanti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_DAA_GaranzieCircolanti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_DAA_GaranzieCircolanti = New Rpt_DAA_GaranzieCircolanti()
        rpt.Site = Me.Site
        Return rpt
    End Function
