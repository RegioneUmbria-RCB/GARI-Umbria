...
Public Class Rpt_DOCO_NoLayout
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_DOCO_NoLayout.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_DOCO_NoLayout
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_DOCO_NoLayout = New Rpt_DOCO_NoLayout()
        rpt.Site = Me.Site
        Return rpt
    End Function
