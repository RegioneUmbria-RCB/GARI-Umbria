...
Public Class Rpt_RegistroVinificazioneIntestazione
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_RegistroVinificazioneIntestazione.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_RegistroVinificazioneIntestazione.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FiltroRegistro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_RegistroVinificazioneIntestazione
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_RegistroVinificazioneIntestazione = New Rpt_RegistroVinificazioneIntestazione()
        rpt.Site = Me.Site
        Return rpt
    End Function
