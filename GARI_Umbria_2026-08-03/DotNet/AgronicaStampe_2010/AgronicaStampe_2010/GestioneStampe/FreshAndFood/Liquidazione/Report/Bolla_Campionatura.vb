...
Public Class Bolla_Campionatura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Bolla_Campionatura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBolla_Campionatura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bolla_Campionatura = New Bolla_Campionatura()
        rpt.Site = Me.Site
        Return rpt
    End Function
