...
Public Class ImballoGenerica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.ImballoGenerica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedImballoGenerica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ImballoGenerica = New ImballoGenerica()
        rpt.Site = Me.Site
        Return rpt
    End Function
