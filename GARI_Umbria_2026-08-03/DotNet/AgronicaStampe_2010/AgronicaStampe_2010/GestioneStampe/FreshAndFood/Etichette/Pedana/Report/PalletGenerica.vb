...
Public Class PalletGenerica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.PalletGenerica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPalletGenerica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PalletGenerica = New PalletGenerica()
        rpt.Site = Me.Site
        Return rpt
    End Function
