...
Public Class rptEtichetteSpedizioneConfCons_GS1ISO_DEprova1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEtichetteSpedizioneConfCons_GS1ISO-DEprova1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.rptEtichetteSpedizioneConfCons_GS1ISO-DEprova1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEtichetteSpedizioneConfCons_GS1ISO_DEprova1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEtichetteSpedizioneConfCons_GS1ISO_DEprova1 = New rptEtichetteSpedizioneConfCons_GS1ISO_DEprova1()
        rpt.Site = Me.Site
        Return rpt
    End Function
