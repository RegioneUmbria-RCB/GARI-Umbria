...
Public Class MonitoraggioCorpiEstraneiAggregata_XLS
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Response.AddHeader("Content-Disposition", "inline; filename = monitoraggiocorpiestraneiaggregata.xls")
    ...
    '##############################################################
    'Questa stampa deve visualizzare una riga per ogni modulo di carico
    'non una riga per ogni modulo di carico per ogni corpo estraneo contenuto
    Private Function LeggiDati_CreaDT() As DataTable
        ...
        If Not IsNothing(DT) Then
            ...
            For i = 0 To DT.Rows.Count - 1
                ...
                'ad ogni bolla corrisponde un carico diverso
                If N_Bolla <> DT.Rows(i).Item("Numero Bolla") Then
                    ...
                    If Cod_CE <> "-1" Then
                        ...
                        CE_Qta = Cod_CE & ": " & CStr(DT.Rows(i).Item("Quantita Rilevata")) & "<br/>"
                        ...
                        If DT.Rows(i).Item("Fase_Cod") = 1 Then
                            Select Case CStr(DT.Rows(i).Item("Tipologia Ritrovamento"))
                                Case "Aereoseparatore"
                                    DR.Item("Linea 1 - Aereoseparatore") = CE_Qta
                                Case "Cernitrice Ottica"
                                    DR.Item("Linea 1 - Cernitrice Ottica") = CE_Qta
                                Case "Cernita Manuale"
                                    DR.Item("Linea 1 - Cernita Manuale") = CE_Qta
                            End Select
                        End If
                        ...
                        If DT.Rows(i).Item("Fase_Cod") = 2 Then
                            Select Case CStr(DT.Rows(i).Item("Tipologia Ritrovamento"))
                                Case "Aereoseparatore"
                                    DR.Item("Linea 2 - Aereoseparatore") = CE_Qta
                                Case "Cernitrice Ottica"
                                    DR.Item("Linea 2 - Cernitrice Ottica") = CE_Qta
                                Case "Cernita Manuale"
                                    DR.Item("Linea 2 - Cernita Manuale") = CE_Qta
                            End Select
                        End If
                ...
                Else
                    ...
                    If DT.Rows(i).Item("Fase_Cod") = 1 Then
                        Select Case CStr(DT.Rows(i).Item("Tipologia Ritrovamento"))
                            Case "Aereoseparatore"
                                DT_Stampa.Rows(DT_Stampa.Rows.Count - 1).Item("Linea 1 - Aereoseparatore") += CE_Qta
                            Case "Cernitrice Ottica"
                                DT_Stampa.Rows(DT_Stampa.Rows.Count - 1).Item("Linea 1 - Cernitrice Ottica") += CE_Qta
                            Case "Cernita Manuale"
                                DT_Stampa.Rows(DT_Stampa.Rows.Count - 1).Item("Linea 1 - Cernita Manuale") += CE_Qta
                        End Select
                    End If
                    ...
                    If DT.Rows(i).Item("Fase_Cod") = 2 Then
                        Select Case CStr(DT.Rows(i).Item("Tipologia Ritrovamento"))
                            Case "Aereoseparatore"
                                DT_Stampa.Rows(DT_Stampa.Rows.Count - 1).Item("Linea 2 - Aereoseparatore") += CE_Qta
                            Case "Cernitrice Ottica"
                                DT_Stampa.Rows(DT_Stampa.Rows.Count - 1).Item("Linea 2 - Cernitrice Ottica") += CE_Qta
                            Case "Cernita Manuale"
                                DT_Stampa.Rows(DT_Stampa.Rows.Count - 1).Item("Linea 2 - Cernita Manuale") += CE_Qta
                        End Select
                    End If
        ...
        DT_Stampa.Columns.Remove("Corpo Estraneo")
