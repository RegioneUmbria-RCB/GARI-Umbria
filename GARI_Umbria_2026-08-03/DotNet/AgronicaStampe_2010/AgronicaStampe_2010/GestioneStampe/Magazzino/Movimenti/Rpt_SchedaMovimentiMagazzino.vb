...
Public Class Rpt_SchedaMovimentiMagazzino
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_SchedaMovimentiMagazzino.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.Rpt_SchedaMovimentiMagazzino.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SchedaMovimentiMagazzino
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SchedaMovimentiMagazzino = New Rpt_SchedaMovimentiMagazzino()
        rpt.Site = Me.Site
        Return rpt
    End Function
