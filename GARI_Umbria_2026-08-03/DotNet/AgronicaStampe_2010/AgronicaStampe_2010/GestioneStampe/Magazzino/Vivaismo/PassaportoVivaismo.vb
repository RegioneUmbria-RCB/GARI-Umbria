...
Public Class PassaportoVivaismo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgronicaStampe_2010.PassaportoVivaismo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DicituraPassaportoFitosanitario() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPassaportoVivaismo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PassaportoVivaismo = New PassaportoVivaismo()
        rpt.Site = Me.Site
        Return rpt
    End Function
