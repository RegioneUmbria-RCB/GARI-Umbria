...
Public Class Gis_Sat_Sentinel_Overlay_Passaggio_R
    Inherits AgronicaCoreDataProvider.DataProvider

    '##############################################################################################
    Public Function Leggi_(ByVal xFiltroAggiuntivo As String,
...
Public Class Gis_Sat_Sentinel_Overlay_Passaggio_W
    ...
    Public Function ImpostaFlagElaborazioneFallita(
            Gis_Sat_Sentinel_Overlay_Passaggio_COD As Integer,
        ...
        Try
            ...
            '---------------------------------------------
            Stb.Length = 0
            Stb.Append(" UPDATE Gis_Sat_Sentinel_Overlay_Passaggio " + vbCrLf)
            Stb.Append(" SET inviato = -1 ")
            Stb.Append(" WHERE Gis_Sat_Sentinel_Overlay_Passaggio_COD = " & Gis_Sat_Sentinel_Overlay_Passaggio_COD & " ")
    ...
    Public Function Scrivi(
        ...
        Try
            ...
            '---------------------------------------------
            Stb.Length = 0
            Stb.Append(" INSERT Gis_Sat_Sentinel_Overlay_Passaggio " + vbCrLf)

            Stb.Append("              (")
            Stb.Append("              Gis_Sat_Sentinel_Overlay_Passaggio_COD, DataRiferimento, Tile, URL, Inviato,            datainvio, ")
            ...
            Stb.Append("			,'" & Agro_SQL_SaveText(url) & "' ")
