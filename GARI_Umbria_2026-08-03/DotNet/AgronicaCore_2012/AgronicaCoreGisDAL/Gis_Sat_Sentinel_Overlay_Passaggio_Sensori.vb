...
Public Class Gis_Sat_Sentinel_Overlay_Passaggio_Sensori_R
...
Public Class Gis_Sat_Sentinel_Overlay_Passaggio_Sensori_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi(
        ...
        Try
            ...
            '---------------------------------------------
            Stb.Length = 0
            Stb.Append(" INSERT Gis_Sat_Sentinel_Overlay_Passaggio_Sensori " + vbCrLf)

            Stb.Append("              (")
            Stb.Append("              Gis_Sat_Sentinel_Overlay_Passaggio_COD, sensore, DataRiferimento, Inviato,            datainvio, ")
