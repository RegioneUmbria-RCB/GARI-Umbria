...
Public Class Gis_Sat_Sentinel_Overlay_Tile_SuperUser_R
    Inherits AgronicaCoreDataProvider.DataProvider


    Public Function LeggiVerificaPermesso(
        ...
        Try
            ...
            DT = Leggi(PivaSuperUser, Tile, "", "", objParametri)
    ...
    Public Function Leggi(
        ...
        Try
            ...
            Stb.Append(" FROM Gis_Sat_Sentinel_Overlay_Tile_Xpiva_superUser_OperazioniAutorizzate " & vbCrLf)

            Dim whereInserito As String = " WHERE "
            If PivaSuperUser <> "" Then
                Stb.Append(whereInserito & "Piva_SuperUser = '" & Agro_SQL_SaveText(PivaSuperUser) & "' " & vbCrLf)
                whereInserito = " AND "
            End If

            If Tile <> "" Then
                Stb.Append(whereInserito & "Tile = '" & Agro_SQL_SaveText(Tile) & "' " & vbCrLf)
            End If
...
Public Class Gis_Sat_Sentinel_Overlay_Tile_SuperUser_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi(
                          ByVal PivaSuperUser As String,
                          ByVal Tile As String,
                          ByVal Tipo_Visibilita As Integer,
        ...
        Try
            ...
            '---------------------------------------------
            Stb.Length = 0
            Stb.Append(" INSERT Gis_Sat_Sentinel_Overlay_Tile_Xpiva_superUser_OperazioniAutorizzate " + vbCrLf)

            Stb.Append("              (")
            Stb.Append("              Piva_SuperUser, Tile, Tipo_Visibilita,")
            ...
            Stb.Append("			 '" & Agro_SQL_SaveText(PivaSuperUser) & "' ")
            Stb.Append("			,'" & Agro_SQL_SaveText(Tile) & "' ")
            Stb.Append("			, " & Agro_SQL_SaveNum(Tipo_Visibilita) & "  ")
