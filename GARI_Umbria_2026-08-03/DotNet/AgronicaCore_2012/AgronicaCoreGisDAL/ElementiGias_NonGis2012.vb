...
Public Class ElementiGias_NonGis2012_R
...
Public Class ElementiGias_NonGis2012_W
    Inherits AgronicaCoreDataProvider.DataProvider



    '##############################################################################################
    Public Function ScriviCoordinateCentroAziendale( _
                ByVal Piva As String, _
                ByVal sa_cod As Integer, _
                ByVal latitudine As Double, _
                ByVal longitudine As Double, _
                ByVal ZSLM As Double, _
                ByVal X As Double, _
                ByVal Y As Double, _
                    ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri _
        ...
        Try
            ...
            Stb.Append(" update centri_Aziendali  " & vbCrLf)
            Stb.Append(" set  " & vbCrLf)
            Stb.Append("   lat = " & Agro_SQL_SaveNum(latitudine) & vbCrLf)
            Stb.Append(" , long = " & Agro_SQL_SaveNum(longitudine) & vbCrLf)
            Stb.Append(" , X = " & Agro_SQL_SaveNum(X) & vbCrLf)
            Stb.Append(" , Y = " & Agro_SQL_SaveNum(Y) & vbCrLf)
            ...
            Stb.Append(" and sa_cod = " & Agro_SQL_SaveNum(sa_cod) & vbCrLf)
