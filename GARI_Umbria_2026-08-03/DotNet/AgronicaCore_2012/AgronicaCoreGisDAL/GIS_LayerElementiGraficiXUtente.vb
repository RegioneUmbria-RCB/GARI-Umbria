...
Public Class GIS_LayerElementiGraficiXUtente_R
    ...
    Public Function Leggi(ByVal LayerCod As Integer,
                          ...
                          Optional ByVal LeggiDescrizioneUtente As Boolean = True
                          ) As DataTable

        Dim NomeRoutine As String = "AgronicaCoreGisDAL.GIS_LayerElementiGraficiXUtente_R.Leggi()"
        ...
        Try
            ...
            If LeggiDescrizioneUtente Then
                StrSQL.AppendLine("     ,usr.Nome ,usr.Cognome ")
            End If
            StrSQL.AppendLine(" FROM  GIS_LayerElementiGraficiXUtente ")
            If LeggiDescrizioneUtente Then
                StrSQL.AppendLine(" LEFT JOIN " & objParametri_Utenti.Recupera_NomeDB() & ".dbo.Utenti_Dettagli usr on")
                StrSQL.AppendLine(" ( GIS_LayerElementiGraficiXUtente.Utente = usr.UserName) ")
            End If
            ...
            Else
                StrSQL.AppendLine(" ORDER BY LayerElementiGrafici_Cod, Utente ")
            End If
...
Public Class GIS_LayerElementiGraficiXUtente_W
    Inherits AgronicaCoreDataProvider.DataProvider2010
    ...
    Public Function Scrivi(ByVal LayerCod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreGisDAL.GIS_LayerElementiGraficiXUtente_W.Scrivi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" INSERT INTO GIS_LayerElementiGraficiXUtente ")
            StrSQL.AppendLine("     ([LayerElementiGrafici_Cod]  ")
            StrSQL.AppendLine("     ,[Utente] ")
    ...
    Public Function Modifica(ByVal LayerCod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreGisDAL.GIS_LayerElementiGraficiXUtente_W.Modifica()"
        ...
        Try
            If LayerCod = 0 And Utente = "" And xFiltroAggiuntivo = "" Then
                Throw New Exception("Modifica permessi utente su layer gis senza filtri (Codice Layer e/o Utente). Operazione non permessa.")
            End If


            StrSQL.Length = 0

            StrSQL.AppendLine(" UPDATE GIS_LayerElementiGraficiXUtente set")
    ...
    Public Function Cancella(ByVal LayerCod As Integer,
                             ...
                             ByVal xFiltroAggiuntivo As String,
                             ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri) As Boolean
        Dim NomeRoutine As String = "AgronicaCoreGisDAL.GIS_LayerElementiGraficiXUtente_W.Cancella()"
        ...
        Try
            If LayerCod = 0 And Utente = "" And xFiltroAggiuntivo = "" Then
                Throw New Exception("cancellazione permessi utente su layer gis senza filtri (Codice Layer e/o Utente). Operazione non permessa.")
            End If
            StrSQL.Length = 0

            StrSQL.AppendLine(" DELETE FROM GIS_LayerElementiGraficiXUtente ")
            StrSQL.AppendLine(" WHERE 1=1 ")
            If LayerCod <> 0 Then
                StrSQL.AppendLine(" and LayerElementiGrafici_Cod=" & Agro_SQL_SaveNum(LayerCod) & " ")
            End If
