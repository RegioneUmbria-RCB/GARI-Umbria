...
Public Class RPT_Scheda_NPK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_Scheda_NPK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Scheda_NPK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Scheda_NPK = New RPT_Scheda_NPK()
        rpt.Site = Me.Site
        Return rpt
    End Function
