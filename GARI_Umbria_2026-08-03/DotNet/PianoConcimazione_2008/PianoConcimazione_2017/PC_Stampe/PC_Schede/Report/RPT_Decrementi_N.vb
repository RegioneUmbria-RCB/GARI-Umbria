...
Public Class RPT_Decrementi_N
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_Decrementi_N.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Decrementi_N
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Decrementi_N = New RPT_Decrementi_N()
        rpt.Site = Me.Site
        Return rpt
    End Function
