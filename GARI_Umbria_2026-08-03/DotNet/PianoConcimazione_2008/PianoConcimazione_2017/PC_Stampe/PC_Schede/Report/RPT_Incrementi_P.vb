...
Public Class RPT_Incrementi_P
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_Incrementi_P.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Incrementi_P
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Incrementi_P = New RPT_Incrementi_P()
        rpt.Site = Me.Site
        Return rpt
    End Function
