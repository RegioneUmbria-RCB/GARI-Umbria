...
Public Class RPT_Incrementi_N
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_Incrementi_N.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Incrementi_N
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Incrementi_N = New RPT_Incrementi_N()
        rpt.Site = Me.Site
        Return rpt
    End Function
