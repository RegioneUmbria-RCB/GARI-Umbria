...
Public Class RPT_Decrementi_P
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_Decrementi_P.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Decrementi_P
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Decrementi_P = New RPT_Decrementi_P()
        rpt.Site = Me.Site
        Return rpt
    End Function
