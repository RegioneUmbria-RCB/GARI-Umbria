...
Public Class RPT_PUA_EffluentiDistribuiti
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_PUA_EffluentiDistribuiti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_PUA_EffluentiDistribuiti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PUA_EffluentiDistribuiti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PUA_EffluentiDistribuiti = New RPT_PUA_EffluentiDistribuiti()
        rpt.Site = Me.Site
        Return rpt
    End Function
