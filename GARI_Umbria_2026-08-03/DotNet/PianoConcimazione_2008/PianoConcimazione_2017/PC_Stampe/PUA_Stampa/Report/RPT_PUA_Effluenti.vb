...
Public Class RPT_PUA_Effluenti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_PUA_Effluenti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PUA_Effluenti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PUA_Effluenti = New RPT_PUA_Effluenti()
        rpt.Site = Me.Site
        Return rpt
    End Function
