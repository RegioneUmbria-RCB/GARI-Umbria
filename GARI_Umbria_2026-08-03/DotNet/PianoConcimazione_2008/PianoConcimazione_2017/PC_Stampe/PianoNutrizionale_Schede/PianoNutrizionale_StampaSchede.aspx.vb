...
Public Class PianoNutrizionale_StampaSchede
...
#Region "Dichiarazione Variabili"
    ...
    Dim Nome_Documento As String = "PianoNutrizionale_StampaSchede"

    '----- Gestione Report
    Private rptSchede_PianoNutrizionale As RPT_PianoNutrizionale_StampaSchede
...
#End Region
    '##########################################################################################################
    Private Sub PianoNutrizionale_StampaSchede_Init(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Init
        rptSchede_PianoNutrizionale = New RPT_PianoNutrizionale_StampaSchede
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            Try
                Dati_PianoNutrizionale(Qs_Piva, xSa_Cod, xAppezza, xID_Imp,
                                       ...
                                       objParametri_Server, rptSchede_PianoNutrizionale)
            ...
            Try
                ...
                If Not MostraDataFirma Then
                    rptSchede_PianoNutrizionale.ReportFooterSection2.SectionFormat.EnableSuppress = True
                End If
            ...
            Try
                ...
                objGestFile.SalvaReportPdf(rptSchede_PianoNutrizionale,
            ...
            Try
                rptSchede_PianoNutrizionale.SaveAs(reportTemporano, True)
            Catch ex As Exception
                ...
                objLog.Gestione_LogErrori(objParametri_Server,
                                      "PianoNutrizionale",
                                       ...
                                       Session("ASG_Utente_Username"),
                                        "PianoNutrizionale_StampaSchede",
                                         Log_Errori)
            ...
            Else
                ...
                'Session("Report") = rptSchede_PianoNutrizionale
        ...
        '    rptSchede_PianoNutrizionale.Section5.ReportObjects("Picture3").ObjectFormat.EnableSuppress = True
        '    rptSchede_PianoNutrizionale.Section5.ReportObjects("Text1").ObjectFormat.EnableSuppress = True
        'End If
    ...
    Public Function SalvaPdf(ByVal objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri,
                             ByRef rptPianoNutrizionale As RPT_PianoNutrizionale_StampaSchede,
    ...
    Public Sub Dati_PianoNutrizionale(ByVal Piva As String, ByVal SaCod As Integer, ByVal Appezza As Integer, ByVal IdReg As Integer,
                                      ...
                                      ByRef rptScheda_PianoNutrizionale As RPT_PianoNutrizionale_StampaSchede)

        Dim dsPianoNutrizionale As New DS_PianoNutrizionale_StampaSchede()
        Dim DS_LogoFooter As New DS_LogoFooter
        Dim drPianoNutrizionale = dsPianoNutrizionale.DT_ValoriAmmessi.NewDT_ValoriAmmessiRow
        ...
        Try
            ...
            If Not IsNothing(DtPC_Dettagli) AndAlso DtPC_Dettagli.Rows.Count > 0 Then
                ...
                drPianoNutrizionale.Resa = DtPC_Dettagli.Rows(0).Item("PC_Dettagli_Resa")
            ...
            '-----------------------------------------------------------------------------
            dsPianoNutrizionale.DT_ValoriAmmessi.Rows.Add(drPianoNutrizionale)
            '-----------------------------------------------------------------------------
        ...
        Try
            ...
            rptSchede_PianoNutrizionale.OpenSubreport("FooterLogo.rpt").SetDataSource(DS_LogoFooter)
        Catch ex As Exception
        ...
        Try
            '-----------------------------------------------------------------------------
            rptSchede_PianoNutrizionale.SetDataSource(dsPianoNutrizionale)
            rptSchede_PianoNutrizionale.OpenSubreport("FooterLogo.rpt").SetDataSource(DS_LogoFooter)
            '-----------------------------------------------------------------------------
        Catch ex As Exception
