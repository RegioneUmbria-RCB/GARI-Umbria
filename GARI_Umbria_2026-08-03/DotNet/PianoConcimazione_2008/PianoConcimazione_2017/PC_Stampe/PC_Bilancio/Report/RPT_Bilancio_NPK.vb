...
Public Class RPT_Bilancio_NPK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_Bilancio_NPK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Bilancio_NPK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Bilancio_NPK = New RPT_Bilancio_NPK()
        rpt.Site = Me.Site
        Return rpt
    End Function
