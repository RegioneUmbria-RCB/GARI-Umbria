...
Public Class RPT_Necessita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_Necessita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Necessita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Necessita = New RPT_Necessita()
        rpt.Site = Me.Site
        Return rpt
    End Function
