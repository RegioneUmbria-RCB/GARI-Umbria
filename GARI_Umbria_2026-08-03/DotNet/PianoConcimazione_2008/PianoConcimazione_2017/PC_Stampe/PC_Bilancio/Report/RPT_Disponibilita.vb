...
Public Class RPT_Disponibilita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PianoConcimazione_2017.RPT_Disponibilita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Disponibilita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Disponibilita = New RPT_Disponibilita()
        rpt.Site = Me.Site
        Return rpt
    End Function
