...
Public Class DomandaIrriguaBootstrap
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        agroKendo.SitoOspite = Enum_SiteRedirector.Sito_AgronicaDomandaIrrigua

        agroVersioneMaster.VersioneMasterPlaceHolder = versioneMasterPlaceHolder
        agroVersioneMaster.SitoOspite = Enum_SiteRedirector.Sito_AgronicaDomandaIrrigua

        jquery.SitoOspite = Enum_SiteRedirector.Sito_AgronicaDomandaIrrigua
        ...
        agroMasterPage.SitoOspite = Enum_SiteRedirector.Sito_AgronicaDomandaIrrigua

        bootstrap.BootstrapPlaceHeader = bootstrapPlaceHeader
        bootstrap.SitoOspite = Enum_SiteRedirector.Sito_AgronicaDomandaIrrigua
        ...
        Else
            Select Case HttpContext.Current.Session("Sito_Origine")
                ...
                Case Enum_SiteRedirector.Sito_AgronicaAgenda_2010
                    If paginaRichiesta = enum_PagineGiasOnline.MenuAgenda Then
                        ' Torna a AgroAgenda (sito di provenienza), non al menu locale che non esiste su DomandaIrrigua
                        Dim objAgenda2010 As New AgronicaCoreGestioneRichieste.ParametriAgenda_2010
                        objAgenda2010.Piva = objParametriAgenda.Piva
                        objAgenda2010.PaginaRichiesta = enum_PagineAgenda_2010.Menu_BS
                        Return AgronicaCoreGestioneRichieste.RedirectGestione.IndirizzoCompleto_SitoAgenda_PassandoDirettamente_ParametriAgenda_2010(
