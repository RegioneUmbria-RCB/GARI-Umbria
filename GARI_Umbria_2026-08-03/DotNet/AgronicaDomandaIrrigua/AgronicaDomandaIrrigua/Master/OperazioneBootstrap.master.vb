...
#Region "Bottoni Nascosti"
    ...
    Protected Sub BTN_ComboOperazione_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BTN_ComboOperazione.Click
        ...
        Dim PaginaLink As String = OpUtil.LinkPagina_from_LavCod_NEW(objParametriAgenda.Lav_Cod, objParametriAgenda, strErrore:=strErrore, fromBootstrapToBootstrap:=fromBootstrapToBootstrap)
