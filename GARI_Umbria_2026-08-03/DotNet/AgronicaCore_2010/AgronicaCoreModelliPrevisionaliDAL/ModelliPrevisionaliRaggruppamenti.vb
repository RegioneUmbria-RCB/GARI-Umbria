...
Public Class ModelliPrevisionaliRaggruppamenti_R
    ...
    Public Function Leggi(ByVal xFiltroAggiuntivo As String,
        ...
        Try
            ...
            Stb.Append(" FROM ModelliPrevisionaliRaggruppamenti " & vbCrLf)
...
Public Class ModelliPrevisionaliRaggruppamenti_W
    Inherits AgronicaCoreDataProvider.DataProvider
