...
Public Class Area_Omogenea_R
    ...
    Public Function Leggi( _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.Area_Omogenea_R.Leggi()"
        ...
        Try
            ...
            StrSQL.Append("SELECT Z.* ")
            StrSQL.Append(", Z.data_creazione as Area_data_creazione ")
            StrSQL.Append(", Z.Data_modifica as Area_Data_modifica ")
            StrSQL.Append(", Z.Username_creazione as Area_Username_creazione ")
            StrSQL.Append(", Z.Username_modifica as Area_Username_modifica ")
            StrSQL.Append(", z.Validita_Inizio as Area_Validita_Inizio ")
            StrSQL.Append(", z.Validita_Fine as Area_Validita_Fine ")

            StrSQL.Append("FROM Area_Omogenea AS Z WHERE 1=1 ")
            If Piva <> "" Then
                StrSQL.Append("AND Z.Piva = '" & Agro_SQL_SaveText(Piva) & "' ")
            End If

            StrSQL.Append("AND Z.Piva_SuperUser = '" & objParametri.PivaSuperUser & "' ")


            If Area_Cod <> 0 Then
                StrSQL.Append("AND Z.Area_Cod = " & Area_Cod.ToString & " ")
            End If
            ...
            Select Case objParametri.FlagVisibilita
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_SoloNonCancellati
                    StrSQL.Append(" AND   Z.Inviato >=0 ")
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_SoloCancellati
                    StrSQL.Append(" AND   Z.Inviato =-1 ")
            ...
            Else
                StrSQL.Append(" ORDER BY  Z.Piva, Z.Area_Cod ")
            End If
...
Public Class Area_Omogenea_W
    Inherits AgronicaCoreDataProvider.DataProvider

    '##############################################################################################
    Public Function Scrivi(ByVal Piva As String, _
                               ByVal Area_Cod As Integer, _
                               ByVal Area_Des As String, _
                               ByVal Tessitura_Cod As Integer, _
                               ByVal Altimetria As String, _
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.Area_Omogenea_W.Scrivi()"
        ...
        Try
            ...
            '----- Genero la query SQL 
            StrSQL.Append(" INSERT INTO Area_Omogenea ( ")
            StrSQL.Append("             Piva_SuperUser, ")
            StrSQL.Append("             Piva, ")
            StrSQL.Append("             Area_Des, ")
            StrSQL.Append("             Tessitura_cod, ")
            StrSQL.Append("             Altimetria, ")
            StrSQL.Append("             SO, ")
            StrSQL.Append("             TipoZona, ")
            ...
            StrSQL.Append("         ,'" & Agro_SQL_SaveText(Area_Des) & "' ")
            StrSQL.Append("         ," & Agro_SQL_SaveNum(Tessitura_Cod.ToString) & " ")
            StrSQL.Append("         ,'" & Agro_SQL_SaveText(Altimetria) & "' ")
            StrSQL.Append("         ," & Agro_SQL_SaveNum(so) & " ")
            StrSQL.Append("         ,'" & Agro_SQL_SaveText(TipoZona) & "' ")
            StrSQL.Append("			, 0 ")
