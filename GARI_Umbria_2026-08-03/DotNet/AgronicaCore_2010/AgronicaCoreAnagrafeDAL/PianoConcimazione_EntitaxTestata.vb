...
Public Class PianoConcimazione_EntitaxTestata_R
    ...
    '##############################################################################################
    Public Function Leggi_Tutte_Piva_Che_Hanno_PianoConcimazione(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri
                                                                 ) As DataTable
...
Public Class PianoConcimazione_EntitaxTestata_W
    ...
    Public Function Cancella(ByVal PC_Testata_Cod As Integer,
                                ByVal PC_Entita_Cod As Integer,
    ...
    Public Function Scrivi(ByVal PC_Testata_Cod As Integer,
                            ByVal PC_Entita_Cod As enum_Entita_PianoConcimazione,
                            ByVal Piva As String,
                            ByVal Sa_Cod As Integer,
                            ByVal Appezza As Integer,
                            ByVal Id_Imp As Integer,
                            ...
                            ByVal QtaMaxN As Decimal,
                            ByVal QtaMaxP2O5 As Decimal,
                            ByVal QtaMaxK2O As Decimal,
        ...
        Try
            ...
            StrSQL.Append("" & Agro_SQL_SaveNum(Trim(Progetto_Cod)) & ", " & vbCrLf)
    ...
    '##############################################################################################
    Public Function AggiornaQtaMax(ByVal PC_Testata_Cod As Integer,
                                   ByVal PC_Entita_Cod As enum_Entita_PianoConcimazione,
                                   ByVal Piva As String,
                                   ByVal Sa_Cod As Integer,
                                   ByVal Appezza As Integer,
    ...
    Public Function CancellaParticella(ByVal Piva As String,
        ...
        Try
            ...
            Else
                ...
                StrSQL.AppendLine(" DELETE FROM PianoConcimazione_EntitaxTestata ")
                StrSQL.AppendLine(" WHERE PC_SuperUser = '" & Agro_SQL_SaveText(objParametri.PivaSuperUser) & "' ")
            ...
            If PC_Testata_Cod <> 0 Then
                StrSQL.AppendLine(" AND   PC_Testata_Cod = " & Agro_SQL_SaveNum(PC_Testata_Cod) & " ")
            Else
