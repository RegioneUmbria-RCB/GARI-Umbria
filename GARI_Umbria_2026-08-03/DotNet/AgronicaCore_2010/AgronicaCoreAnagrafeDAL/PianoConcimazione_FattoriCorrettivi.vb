...
Public Class PianoConcimazione_FattoriCorrettivi_R
    ...
    Public Function Leggi(ByVal Regolamento_Cod As Integer, _
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.PianoConcimazione_FattoriCorrettivi_R.Leggi()"
    ...
    '##############################################################################################
    Public Function LeggiDose(ByVal Regolamento_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.PianoConcimazione_FattoriCorrettivi_R.LeggiDose()"
...
Public Class PianoConcimazione_FattoriCorrettivi_W
    ...
    '##############################################################################################
    Public Function Scrivi(ByVal Regolamento_Cod As Integer,
                           ByVal PC_Testata_Cod As Integer,
    ...
    '##############################################################################################
    Public Function Cancella(ByVal Regolamento_Cod As Integer,
                             ByVal PC_Testata_Cod As Integer,
                             ByVal Fattore_Cod As Integer,
                               ByVal xFiltroAggiuntivo As String,
                                   ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri
