...
Public Class AppezzaxParticellexMacrousi_R
    ...
    Public Function Leggi(ByVal Piva As String, _
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.AppezzaxParticellexMacrousi_R.Leggi()"
        ...
        Try
            ...
            'modificare query
            StrSQL.Length = 0
            StrSQL.Append(" SELECT AppezzamentiXParticellexMacrousi.*, Macrousi.Macrouso_Des, ")
            ...
            StrSQL.Append("        AppezzamentiXParticellexMacrousi ON AppezzamentiXParticelle.PIVA = AppezzamentiXParticellexMacrousi.Piva AND   ")
            StrSQL.Append("        AppezzamentiXParticelle.SA_COD = AppezzamentiXParticellexMacrousi.Sa_cod AND   ")
            StrSQL.Append("        AppezzamentiXParticelle.PROV = AppezzamentiXParticellexMacrousi.PROV AND   ")
            StrSQL.Append("        AppezzamentiXParticelle.APPEZZA = AppezzamentiXParticellexMacrousi.Appezza AND   ")
            StrSQL.Append("        AppezzamentiXParticelle.COM = AppezzamentiXParticellexMacrousi.COM AND   ")
            StrSQL.Append("        AppezzamentiXParticelle.SEZIONE = AppezzamentiXParticellexMacrousi.SEZIONE AND   ")
            StrSQL.Append("        AppezzamentiXParticelle.FOGLIO = AppezzamentiXParticellexMacrousi.FOGLIO AND   ")
            StrSQL.Append("        AppezzamentiXParticelle.NUMERO = AppezzamentiXParticellexMacrousi.NUMERO AND   ")
            StrSQL.Append("        AppezzamentiXParticelle.SUBALTERNO = AppezzamentiXParticellexMacrousi.SUBALTERNO INNER JOIN  ")
            ...
            StrSQL.Append("        Macrousi ON AppezzamentiXParticellexMacrousi.Macrouso_Cod = Macrousi.Macrouso_Cod INNER JOIN  ")
            ...
            StrSQL.Append(" WHERE AppezzamentiXParticellexMacrousi.Validita_inizio <= " & Agro_SQL_SaveDate(objParametri.FinestraTemporaleFine) & " ")
            StrSQL.Append(" AND   AppezzamentiXParticellexMacrousi.Validita_Fine >= " & Agro_SQL_SaveDate(objParametri.FinestraTemporaleInizio) & " ")
            ...
            If Piva <> "" Then
                StrSQL.Append(" AND   AppezzamentiXParticellexMacrousi.Piva = '" & Agro_SQL_SaveText(Piva) & "' ")
            End If

            If Sa_Cod <> 0 Then
                StrSQL.Append(" AND   AppezzamentiXParticellexMacrousi.Sa_Cod = " & Agro_SQL_SaveNum(Sa_Cod) & " ")
            End If

            If Appezza <> 0 Then
                StrSQL.Append(" AND   AppezzamentiXParticellexMacrousi.Appezza = " & Agro_SQL_SaveNum(Appezza) & " ")
            End If

            If PROV <> "" Then
                StrSQL.Append(" AND AppezzamentiXParticellexMacrousi.PROV = '" & Agro_SQL_SaveText(Trim(PROV)) & "' ")
            End If

            If COM <> "" Then
                StrSQL.Append(" AND AppezzamentiXParticellexMacrousi.COM = '" & Agro_SQL_SaveText(Trim(COM)) & "' ")
            End If

            If SEZIONE <> "" Then
                StrSQL.Append(" AND   AppezzamentiXParticellexMacrousi.Sezione = '" & IIf(Agro_SQL_SaveText(SEZIONE, False) <> "", Agro_SQL_SaveText(LCase(SEZIONE)), "0") & "'  ")
                'StrSQL.Append(" AND AppezzamentiXParticellexMacrousi.SEZIONE = '" & Agro_SQL_SaveText(Trim(LCase(SEZIONE))) & "' ")
            End If

            If FOGLIO <> 0 Then
                StrSQL.Append(" AND AppezzamentiXParticellexMacrousi.FOGLIO =  " & Agro_SQL_SaveNum(FOGLIO) & " ")
            End If

            If NUMERO <> 0 Then
                StrSQL.Append(" AND AppezzamentiXParticellexMacrousi.NUMERO =  " & Agro_SQL_SaveNum(NUMERO) & " ")
            End If

            If SUBALTERNO <> "" Then
                StrSQL.Append(" AND   AppezzamentiXParticellexMacrousi.SUBALTERNO =  '" & IIf(Agro_SQL_SaveText(SUBALTERNO, False) <> "", Agro_SQL_SaveText(LCase(SUBALTERNO)), "0") & "' ")
                'StrSQL.Append(" AND AppezzamentiXParticellexMacrousi.SUBALTERNO = '" & Agro_SQL_SaveText(Trim(LCase(SUBALTERNO))) & "' ")
            End If

            If Macrouso_Cod <> "" Then
                StrSQL.Append(" AND AppezzamentiXParticellexMacrousi.Macrouso_Cod = '" & Agro_SQL_SaveText(Trim(LCase(Macrouso_Cod))) & "' ")
            End If
            ...
            Select Case objParametri.FlagVisibilita
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_SoloNonCancellati
                    StrSQL.Append(" AND   AppezzamentiXParticellexMacrousi.Inviato >=0 ")
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_SoloCancellati
                    StrSQL.Append(" AND   AppezzamentiXParticellexMacrousi.Inviato =-1 ")
            ...
            Else
                StrSQL.Append(" ORDER BY AppezzamentiXParticellexMacrousi.Appezza ASC")
            End If
    ...
    '============================================================================
    Public Function Leggi_SuperficieMacrousoUtilizzata(ByVal Piva As String, _
                          ByVal Sa_Cod As Int32, _
                          ByVal Appezza As Int32, _
                            ByVal PROV As String, _
                            ByVal COM As String, _
        ...
        Try
            ...
            StrSQL.Append(" FROM   AppezzamentixParticellexMacrousi ")
...
Public Class AppezzaxParticellexMacrousi_W
    ...
    Public Function Scrivi( _
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.AppezzaxParticellexMacrousi_W.Scrivi()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append("INSERT INTO AppezzamentiXParticellexMacrousi(       ")
            StrSQL.Append("                    PIVA, Sa_Cod, Appezza, PROV, COM, SEZIONE, ")
            StrSQL.Append("                    FOGLIO, NUMERO, SUBALTERNO,  Macrouso_Cod, Superficie,     ")
    ...
    Public Function Modifica( _
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.AppezzaxParticellexMacrousi_W.Modifica()"
        ...
        Try
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append("UPDATE AppezzamentiXParticellexMacrousi SET ")
    ...
    Public Function Modifica_Parametrizzata(
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.AppezzamentiXParticellexMacrousi_W.Modifica_Parametrizzata()"
        Dim MessaggioErrore As String = ""
        Dim StrSQL As New System.Text.StringBuilder
        Dim xRisp As Boolean = False
    ...
    Public Function Cancella( _
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.AppezzaxParticellexMacrousi_W.Cancella()"
        ...
        Try
            ...
            If objParametri.FlagCancellazioneLogica = AgronicaCoreDataProvider.AgronicaCoreParametri.enumCancellazioneLogica.CancellazioneLogica Then
                ...
                StrSQL.Length = 0
                StrSQL.Append(" UPDATE AppezzamentiXParticellexMacrousi ")
                StrSQL.Append(" SET ")
