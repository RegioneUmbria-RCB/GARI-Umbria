...
Public Class SpecieVegetalixCosti_R
    ...
    Public Function Leggi(
        ...
        Dim NomeRoutine As String = "AnagrafeDAL.SpecieVegetalixCosti_R.Leggi()"
        ...
        Try
            ...
            StrSQL.Append(" FROM  SpecieVegetalixCosti, SpecieVegetali ")

            StrSQL.Append(" WHERE   SpecieVegetalixCosti.Validita_inizio <= " & Agro_SQL_SaveDate(FinestraTemp_Fine) & " ")
            StrSQL.Append(" AND     SpecieVegetalixCosti.Validita_Fine >= " & Agro_SQL_SaveDate(FinestraTemp_Inizio) & " ")
            StrSQL.Append(" AND     SpecieVegetalixCosti.Veg_Cod = SpecieVegetali.Veg_Cod ")
            If Veg_Cod <> 0 Then
            ...
            Select Case FlagVisibilita
                Case 1  'Solo i NON CANCELLATI
                    StrSQL.Append(" AND   SpecieVegetalixCosti.Inviato >=0 ")
                Case 2  'Solo i CANCELLATI
                    StrSQL.Append(" AND   SpecieVegetalixCosti.Inviato =-1 ")
                Case 3  'TUTTI
                    '
                Case Else
