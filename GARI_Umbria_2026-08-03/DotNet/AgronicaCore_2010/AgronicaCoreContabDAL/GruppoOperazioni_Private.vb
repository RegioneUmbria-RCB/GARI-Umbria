...
Public Class GruppoOperazioni_Private_R
    ...
    Public Function Leggi( _
        ...
        Try
            ...
            If xSelectInfoMinime = True Then
                StrSQL.Append(" SELECT Gru_Cod_Privato, Gru_Des_Privato ")
            Else
                StrSQL.Append(" SELECT * ")
            End If

            StrSQL.Append(" FROM  GruppoOperazioni_Private ")
            ...
            If Gru_Cod_Privato <> 0 Then
                StrSQL.Append(" AND Gru_Cod_Privato = " & Agro_SQL_SaveNum(Gru_Cod_Privato) & " ")
            End If
            '//////////////////////////////////////////////////////////////////////
            '//////////////////////////////////////////////////////////////////////
            ...
            Else
                StrSQL.Append(" ORDER BY Gru_Des_Privato ASC")
            End If
            '--------------------------------------------------------------------------
