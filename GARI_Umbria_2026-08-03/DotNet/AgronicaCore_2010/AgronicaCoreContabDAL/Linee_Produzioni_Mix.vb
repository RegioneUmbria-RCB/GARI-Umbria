...
Public Class Linee_Produzioni_Mix_R
    ...
    Public Function Leggi( _
        ...
        Try
            ...
            strSQL.Append(" SELECT * from Linee_Produzioni_Mix " + vbCrLf)
...
Public Class Linee_Produzioni_Mix_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi( _
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" INSERT Linee_Produzioni_Mix_W " + vbCrLf)
            ...
            StrSQL.Append("  ,[Gen_Cod] " & vbCrLf)
            StrSQL.Append("  ,[Spe_Cod] " & vbCrLf)
            StrSQL.Append("  ,[Raz_Cod] " & vbCrLf)
            ...
            StrSQL.Append(", " & Agro_SQL_SaveNum(Gen_Cod) & " " & vbCrLf)
            StrSQL.Append(", " & Agro_SQL_SaveNum(Spe_Cod) & " " & vbCrLf)
            StrSQL.Append(", " & Agro_SQL_SaveNum(Raz_Cod) & " " & vbCrLf)
            StrSQL.Append(", " & Agro_SQL_SaveNum(Livello) & " " & vbCrLf)
