...
Public Class BCP_DatiAziende_WS_R
    ...
    Public Function Leggi( _
                            ...
                            ByVal ElemLiv1 As String, _
                            ByVal ElemLiv2 As String, _
                            ByVal ElemLiv3 As String, _
                            ByVal ElemLiv4 As String, _
    ...
    Public Function Leggi_SE_Specie( _
                                    ByVal SessionID As String, _
                                    ByVal Azienda As String, _
                                    ByVal Anno As String, _
                                        ByVal xSelezioneVariabile As AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile, _
    ...
    Public Function Leggi_SE_Operazioni( _
                                    ByVal SessionID As String, _
                                    ByVal Azienda As String, _
                                    ByVal Anno As String, _
                                    ByVal Specie As String, _
