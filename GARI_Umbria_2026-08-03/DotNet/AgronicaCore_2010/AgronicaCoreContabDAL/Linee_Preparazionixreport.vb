...
Public Class Linee_Preparazionixreport_R
    ...
    Public Function Leggi( _
        ...
        Try
            ...
            strSQL.Append(" SELECT Linee_Preparazionixreport " + vbCrLf)
...
Public Class Linee_Preparazionixreport_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi( _
                        ...
                        , ByVal StrCampo_Registri As String _
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" INSERT Linee_Preparazionixreport " + vbCrLf)

            StrSQL.Append("              (")

            StrSQL.Append("   [Piva] " & vbCrLf)
            StrSQL.Append("  ,[Preparazione_Cod] " & vbCrLf)
            StrSQL.Append("  ,[Id_Report] " & vbCrLf)
            StrSQL.Append("  ,[StrCampo_Registri] " & vbCrLf)
            ...
            StrSQL.Append(", " & Agro_SQL_SaveNum(Id_Report) & " " & vbCrLf)
            StrSQL.Append(",'" & Agro_SQL_SaveText(StrCampo_Registri) & "'" & vbCrLf)
