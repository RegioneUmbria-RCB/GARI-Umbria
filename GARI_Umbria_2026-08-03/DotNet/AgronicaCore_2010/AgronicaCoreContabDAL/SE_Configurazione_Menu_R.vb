...
Public Class SE_Configurazione_Menu_R
    ...
    Public Function Leggi_Foglie(ByVal Piva_SuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.SE_Configurazione_Menu_R.Leggi_Foglie()"
        ...
        Try
            ...
            StrSQL.Append(" FROM  SE_Configurazione_Menu_Foglie")
            ...
            Select Case FlagVisibilita
                Case 1  'Solo i NON CANCELLATI
                    StrSQL.Append(" AND     SE_Configurazione_Menu_Foglie.Inviato >= 0 ")
                Case 2  'Solo i CANCELLATI
                    StrSQL.Append(" AND     SE_Configurazione_Menu_Foglie.Inviato = -1 ")
                Case 3  'TUTTI
                    '
                Case Else
    ...
    Public Function Leggi_Foglie(ByVal Piva_SuperUser As String,
        ...
        Try
            ...
            If Elemento_Cod <> 0 Then
                ...
                StrSQL.Append(" AND Elemento_Cod = " & Agro_SQL_SaveNum(Elemento_Cod) & " ")
    ...
    '============================================================================
    Public Function Leggi_Foglie_Default(ByVal Piva_SuperUser As String,
                                         ByVal Servizio As Int32,
                                         ByVal Nodo_Codice As Int32,
                                         ByVal FinestraTemp_Inizio As Date,
                                         ByVal FinestraTemp_Fine As Date,
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.SE_Configurazione_Menu_R.Leggi_Foglie_Default()"
        ...
        Try
            ...
            StrSQL.Length = 0
            StrSQL.Append(" SELECT * ")
            StrSQL.Append(" FROM  SE_Configurazione_Menu_Foglie F")
            StrSQL.Append(" INNER JOIN  SE_MacrovociDefault D ")
            StrSQL.Append(" ON  F.Piva_SuperUser = D.Piva_SuperUser AND F.Elemento_Cod = D.Elemento_Cod  ")

            StrSQL.Append(" WHERE D.Validita_Inizio <= " & Agro_SQL_SaveDate(FinestraTemp_Fine) & "  ")
            StrSQL.Append(" AND   D.Validita_Fine >= " & Agro_SQL_SaveDate(FinestraTemp_Inizio) & "  ")
            ...
            If Piva_SuperUser <> "" Then
                StrSQL.Append(" AND F.Piva_SuperUser = '" & Agro_SQL_SaveText(Piva_SuperUser) & "'")
            End If

            If Servizio <> 0 Then
                StrSQL.Append(" AND F.Servizio = " & Agro_SQL_SaveNum(Servizio) & " ")
            End If

            If Nodo_Codice <> 0 Then
                StrSQL.Append(" AND F.Nodo_Codice = " & Agro_SQL_SaveNum(Nodo_Codice) & " ")
            End If


            StrSQL.Append(" ORDER BY F.Piva_SuperUser, F.Servizio, F.Nodo_Codice, F.Ordinamento ASC")
    ...
    Public Function Leggi_Nodo(ByVal Piva_SuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreAnagrafeDAL.SE_Configurazione_Menu_R.Leggi_Nodo()"
        ...
        Try
            ...
            StrSQL.Length = 0
            StrSQL.Append(" SELECT * ")
            StrSQL.Append(" FROM  SE_Configurazione_Menu_Nodo")
            StrSQL.Append(" WHERE Validita_inizio <= " & Agro_SQL_SaveDate(FinestraTemp_Fine) & " ")
            StrSQL.Append(" AND   Validita_Fine >= " & Agro_SQL_SaveDate(FinestraTemp_Inizio) & " ")

            Select Case FlagVisibilita
                Case 1  'Solo i NON CANCELLATI
                    StrSQL.Append(" AND     SE_Configurazione_Menu_Nodo.Inviato >= 0 ")
                Case 2  'Solo i CANCELLATI
                    StrSQL.Append(" AND     SE_Configurazione_Menu_Nodo.Inviato = -1 ")
                Case 3  'TUTTI
                    '
                Case Else
                    Throw New Exception("Parametro non corretto nella query (FlagVisibilita)")
