...
Public Class Linee_Preparazioni_Report_Esclusi_R
    ...
    Public Function Leggi( _
        ...
        Try
            ...
            strSQL.Append(" SELECT * from Linee_Preparazioni_Report_Esclusi " + vbCrLf)
...
Public Class Linee_Preparazioni_Report_Esclusi_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi( _
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" INSERT Linee_Preparazioni_Report_Esclusi " + vbCrLf)
