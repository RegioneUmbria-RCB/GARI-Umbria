...
Public Class SE_Dettagli_W
    ...
    Public Function Scrivi(ByVal Piva_SuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreContabDAL.SE_Dettagli_W.Scrivi()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" INSERT INTO SE_Dettagli ")
            StrSQL.Append("             (Piva_Superuser, Piva,    Macrovoce_Cod, Veg_Cod, Operazione_Cod, ")
            StrSQL.Append("              Lav_Cod,  Dettaglio_Cod, ")
            StrSQL.Append("              Elem_Cod,  Descrizione, Pro_Cod, Cod_Risum, Mac_Cod, Qta, Udm_Cod, Prezzo, Classe, ")
            ...
            StrSQL.Append("         , " & Agro_SQL_SaveNum(Dettaglio_Cod) & "  ")
            ...
            StrSQL.Append("         , " & Agro_SQL_SaveNum(Prezzo) & "  ")
            StrSQL.Append("         ,'" & Agro_SQL_SaveText(Classe) & "'  ")
            StrSQL.Append("         , 0  ")
            StrSQL.Append("         , Null  ")
    ...
    Public Function Modifica(ByVal Piva_SuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreContabDAL.SE_Dettagli_W.Modifica()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" UPDATE SE_Dettagli SET ")
            ...
            StrSQL.Append("   ,Cod_Risum =  " & Agro_SQL_SaveNum(Cod_Risum) & "   ")
            StrSQL.Append("   ,Mac_Cod =  " & Agro_SQL_SaveNum(Mac_Cod) & "   ")
            StrSQL.Append("   ,Qta =  " & Agro_SQL_SaveNum(Qta) & "   ")
            StrSQL.Append("   ,Udm_Cod =  " & Agro_SQL_SaveNum(Udm_Cod) & "   ")
            StrSQL.Append("   ,Prezzo =  " & Agro_SQL_SaveNum(Prezzo) & "   ")
    ...
    Public Function Cancella(ByVal Piva_SuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreContabDAL.SE_Dettagli_W.Cancella()"
        ...
        Try
            ...
            If FlagCancellazioneLogica Then
                ...
                StrSQL.Length = 0
                StrSQL.Append(" UPDATE SE_Dettagli ")
                StrSQL.Append(" SET ")
                StrSQL.Append("      Username_Modifica = '" & Agro_SQL_SaveText(UserName_Modifica) & "' ")
            ...
            If Dettaglio_Cod <> 0 Then
                StrSQL.Append(" AND Lav_Cod = " & Agro_SQL_SaveNum(Dettaglio_Cod) & "   ")
            End If
