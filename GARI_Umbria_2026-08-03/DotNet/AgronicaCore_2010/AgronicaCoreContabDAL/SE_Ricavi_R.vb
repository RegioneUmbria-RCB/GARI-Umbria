...
Public Class SE_Ricavi_R
    ...
    Public Function Leggi(
        ...
        Dim NomeRoutine As String = "AgronicaCoreContabDAL.SE_Ricavi_R.Leggi()"
        ...
        Try
            ...
            StrSQL.Append(" ORDER BY Piva_SuperUser, Piva, Veg_Cod, Validita_Inizio ASC ")
