...
Public Class SE_Macrovoci_W
    ...
    Public Function Scrivi(ByVal Piva_SuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreContabDAL.SE_Macrovoci_W.Scrivi()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" INSERT INTO SE_Macrovoci ")
            StrSQL.Append("             (Piva_Superuser, Piva,    Macrovoce_Cod, Veg_Cod, Costo, ")
    ...
    Public Function Modifica(ByVal Piva_SuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreContabDAL.SE_Macrovoci_W.Modifica()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" UPDATE SE_Macrovoci SET ")
    ...
    Public Function Cancella(ByVal Piva_SuperUser As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreContabDAL.SE_Macrovoci_W.Cancella()"
        ...
        Try
            ...
            If FlagCancellazioneLogica Then
                ...
                StrSQL.Length = 0
                StrSQL.Append(" UPDATE SE_Macrovoci ")
                StrSQL.Append(" SET ")
                StrSQL.Append("      Username_Modifica = '" & Agro_SQL_SaveText(UserName_Modifica) & "' ")
