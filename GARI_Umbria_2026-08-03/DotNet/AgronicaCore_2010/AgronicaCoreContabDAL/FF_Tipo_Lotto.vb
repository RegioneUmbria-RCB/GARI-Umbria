...
Public Class FF_Tipo_Lotto_R
    ...
    Public Function Leggi( _
        ...
        Try
            ...
            Stb.Append(" FROM FF_Tipo_Lotto " & vbCrLf)
    ...
    Public Function LeggiXFlusso(
        ByVal Flusso As FF_Track_Flusso,
        ...
        Try
            ...
            Stb.Append(" FROM FF_Tipo_Lotto " & vbCrLf)
            Stb.Append(" WHERE 1=1 " & vbCrLf)
            If Flusso <> FF_Track_Flusso.Tutti Then
                Stb.Append(" AND  Flusso=" & Agro_SQL_SaveNum(Flusso) & vbCrLf)
            End If
            If xFiltroAggiuntivo <> "" Then
                Stb.Append(" AND " & Agro_SQL_Save_xFiltroAggiuntivo(xFiltroAggiuntivo, , objParametri))
            End If
    ...
    Public Function CheckTipoLottoXFlusso(
        ...
        Try
            ...
            Stb.Append(" FROM FF_Tipo_Lotto " & vbCrLf)
            Stb.Append(" WHERE 1=1 " & vbCrLf)
            Stb.Append(" AND  FF_Tipo_Lotto_Cod=" & Agro_SQL_SaveNum(TipoLotto) & vbCrLf)
            If Flusso <> FF_Track_Flusso.Tutti Then
                Stb.Append(" AND  (Flusso=" & Agro_SQL_SaveNum(Flusso) & " or Flusso=0)" & vbCrLf)
            End If
            If xFiltroAggiuntivo <> "" Then
                Stb.Append(" AND " & Agro_SQL_Save_xFiltroAggiuntivo(xFiltroAggiuntivo, , objParametri))
            End If
    ...
    Public Function CheckEsponiDatiGISxTipoLotto(
        ByVal TipoLotto As Integer,
        ByVal xFiltroAggiuntivo As String,
        ByVal xOrderBy As String,
        ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri
        ...
        Try
            ...
            Stb.Append(" SELECT EsponiDatiGIS " & vbCrLf)
            Stb.Append(" FROM FF_Tipo_Lotto " & vbCrLf)
            Stb.Append(" WHERE 1=1 " & vbCrLf)
            Stb.Append(" AND  FF_Tipo_Lotto_Cod=" & Agro_SQL_SaveNum(TipoLotto) & vbCrLf)
            If xFiltroAggiuntivo <> "" Then
            ...
            If DT.Rows.Count() > 0 Then
                ret = Convert.ToBoolean(DT.Rows(0)("EsponiDatiGIS"))
            Else
                ret = False
            End If
