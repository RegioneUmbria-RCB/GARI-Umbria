...
Imports AgronicaCoreUmaDal.UMA_Richieste_Trasferimenti_R
Public Class UMA_Richieste_Trasferimenti_BIZ
    ...
    Public Function Leggi(ByVal piva As String,
        ...
        Dim AgronicaDAL As New UMA_Richieste_Trasferimenti_R
        Dim MessaggioErrore As String
        Dim result As DataTable
        Dim FlagConnessioneLocale As Boolean = False
        Dim FlagTransazioneLocale As Boolean = False
        Dim NomeRoutine As String = "UMA_Richieste_Trasferimenti_BIZ.Leggi()"
        Try
    ...
    End Function
    Public Function Salva_Trasferimenti(ByRef objParametri As AgronicaCoreParametri,
                                                righeinseriteJson As String,
                                                righeModificateJson As String,
                                                righeCancellateJson As String) As RispostaStandard

        Const nomeRoutine = "AgronicaCoreAnagrafeBIZ.UMA_Richieste_Trasferimenti_BIZ.Salva_Trasferimenti()"

        '-------------------- Dichiarazioni di variabili ----------------------
        Dim MessaggioErrore As String = ""

        Dim AgronicaDAL As New UMA_Richieste_Trasferimenti_W
        ...
        Dim righeInseriteArr As List(Of UMA_Richieste_Trasferimenti_W.RichiesteTrasferimenti) = JsonConvert.DeserializeObject(Of List(Of UMA_Richieste_Trasferimenti_W.RichiesteTrasferimenti))(righeinseriteJson, deserializerSettings)
        Dim righeModificateArr As List(Of UMA_Richieste_Trasferimenti_W.RichiesteTrasferimenti) = JsonConvert.DeserializeObject(Of List(Of UMA_Richieste_Trasferimenti_W.RichiesteTrasferimenti))(righeModificateJson, deserializerSettings)
        Dim righeCancellateArr As List(Of UMA_Richieste_Trasferimenti_W.RichiesteTrasferimenti) = JsonConvert.DeserializeObject(Of List(Of UMA_Richieste_Trasferimenti_W.RichiesteTrasferimenti))(righeCancellateJson, deserializerSettings)
