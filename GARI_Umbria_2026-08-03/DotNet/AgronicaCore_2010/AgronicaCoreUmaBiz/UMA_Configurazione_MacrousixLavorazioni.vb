...
Public Class UMA_Configurazione_MacrousixLavorazioni_BIZ
    ...
    Public Function AgronicaCoreDataProvider_Leggi(ByRef objParametri As AgronicaCoreParametri, Optional InizioValidita As String = "", Optional FineValidita As String = "") As DataTable
        ...
        Try
            result = AgronicaDAL.Leggi(objParametri, InizioValidita, FineValidita)
    ...
    Public Shared Sub ControlliValidita_LavorazioniUMA(ByVal righeInserite As List(Of LavorazioneUMA),
        ...
        If String.IsNullOrEmpty(Errori) Then
            ...
            Dim ListaRighe As New List(Of UMA_Configurazione_MacrousixLavorazioni_W.LavorazioneUMA)
    ...
    Public Function LeggiElenco_UMA_Macrousi(objParametri_Server As AgronicaCoreParametri) As DataTable
        ...
        Dim biz As New AgronicaCoreUmaDal.UMA_Configurazione_MacrousixLavorazioni_R
