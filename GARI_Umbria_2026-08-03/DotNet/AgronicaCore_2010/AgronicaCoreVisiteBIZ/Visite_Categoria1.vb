...
Public Class Visite_Categoria1_R
    ...
    Public Function Leggi(ByRef objParametri As AgronicaCoreParametri) As DataTable
        ...
        Dim r As New AgronicaCoreVisiteDAL.Visite_Categoria1_R
        Return r.Leggi(objParametri)

    End Function

    Public Function TestNomeCategoria1GiaEsistente(ByRef objParametri As AgronicaCoreParametri, nome As String) As Boolean
        Dim r As New AgronicaCoreVisiteDAL.Visite_Categoria1_R
        Dim dt As DataTable = r.Leggi(0, nome, objParametri)

        'Se c'è almeno un record vuol dire che il nome esiste già
        Return (dt.Rows.Count > 0)

    End Function

    Public Function TestCategoria1GiaInUso(ByRef objParametri As AgronicaCoreParametri, ID_Categoria1 As Integer) As Boolean
...
Public Class Visite_Categoria1_W
    ...
    Public Function Aggiungi(ByRef objParametri As AgronicaCoreParametri,
        ...
        Dim r As New AgronicaCoreVisiteBIZ.Visite_Categoria1_R
        If r.TestNomeCategoria1GiaEsistente(objParametri, Nome) Then
        ...
        Try
            ...
            Dim ID_Categoria1 As Integer = seq.NuovoId_Tabella("Visiste_ID_Categoria1", 0, 2000000000, objParametri)

            'Salvo il nuovo elemento
            Dim w As New AgronicaCoreVisiteDAL.Visite_Categoria1_W
            Dim esito As Boolean = w.Scrivi(ID_Categoria1, Nome, objParametri)
    ...
    Public Function Modifica(ByRef objParametri As AgronicaCoreParametri,
        ...
        Try
            ...
            'Modifico l'elemento
            Dim w As New AgronicaCoreVisiteDAL.Visite_Categoria1_W
            Dim esito As Boolean = w.Modifica(ID_Categoria1, Nome, objParametri)
    ...
    Public Function Cancella(ByRef objParametri As AgronicaCoreParametri,
        ...
        Dim r As New AgronicaCoreVisiteBIZ.Visite_Categoria1_R
        If r.TestCategoria1GiaInUso(objParametri, ID_Categoria1) Then
            Return "Errore: La Categoria ha delle sottocategorie, impossibile eliminare"
        End If
        ...
        Try
            ...
            'Cancello l'elemento
            Dim w As New AgronicaCoreVisiteDAL.Visite_Categoria1_W
            Dim esito As Boolean = w.Cancella(ID_Categoria1, objParametri)
