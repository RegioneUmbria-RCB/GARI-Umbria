...
Public Class NC_LineeImpianti_R
    ...
    Public Function Leggi( _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_LineeImpianti_R.Leggi"
        ...
        Try
            ...
            strSQL.AppendLine(" SELECT ID_LineaImpianto, Nome ")
            strSQL.AppendLine(" FROM NC_LineeImpianti ")
...
Public Class NC_LineeImpianti_W
    ...
    Public Function Modifica(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_LineeImpianti_W.Modifica()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.AppendLine(" UPDATE NC_LineeImpianti SET")

            StrSQL.AppendLine("  Nome = " & Agro_SQL_SaveText_NULL(New_Nome))
            ...
            StrSQL.AppendLine("	WHERE PivaSuperUser = " & Agro_SQL_SaveText_NULL(objParametri.PivaSuperUser))
            StrSQL.AppendLine("	AND ID_LineaImpianto  =		" & Agro_SQL_SaveNum_NULL(Old_ID_LineaImpianto))
    ...
    Public Function Scrivi(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_LineeImpianti_W.Scrivi()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.AppendLine(" INSERT INTO  NC_LineeImpianti")

            StrSQL.AppendLine("              (")
            StrSQL.AppendLine("              PivaSuperUser,      ")
            StrSQL.AppendLine("              ID_LineaImpianto,         Nome, ")
            ...
            StrSQL.AppendLine("			," & Agro_SQL_SaveNum_NULL(ID_LineaImpianto))
            StrSQL.AppendLine("			," & Agro_SQL_SaveText_NULL(Nome))
    ...
    Public Function Cancella(ByVal xFiltroAggiuntivo As String, _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_LineeImpianti_W.Cancella()"
        ...
        Try
            ...
            Else
                StrSQL.AppendLine(" DELETE FROM NC_LineeImpianti ")
                StrSQL.AppendLine(" WHERE PivaSuperUser = " & Agro_SQL_SaveText_NULL(objParametri.PivaSuperUser))
                StrSQL.AppendLine("	AND ID_LineaImpianto =		" & Agro_SQL_SaveNum_NULL(ID_LineaImpianto))
            End If
            '---------------------------------------------
