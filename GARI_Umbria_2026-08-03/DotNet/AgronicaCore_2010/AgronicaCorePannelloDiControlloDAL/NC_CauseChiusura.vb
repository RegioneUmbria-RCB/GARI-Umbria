...
Public Class NC_CauseChiusura_R
    ...
    Public Function Leggi( _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_Stati_R.Leggi"
        ...
        Try
            ...
            strSQL.AppendLine(" SELECT ID_CausaChiusura, Nome ")
            strSQL.AppendLine(" FROM NC_CauseChiusura ")
...
Public Class NC_CauseChiusura_W
    ...
    Public Function Modifica(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_ID_CauseChiusura_W.Modifica()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.AppendLine(" UPDATE NC_CauseChiusura SET")
            ...
            StrSQL.AppendLine("	WHERE PivaSuperUser = " & Agro_SQL_SaveText_NULL(objParametri.PivaSuperUser))
            StrSQL.AppendLine("	AND ID_CausaChiusura  =		" & Agro_SQL_SaveNum_NULL(Old_ID_CausaChiusura))
    ...
    Public Function Scrivi(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_CauseChiusura_W.Scrivi()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.AppendLine(" INSERT INTO  NC_CauseChiusura")

            StrSQL.AppendLine("              (")
            StrSQL.AppendLine("              PivaSuperUser,      ")
            StrSQL.AppendLine("              ID_CausaChiusura,   Nome, ")
            ...
            StrSQL.AppendLine("			," & Agro_SQL_SaveNum_NULL(ID_CausaChiusura))
    ...
    Public Function Cancella(ByVal xFiltroAggiuntivo As String, _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_CauseChiusura_W.Cancella()"
        ...
        Try
            ...
            Else
                StrSQL.AppendLine(" DELETE FROM NC_CauseChiusura ")
                StrSQL.AppendLine(" WHERE PivaSuperUser = " & Agro_SQL_SaveText_NULL(objParametri.PivaSuperUser))
                StrSQL.AppendLine("	AND ID_CausaChiusura =		" & Agro_SQL_SaveNum_NULL(ID_CausaChiusura))
            End If
            '---------------------------------------------
