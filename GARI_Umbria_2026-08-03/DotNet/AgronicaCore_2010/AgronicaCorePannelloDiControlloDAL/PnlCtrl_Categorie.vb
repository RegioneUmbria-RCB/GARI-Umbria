...
Public Class Categorie_R
    ...
    '##############################################################################################
    Public Function Leggi_Categorie( _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.PnlCtrl_Categorie_R.Leggi_Categorie"
        ...
        Try
            ...
            strSQL.Append(" SELECT ID, TipoCategoria, Area, Tipologia " + vbCrLf)
            strSQL.Append(" FROM PnlCtrl_Categorie ")
            ...
            If Not IsNothing(TipoCatgoria) Then
                strSQL.Append(" AND TipoCategoria = " & Agro_SQL_SaveNum_NULL(TipoCatgoria))
            End If

            If Not IsNothing(Area) Then
                strSQL.Append(" AND Area = " & Agro_SQL_SaveText_NULL(Area))
            End If

            If Not IsNothing(Tipologia) Then
                strSQL.Append(" AND Tipologia = " & Agro_SQL_SaveText_NULL(Tipologia))
            End If
...
Public Class Categorie_W
    ...
    Public Function Modifica(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.PnlCtrl_Categorie_W.Modifica()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" UPDATE PnlCtrl_Categorie SET" + vbCrLf)

            StrSQL.Append("  Area = " & Agro_SQL_SaveText_NULL(New_Area) & vbCrLf)
            StrSQL.Append(", Tipologia = " & Agro_SQL_SaveText_NULL(New_Tipologia) & vbCrLf)
    ...
    Public Function Scrivi(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
                            ByVal ID As Integer, _
                            ByVal TipoCategoria As Integer, _
                            ByVal Area As String, _
                            ByVal Tipologia As String, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.PnlCtrl_Categorie_W.Scrivi()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.Append(" INSERT INTO  PnlCtrl_Categorie" + vbCrLf)

            StrSQL.Append("              (")
            StrSQL.Append("              PivaSuperUser,                 ")
            StrSQL.Append("              ID,                            TipoCategoria, ")
            StrSQL.Append("              Area,                          Tipologia, ")
            ...
            StrSQL.Append("			," & Agro_SQL_SaveNum_NULL(TipoCategoria))
            StrSQL.Append("			," & Agro_SQL_SaveText_NULL(Area))
            StrSQL.Append("			," & Agro_SQL_SaveText_NULL(Tipologia))
