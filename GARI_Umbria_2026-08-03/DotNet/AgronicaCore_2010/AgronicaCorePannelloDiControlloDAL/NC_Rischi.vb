...
Public Class NC_Rischi_R
    ...
    Public Function Leggi( _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_Rischi_R.Leggi"
        ...
        Try
            ...
            strSQL.AppendLine(" SELECT ID_Rischio, Nome ")
            strSQL.AppendLine(" FROM NC_Rischi ")
...
Public Class NC_Rischi_W
    ...
    Public Function Modifica(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_Rischi_W.Modifica()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.AppendLine(" UPDATE NC_Rischi SET")
            ...
            StrSQL.AppendLine("	WHERE PivaSuperUser = " & Agro_SQL_SaveText_NULL(objParametri.PivaSuperUser))
            StrSQL.AppendLine("	AND ID_Rischio  =		" & Agro_SQL_SaveNum_NULL(Old_ID_Rischio))
    ...
    Public Function Scrivi(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_Rischi_W.Scrivi()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.AppendLine(" INSERT INTO  NC_Rischi")

            StrSQL.AppendLine("              (")
            StrSQL.AppendLine("              PivaSuperUser,      ")
            StrSQL.AppendLine("              ID_Rischio,         Nome, ")
            ...
            StrSQL.AppendLine("			," & Agro_SQL_SaveNum_NULL(ID_Rischio))
    ...
    Public Function Cancella(ByVal xFiltroAggiuntivo As String, _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_Rischi_W.Cancella()"
        ...
        Try
            ...
            Else
                StrSQL.AppendLine(" DELETE FROM NC_Rischi ")
                StrSQL.AppendLine(" WHERE PivaSuperUser = " & Agro_SQL_SaveText_NULL(objParametri.PivaSuperUser))
                StrSQL.AppendLine("	AND ID_Rischio =		" & Agro_SQL_SaveNum_NULL(ID_Rischio))
            End If
            '---------------------------------------------
