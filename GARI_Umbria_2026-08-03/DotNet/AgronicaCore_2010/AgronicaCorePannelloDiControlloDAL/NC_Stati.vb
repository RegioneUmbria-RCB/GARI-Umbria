...
Public Class NC_Stati_R
    ...
    Public Function Leggi( _
        ...
        Try
            ...
            strSQL.AppendLine(" SELECT ID_Stato, Nome ")
            strSQL.AppendLine(" FROM NC_Stati ")
...
Public Class NC_Stati_W
    ...
    Public Function Modifica(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_Stati_W.Modifica()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.AppendLine(" UPDATE NC_Stati SET")
            ...
            StrSQL.AppendLine("	WHERE PivaSuperUser = " & Agro_SQL_SaveText_NULL(objParametri.PivaSuperUser))
            StrSQL.AppendLine("	AND ID_Stato  =		" & Agro_SQL_SaveNum_NULL(Old_ID_Stato))
    ...
    Public Function Scrivi(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri, _
        ...
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_Stati_W.Scrivi()"
        ...
        Try
            ...
            '---------------------------------------------
            StrSQL.Length = 0
            StrSQL.AppendLine(" INSERT INTO  NC_Stati")

            StrSQL.AppendLine("              (")
            StrSQL.AppendLine("              PivaSuperUser,      ")
            StrSQL.AppendLine("              ID_Stato,           Nome, ")
            ...
            StrSQL.AppendLine("			," & Agro_SQL_SaveNum_NULL(ID_Stato))
    ...
    Public Function Cancella(ByVal xFiltroAggiuntivo As String, _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCorePannelloDiControlloDAL.NC_Stati_W.Cancella()"
        ...
        Try
            ...
            Else
                StrSQL.AppendLine(" DELETE FROM NC_Stati ")
                StrSQL.AppendLine(" WHERE PivaSuperUser = " & Agro_SQL_SaveText_NULL(objParametri.PivaSuperUser))
                StrSQL.AppendLine("	AND ID_Stato =		" & Agro_SQL_SaveNum_NULL(ID_Stato))
            End If
            '---------------------------------------------
