...
Public Class Interscambio_Analisi_Testata_R
    ...
    Public Function Leggi(Sistema_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreInterscambioDAL.Interscambio_Analisi_Testata_R.Leggi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" FROM   Interscambio_Analisi_Testata ")
...
Public Class Interscambio_Analisi_Testata_W
    ...
    Public Function Scrivi(Sistema_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreInterscambioDAL.Interscambio_Analisi_Testata_W.Scrivi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" INSERT INTO Interscambio_Analisi_Testata ( ")
    ...
    Public Function Cancella(Sistema_Cod As Integer,
        ...
        Try
            ...
            StrSQL.AppendLine(" DELETE FROM Interscambio_Analisi_Testata  ")

            StrSQL.AppendLine(" WHERE Sistema_Cod = " & Agro_SQL_SaveNum(Sistema_Cod) & " ")
            StrSQL.AppendLine(" AND Analisi_Testata_Cod = " & Agro_SQL_SaveNum(Analisi_Testata_Cod) & " ")
            StrSQL.AppendLine(" AND Codice_Esterno = '" & Agro_SQL_SaveText(Codice_Esterno) & "' ")
