...
Public Class Interscambio_SquadreXAttivita_R
    ...
    Public Function Leggi(Sistema_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreInterscambioDAL.Interscambio_SquadreXAttivita_R.Leggi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" FROM   Interscambio_SquadreXAttivita ")
            ...
            If ID_Squadra <> 0 Then
                StrSQL.AppendLine(" AND ID_Squadra = " & Agro_SQL_SaveNum(ID_Squadra) & "")
            End If
...
Public Class Interscambio_SquadreXAttivita_W
    ...
    Public Function Scrivi(Sistema_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreInterscambioDAL.Interscambio_SquadreXAttivita_W.Scrivi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" INSERT INTO Interscambio_SquadreXAttivita ( ")
            StrSQL.AppendLine("           Sistema_Cod")

            StrSQL.AppendLine("         , Piva")
            StrSQL.AppendLine("         , ID_Squadra")
            ...
            StrSQL.AppendLine("          , " & Agro_SQL_SaveNum(ID_Squadra) & " ")
    ...
    Public Function Cancella(Sistema_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreInterscambioDAL.Interscambio_SquadreXAttivita_W.Cancella()"
        ...
        Try
            ...
            StrSQL.AppendLine(" Delete FROM Interscambio_SquadreXAttivita ")
