...
Public Class Interscambio_Materie_Prime_R
    ...
    Public Function Leggi(Sistema_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreInterscambioDAL.Interscambio_Materie_Prime_R.Leggi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" FROM   Interscambio_Materie_Prime ")
...
Public Class Interscambio_Materie_Prime_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi(Sistema_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreInterscambioDAL.Interscambio_Materie_Prime_W.Scrivi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" INSERT INTO Interscambio_Materie_Prime ( ")
