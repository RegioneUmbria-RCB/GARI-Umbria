...
Public Class Sementieri_EstrazioneColtivazioni_R
    ...
    Public Function Leggi(
        ...
        Dim NomeRoutine As String = "AgronicaCoreSementieriDAL.Sementieri_EstrazioneColtivazioni_R.Leggi()"
        ...
        Try
            ...
            Select Case xSelezioneVariabile
                ...
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta
                    ...
                    Stb.Append("select SEC.Progressivo " & vbCrLf)
                    Stb.Append(", SEC.Ditta_Sementiera" & vbCrLf)
                    Stb.Append(", SEC.Id_Appezzamento " & vbCrLf)
                    Stb.Append(", SEC.Specie_NC " & vbCrLf)
                    Stb.Append(", SEC.Specie_NS " & vbCrLf)
                    Stb.Append(", SEC.Tipologia " & vbCrLf)
                    Stb.Append(", SEC.Provincia " & vbCrLf)
                    Stb.Append(", SEC.Comune " & vbCrLf)
                    Stb.Append(", SEC.Azienda_Agricola " & vbCrLf)
                    Stb.Append(", SEC.Indirizzo_Appezzamento " & vbCrLf)
                    Stb.Append(", SEC.Latitudine " & vbCrLf)
                    Stb.Append(", SEC.Longitudine " & vbCrLf)
                    Stb.Append(", SEC.Superficie " & vbCrLf)
                    Stb.Append("FROM [dbo].[Sementieri_Estrazione_Coltivazioni] SEC " & vbCrLf)

                    Stb.Append(" WHERE 1=1 " & vbCrLf)
                    If Estrazione_Id <> 0 Then
                        Stb.Append(String.Format(" And SEC.Progressivo = {0} ", Agro_SQL_SaveNum(Estrazione_Id)) & vbCrLf)
                    End If

                    If Sementieri_Sportello_Configurazione_cod <> 0 Then
                        Stb.Append(String.Format(" And SEC.Sementieri_Sportello_Configurazione_cod = {0} ", Agro_SQL_SaveNum(Sementieri_Sportello_Configurazione_cod)) & vbCrLf)
                    End If

                    If Not Tipologia_Report.Equals("") Then
                        Stb.Append(String.Format(" And UPPER(SEC.Tipologia_Report) = '{0}' ", Agro_SQL_SaveText(Tipologia_Report.ToUpper.Trim)) & vbCrLf)
                    End If

                    If Not Regione.Equals("") Then
                        Stb.Append(String.Format(" And UPPER(SEC.Regione) = '{0}' ", Agro_SQL_SaveText(Regione.ToUpper.Trim)) & vbCrLf)
                    End If
...
Public Class Sementieri_EstrazioneColtivazioni_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi(ByVal Sementieri_Sportello_Configurazione_cod As Integer,
        ...
        Const nomeRoutine = "AgronicaCoreSementieriDAL.Sementieri_EstrazioneColtivazioni_W.Scrivi()"
        ...
        Try
            strSql.Length = 0
            strSql.AppendLine(" INSERT INTO Sementieri_Estrazione_Coltivazioni ")
            strSql.AppendLine("( ")
            strSql.AppendLine(" [Sementieri_Sportello_Configurazione_cod] ")
            strSql.AppendLine(" ,[Regione] ")
            strSql.AppendLine(" ,[Tipologia_Report] ")
            ...
            strSql.AppendLine(", '" & Agro_SQL_SaveText(Tipologia_Report) & "' ")
    ...
    Public Function Elimina(ByVal Sementieri_Sportello_Configurazione_cod As Integer,
        ...
        Const nomeRoutine = "AgronicaCoreSementieriDAL.Sementieri_EstrazioneColtivazioni_W.Elimina()"
        ...
        Try
            strSql.Length = 0
            strSql.AppendLine(" DELETE from Sementieri_Estrazione_Coltivazioni ")
            strSql.AppendLine(" WHERE Tipologia_Report = '" & Agro_SQL_SaveText(Tipologia_Report) & "' ")
