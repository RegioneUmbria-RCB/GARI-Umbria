...
Public Class Mappatura_Specie_Distanze_Bietola_R
    ...
    Public Function Leggi( _
        ...
        Try
            ...
            stb.Append("FROM         Mappatura_Specie_Distanze_Bietola " & vbCrLf)
...
Public Class Mappatura_Specie_Distanze_Bietola_W
    Inherits AgronicaCoreDataProvider.DataProvider
