...
Public Class Sementieri_Sportello_InterferenzePerConferma_Notifiche_R
    ...
    Public Function leggi(
        ...
        Try
            ...
            Stb.AppendLine(" From Sementieri_Sportello_InterferenzePerConferma_Notifiche ")
            Stb.AppendLine(" where PivaSuperUser = '" & objParametri.PivaSuperUser & "' ")
            Stb.AppendLine(" and utente = '" & objParametri.UtenteUsername & "' ")
            Stb.AppendLine(" and Interferenze_Cod = " & Interferenze_Cod & " ")
...
Public Class Sementieri_Sportello_InterferenzePerConferma_Notifiche_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi(
        ...
        Try
            ...
            '---------------------------------------------
            Stb.Length = 0
            Stb.Append(" INSERT Sementieri_Sportello_InterferenzePerConferma_Notifiche " + vbCrLf)

            Stb.Append("              (")
            Stb.Append("              PivaSuperUser, Interferenze_Cod, Utente, Stato_Cod,  Inviato,  datainvio, ")
            ...
            Stb.Append("         ,  " & interferenze_Cod & vbCrLf)
