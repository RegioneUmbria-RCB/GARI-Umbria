...
Public Class SQNPI_LogInvio_Dettaglio_Errori_R
...
Public Class SQNPI_LogInvio_Dettaglio_Errori_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi( _
                           ...
                           , ByVal CodiceErrore As String _
                           , ByVal DescrizioneErrore As String _
                           , ByVal ProgressivoErrore As Integer _
                           , ByVal skTipoLog As Integer _
                           , ByVal DatoErrato As String, _
                           ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri _
        ...
        Try
            ...
            '---------------------------------------------
            Stb.Length = 0
            Stb.Append(" INSERT ws_SQNPI_LogInvio_Dettaglio_Errori " + vbCrLf)

            Stb.Append("              (")
            Stb.Append("              ws_SQNPI_LogInvio_Cod, CodiceErrore, DescrizioneErrore, ProgressivoErrore, skTipoLog, DatoErrato, ")
            ...
            Stb.Append("			,'" & Agro_SQL_SaveText(CodiceErrore) & "' ")
            Stb.Append("			,'" & Agro_SQL_SaveText(DescrizioneErrore) & "' ")
            Stb.Append("			, " & Agro_SQL_SaveNum(ProgressivoErrore) & "  ")
            Stb.Append("			, " & Agro_SQL_SaveNum(skTipoLog) & "  ")
            Stb.Append("			, '" & Agro_SQL_SaveText(DatoErrato) & "'  ")
