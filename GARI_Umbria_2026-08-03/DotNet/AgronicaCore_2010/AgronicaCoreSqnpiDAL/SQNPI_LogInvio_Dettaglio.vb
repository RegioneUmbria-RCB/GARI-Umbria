...
Public Class SQNPI_LogInvio_Dettaglio_R
...
Public Class SQNPI_LogInvio_Dettaglio_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi( _
        ...
        Try
            ...
            '---------------------------------------------
            Stb.Length = 0
            Stb.Append(" INSERT ws_SQNPI_LogInvio_Dettaglio  " + vbCrLf)

            Stb.Append("              (")
            Stb.Append("              ws_SQNPI_LogInvio_Cod, IdentificativoFlusso, ")
            ...
            Stb.Append("			,'" & Agro_SQL_SaveText(IdentificativoFlusso) & "' ")
