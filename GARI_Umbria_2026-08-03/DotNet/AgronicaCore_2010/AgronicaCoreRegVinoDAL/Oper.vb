...
Public Class Oper_R
    ...
    Public Function Leggi( _
        ...
        Try
            ...
            Stb.Append(" From ws_Reg_Vino_Operazioni " & vbCrLf)
...
Public Class Oper_W
    ...
    Public Function Scrivi(ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri _
        ...
        Try
            ...
            Stb.Append("			,'" & Agro_SQL_SaveText_NULL(username_creazione) & "' ")
            Stb.Append("			,'" & Agro_SQL_SaveText_NULL(username_modifica) & "' ")
    ...
    Public Function Cancella(ByVal xFiltroAggiuntivo As String, _
        ...
        Try
            ...
            If objParametri.FlagCancellazioneLogica = enumCancellazioneLogica.CancellazioneLogica Then
                Stb.Append(" UPDATE ... ")
                Stb.Append(" SET ")
                Stb.Append("         Username_Modifica = '" & Agro_SQL_SaveText_NULL(objParametri.UsernameOperazione) & "' ")
