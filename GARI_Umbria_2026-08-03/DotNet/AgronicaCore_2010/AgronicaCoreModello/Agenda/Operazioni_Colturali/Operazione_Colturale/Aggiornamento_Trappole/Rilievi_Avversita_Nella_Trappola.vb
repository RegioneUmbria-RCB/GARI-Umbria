...
Namespace Agenda.Operazioni_Colturali.Operazione_Colturale.Aggiornamento_Trappole
    ...
    Public Class Rilievi_Avversita_Nella_Trappola
        Inherits Abstr_Aggiornamento_Trappole

        Private _Rilievi As List(Of Rilievo)
        ...
        Private Sub ImpostaParametriOperazione(objParametri_Server As AgronicaCoreParametri)
            _Lav_Cod = CostantiPersonalizzate.LAVCOD_RILIEVO_AVVERSITA_TRAPPOLE
            ...
            _Rilievi = New List(Of Rilievo)
        End Sub


        Public Property Rilievi() As List(Of Rilievo)
            Get
                Return _Rilievi
            End Get
            Set(value As List(Of Rilievo))
                _Rilievi = value
            End Set
        End Property
