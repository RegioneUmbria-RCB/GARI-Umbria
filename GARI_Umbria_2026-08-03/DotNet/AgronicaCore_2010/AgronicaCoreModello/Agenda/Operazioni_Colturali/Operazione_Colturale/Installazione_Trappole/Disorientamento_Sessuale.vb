...
Namespace Agenda.Operazioni_Colturali.Operazione_Colturale.Installazione_Trappole
    ...
    Public Class Disorientamento_Sessuale
        ...
        Private Sub ImpostaParametriOperazione(objParametri_Server As AgronicaCoreParametri)
            _Lav_Cod = CostantiPersonalizzate.LAVCOD_DISORIENTAMENTO_SESSUALE
            _Cau_Mov = TipiEnumerativi.enum_Agenda_Causali.TRATTAMENTO
            _Cau_Des = "Trattamento"
