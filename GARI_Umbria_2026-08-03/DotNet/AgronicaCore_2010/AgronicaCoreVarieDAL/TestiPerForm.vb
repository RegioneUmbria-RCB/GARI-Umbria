...
Public Class TestiPerForm_R
    ...
    Public Function Leggi(
        ...
        Try
            ...
            Stb.AppendLine(" From TestiPerForm ")
            Stb.AppendLine(" Where Piva_SuperUser = '" & Agro_SQL_SaveText(Piva_SuperUser) & "' ")
            Stb.AppendLine(" And WebForm = '" & Agro_SQL_SaveText(WebForm) & "' ")
            If WebControlId <> "" Then
                Stb.AppendLine(" And WebControlId = '" & Agro_SQL_SaveText(WebControlId) & "'")
            End If
