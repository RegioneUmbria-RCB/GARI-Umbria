...
Public Class Esportatore_Malavasi : Inherits ImportatoreBase

    Protected Const _JOBKEY As String = "Esportatore_Malavasi_Job"
    Protected Const _TRIGGERKEY As String = "Esportatore_Malavasi_Trigger"
    ...
    Public Overrides Function StartOnDemand(ByVal contesto As enum_Contesto_Integrazione_Macchine_Lavorazione, ByRef schedulatore As IScheduler) As Boolean
        ...
        Dim job As IJobDetail = JobBuilder.Create(Of Esportatore_Malavasi_Job).
...
#Region "Classe di lavoro (JOB)"
    ...
    Private Class Esportatore_Malavasi_Job : Implements IJob
        ...
        Public Function Execute(context As IJobExecutionContext) As Task Implements IJob.Execute
            ...
            Try
                ...
                Dim servizio As New ServizioEsportazione_Malavasi(configurazione_servizio,
                ...
                Select Case contesto
                    Case enum_Contesto_Integrazione_Macchine_Lavorazione.Invio_Primo_Ingresso_Lav
                        rval = servizio.AvviaEsportPrimoIngressoCalibratriceMalavasi()
                    Case enum_Contesto_Integrazione_Macchine_Lavorazione.Invio_Ordine_Lav
                        rval = servizio.AvviaEsportOrdineCalibratriceMalavasi()
                End Select
