...
Public Class Esportatore_Standard : Inherits ImportatoreBase

    Protected Const _JOBKEY As String = "Esportatore_Standard_Job"
    Protected Const _TRIGGERKEY As String = "Esportatore_Standard_Trigger"
    ...
    Public Overrides Function StartOnDemand(ByVal contesto As enum_Contesto_Integrazione_Macchine_Lavorazione, ByRef schedulatore As IScheduler) As Boolean
        ...
        Dim job As IJobDetail = JobBuilder.Create(Of Esportatore_Standard_Job).
...
#Region "Classe di lavoro (JOB)"
    ...
    Private Class Esportatore_Standard_Job : Implements IJob
        ...
        Public Function Execute(context As IJobExecutionContext) As Task Implements IJob.Execute
            ...
            Try
                ...
                Dim servizio As New ServizioEsportazione_Standard(configurazione_servizio,
                ...
                Select Case contesto
                    Case enum_Contesto_Integrazione_Macchine_Lavorazione.Invio_Primo_Ingresso_Lav
                        rval = servizio.AvviaEsportPrimoIngressoMacchinaStandard()
                    Case enum_Contesto_Integrazione_Macchine_Lavorazione.Invio_Ordine_Lav
                        rval = servizio.AvviaEsportOrdineMacchinaStandard()
                End Select
