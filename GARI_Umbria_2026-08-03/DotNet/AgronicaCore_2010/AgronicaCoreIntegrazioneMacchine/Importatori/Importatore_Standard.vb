...
Public Class Importatore_Standard : Inherits ImportatoreBase

    Protected Const _JOBKEY As String = "Importatore_Standard_Job"
    Protected Const _TRIGGERKEY As String = "Importatore_Standard_Trigger"
    ...
    Public Overrides Sub Start()
        ...
        Dim job As IJobDetail = JobBuilder.Create(Of Importatore_Standard_Job).
...
#Region "Classe di lavoro (JOB)"
    ...
    Private Class Importatore_Standard_Job : Implements IJob
        ...
        Public Function Execute(context As IJobExecutionContext) As Task Implements IJob.Execute
            ...
            Try
                Dim servizio As New ServizioImportazione_Standard(configurazione_servizio, configurazioneImportatore, objParametri)
                Dim rval As RispostaStandard = servizio.AvviaImportMacchinaStandard()
