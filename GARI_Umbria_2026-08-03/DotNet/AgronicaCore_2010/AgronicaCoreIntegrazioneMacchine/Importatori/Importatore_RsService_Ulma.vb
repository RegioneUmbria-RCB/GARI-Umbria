...
Public Class Importatore_RsService_Ulma : Inherits ImportatoreBase

    Protected Const _JOBKEY As String = "Importatore_RsService_Ulma_Job"
    Protected Const _TRIGGERKEY As String = "Importatore_RsService_Ulma_Trigger"
    ...
    Public Overrides Sub Start()
        ...
        Dim job As IJobDetail = JobBuilder.Create(Of Importatore_RsService_Ulma_Job).
        ...
        logger.InfoFormat("Task '{0}' aggiunto allo Schedulatore", _JOBKEY)

    End Sub

#Region "Classe di lavoro (JOB)"

    Private Class Importatore_RsService_Ulma_Job : Implements IJob
        ...
        Public Function Execute(context As IJobExecutionContext) As Task Implements IJob.Execute
            ...
            Try
                Dim servizio As New ServizioImportazione_RsService_Ulma(configurazione_servizio, configurazioneImportatore, objParametri)
                Dim rval As RispostaStandard = servizio.AvviaImportBilanciaDati()
