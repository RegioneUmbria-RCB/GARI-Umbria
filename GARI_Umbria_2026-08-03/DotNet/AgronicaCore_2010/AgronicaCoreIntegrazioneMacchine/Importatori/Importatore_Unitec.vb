...
Public Class Importatore_Unitec : Inherits ImportatoreBase

    Protected Const _JOBKEY As String = "Importatore_Unitec_Job"
    Protected Const _TRIGGERKEY As String = "Importatore_Unitec_Trigger"
    ...
    Public Overrides Sub Start()
        ...
        Dim job As IJobDetail = JobBuilder.Create(Of Importatore_Unitec_Job).
...
#Region "Classe di lavoro (JOB)"
    ...
    Private Class Importatore_Unitec_Job : Implements IJob
        ...
        Public Function Execute(context As IJobExecutionContext) As Task Implements IJob.Execute
            ...
            Try
                Dim servizio As New ServizioImportazione_Unitec(configurazione_servizio, configurazioneImportatore, objParametri)
                Dim rval As RispostaStandard = servizio.AvviaImportCalibratriceUnitec()
