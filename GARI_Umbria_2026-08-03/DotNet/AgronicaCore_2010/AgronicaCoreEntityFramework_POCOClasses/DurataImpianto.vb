...
Partial Public Class DurataImpianto

    'Simple Properties
    <DataMember()>
    Public Property VEG_COD As Integer
    <DataMember()>
    Public Property CICLI As Nullable(Of Integer)
    <DataMember()>
    Public Property InProduzioneDal As Nullable(Of Integer)
    <DataMember()>
    Public Property Confermato As Nullable(Of Short)
    <DataMember()>
