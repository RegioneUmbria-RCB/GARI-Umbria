...
Partial Public Class AziInfoRER
    ...
    <DataMember()>
    Public Property Quadrante As Nullable(Of Short)
    <DataMember()>
    Public Property MeteoAttivo As Nullable(Of Short)
    <DataMember()>
    Public Property TipoMeteo As Nullable(Of Short)
    <DataMember()>
    Public Property SfondoBackground As Nullable(Of Short)
    <DataMember()>
