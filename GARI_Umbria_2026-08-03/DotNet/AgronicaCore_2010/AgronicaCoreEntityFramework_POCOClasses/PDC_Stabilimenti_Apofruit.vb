...
Partial Public Class PDC_Stabilimenti_Apofruit

    'Simple Properties
    <DataMember()>
    Public Property VCCOIS As String
    <DataMember()>
    Public Property Descrizione_Centro_Iscrizione As String
    <DataMember()>
    Public Property Cod_Stabilimento As String
    <DataMember()>
    Public Property Descrizione_Stabilimento As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property DecodificaInSiagr As Nullable(Of Integer)
