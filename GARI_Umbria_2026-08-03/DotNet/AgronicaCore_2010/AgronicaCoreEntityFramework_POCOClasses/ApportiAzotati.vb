...
Partial Public Class ApportiAzotati
    ...
    <DataMember()>
    Public Property GG As Nullable(Of Integer)
    <DataMember()>
    Public Property Anno_1 As Nullable(Of Integer)
    <DataMember()>
    Public Property Anno_2 As Nullable(Of Integer)
    <DataMember()>
    Public Property Anno_3 As Nullable(Of Integer)
    <DataMember()>
    Public Property Anno_4 As Nullable(Of Integer)
    <DataMember()>
