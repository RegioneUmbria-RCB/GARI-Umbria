...
Partial Public Class Codifica_Varieta_OIPomodorodaIndustriaNordItalia

    'Simple Properties
    <DataMember()>
    Public Property Cod_Varieta As String
    <DataMember()>
    Public Property Cul_Cod_Gias As Integer
    <DataMember()>
    Public Property Veg_Cod_Gias As Integer
    <DataMember()>
    Public Property Desc_Varieta As String
    <DataMember()>
    Public Property Grva_Cod_Gias As Integer
    <DataMember()>
