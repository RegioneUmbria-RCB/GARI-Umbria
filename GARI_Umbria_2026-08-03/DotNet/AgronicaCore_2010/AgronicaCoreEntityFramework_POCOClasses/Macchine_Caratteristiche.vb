...
Partial Public Class Macchine_Caratteristiche

    'Simple Properties
    <DataMember()>
    Public Property Mac_Car_Cod As Integer
    <DataMember()>
    Public Property Mac_Car_Des As String
    <DataMember()>
    Public Property Mac_Car_Tipo As Integer
    <DataMember()>
    Public Property Mac_Car_Udm_Cod As Nullable(Of Integer)
    <DataMember()>
