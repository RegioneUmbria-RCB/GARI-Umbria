...
Partial Public Class PC_GrigliaK2O

    'Simple Properties
    <DataMember()>
    Public Property Regolamento_Cod As Integer
    <DataMember()>
    Public Property Id_Griglia As Integer
    <DataMember()>
    Public Property Id_Gruppo_Tessitura As Integer
    <DataMember()>
    Public Property Minimo As Nullable(Of Double)
    <DataMember()>
    Public Property Massimo As Nullable(Of Double)
    <DataMember()>
    Public Property Id_Dotazione As Nullable(Of Integer)
    <DataMember()>
