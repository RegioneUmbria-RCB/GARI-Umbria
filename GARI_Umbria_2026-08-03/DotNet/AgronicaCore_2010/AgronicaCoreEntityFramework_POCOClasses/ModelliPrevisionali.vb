...
Partial Public Class ModelliPrevisionali

    'Simple Properties
    <DataMember()>
    Public Property Mod_Cod As Integer
    <DataMember()>
    Public Property Mod_Des As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property Tipo_Visibilita As Nullable(Of Integer)
    <DataMember()>
    Public Property Mod_Note As String
