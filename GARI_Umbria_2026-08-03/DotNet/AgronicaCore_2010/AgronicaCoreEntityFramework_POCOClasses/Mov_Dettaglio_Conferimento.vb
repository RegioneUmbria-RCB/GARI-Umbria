...
Partial Public Class Mov_Dettaglio_Conferimento
    ...
    <DataMember()>
    Public Property Premio_Complessivo As Nullable(Of Double)
    <DataMember()>
    Public Property Prezzo_Unitario_Finale As Nullable(Of Double)
    <DataMember()>
    Public Property Cod_Varieta As Nullable(Of Integer)
    <DataMember()>
