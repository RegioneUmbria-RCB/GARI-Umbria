...
Partial Public Class Limiti_P2O5

    'Simple Properties
    <DataMember()>
    Public Property P2O5_COD As Integer
    <DataMember()>
    Public Property P2O5_scarsa As Nullable(Of Short)
    <DataMember()>
    Public Property P2O5_normale As Nullable(Of Short)
    <DataMember()>
    Public Property P2O5_elevata As Nullable(Of Short)
    <DataMember()>
