...
Partial Public Class Reg_TrAntip_Diserbo
    ...
    <DataMember()>
    Public Property TR_COD As Nullable(Of Integer)
    <DataMember()>
    Public Property TR_QTA As Nullable(Of Double)
    <DataMember()>
    Public Property MISCELA As String
    <DataMember()>
