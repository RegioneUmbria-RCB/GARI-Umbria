...
Partial Public Class DSS_Agronica_Stazioni_Meteo_ModelliPrevisionali_SRV
    ...
    <DataMember()>
    Public Property GSB_Flag As Integer
    <DataMember()>
    Public Property GSB_DataOraElaborazione As Date
    <DataMember()>
    Public Property RisultatoElaborazione As String
    <DataMember()>
    Public Property Qta_Ril As Nullable(Of Single)
    <DataMember()>
