...
Partial Public Class GerarchiaImprese_Tipologia_Dettagli

    'Simple Properties
    <DataMember()>
    Public Property TipologiaGerarchie_Cod As Integer
    <DataMember()>
    Public Property TipologiaGerarchie_Dettagli_Livello_Cod As Integer
    <DataMember()>
    Public Property TipologiaGerarchie_Dettagli_Livello_Des As String
    <DataMember()>
    Public Property TipologiaGerarchie_Dettagli_Livello As Integer
    <DataMember()>
