...
Partial Public Class ws_RegVino_CodiciRitorno

    'Simple Properties
    <DataMember()>
    Public Property Codice_Esito As String
    <DataMember()>
    Public Property Messaggio_Esito As String
    <DataMember()>
    Public Property Oggetto_Controllo As String
    <DataMember()>
    Public Property Tipo_esito As String
    <DataMember()>
