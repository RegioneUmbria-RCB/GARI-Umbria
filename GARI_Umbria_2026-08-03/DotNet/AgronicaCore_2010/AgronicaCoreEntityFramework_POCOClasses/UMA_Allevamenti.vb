...
Partial Public Class UMA_Allevamenti
    ...
    <DataMember()>
    Public Property UMA_All_Des As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property UMA_AllGru_Cod As String
    <DataMember()>
    Public Property UMA_AllGru_Des As String
