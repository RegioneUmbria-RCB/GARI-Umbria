...
Partial Public Class GIS_ProcessingAlgorithms_Cleaning_Avanzamento

    'Simple Properties
    <DataMember()>
    Public Property DataOraUltimoPassaggio As Date
    <DataMember()>
    ...
    <DataMember()>
    Public Property AlgoritmoPadre As String
