...
Partial Public Class Imprese_ISCCXElaborazioni
    ...
    <DataMember()>
    Public Property Esito_Cod As Integer
    <DataMember()>
    Public Property Data_Controllo As Date
    <DataMember()>
    Public Property Username_Controllo As String
    <DataMember()>
