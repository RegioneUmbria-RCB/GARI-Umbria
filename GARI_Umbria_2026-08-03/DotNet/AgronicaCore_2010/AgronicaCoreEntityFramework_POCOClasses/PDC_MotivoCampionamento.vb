...
Partial Public Class PDC_MotivoCampionamento

    'Simple Properties
    <DataMember()>
    Public Property ID_MotivoCampionamento As Integer
    <DataMember()>
    Public Property Descrizione_MotivoCampionamento As String
    <DataMember()>
