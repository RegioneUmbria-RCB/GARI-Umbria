...
Partial Public Class PS_Zone
    ...
    <DataMember()>
    Public Property Zona_Codice As String
    <DataMember()>
    Public Property Zona_Descrizione As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property Flag_Storico As Nullable(Of Integer)
