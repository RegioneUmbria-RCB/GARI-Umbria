...
Partial Public Class Codifica_SpecieVegetali_Avepa
    ...
    <DataMember()>
    Public Property Veg_Cod_Avepa As String
    <DataMember()>
    Public Property Cul_Cod_Avepa As String
    <DataMember()>
    Public Property Veg_Des_Avepa As String
    <DataMember()>
    Public Property Cul_Des_Avepa As String
    <DataMember()>
