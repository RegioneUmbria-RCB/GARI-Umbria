...
Partial Public Class FormulatiXPeriodoSospensione

    'Simple Properties
    <DataMember()>
    Public Property Fr_cod As Integer
    <DataMember()>
    Public Property Progressivo_sospensione As Integer
    <DataMember()>
    Public Property DataSospensioneDA As Nullable(Of Date)
    <DataMember()>
    Public Property DataSospensioneA As Nullable(Of Date)
    <DataMember()>
