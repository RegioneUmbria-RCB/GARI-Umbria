...
Partial Public Class G2G_Recode_PianoConcimazione_Elaborazioni
    ...
    <DataMember()>
    Public Property From_PC_Elaborazione_Cod As Integer
    <DataMember()>
    Public Property To_PC_Elaborazione_Cod As Integer
    <DataMember()>
