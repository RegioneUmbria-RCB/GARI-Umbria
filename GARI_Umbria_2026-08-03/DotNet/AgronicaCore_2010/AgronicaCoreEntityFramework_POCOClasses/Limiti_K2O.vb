...
Partial Public Class Limiti_K2O

    'Simple Properties
    <DataMember()>
    Public Property K2O_COD As Integer
    <DataMember()>
    Public Property K2O_scarsa As Nullable(Of Short)
    <DataMember()>
    Public Property K2O_normale As Nullable(Of Short)
    <DataMember()>
    Public Property K2O_elevata As Nullable(Of Short)
    <DataMember()>
