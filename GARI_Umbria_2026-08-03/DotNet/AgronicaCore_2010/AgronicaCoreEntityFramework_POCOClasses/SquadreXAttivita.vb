...
Partial Public Class SquadreXAttivita
    ...
    <DataMember()>
    Public Property ID_Squadra As Integer
    <DataMember()>
    Public Property Lav_Cod As Nullable(Of Integer)
    <DataMember()>
    Public Property attivita_list As String
    <DataMember()>
    Public Property des_Squadra As String
    <DataMember()>
    Public Property veg_cod_list As String
    <DataMember()>
    Public Property cod_risum_list As String
    <DataMember()>
    Public Property mac_cod_list As String
    <DataMember()>
    Public Property pubblico As Nullable(Of Short)
    <DataMember()>
    ...
    <DataMember()>
    Public Property cod_risum_caposquadra_list As String
