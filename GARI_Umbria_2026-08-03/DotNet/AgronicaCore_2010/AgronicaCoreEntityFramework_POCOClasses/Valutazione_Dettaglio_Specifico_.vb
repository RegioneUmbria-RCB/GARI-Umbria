...
Partial Public Class Valutazione_Dettaglio_Specifico_
    ...
    <DataMember()>
    Public Property Dettaglio_Key As String
    <DataMember()>
    Public Property Valore_Unitario As Double
    <DataMember()>
    Public Property Valore_Totale As Double
    <DataMember()>
    Public Property Valore_Ha As Double
    <DataMember()>
    Public Property Valore_Peso As Double
    <DataMember()>
