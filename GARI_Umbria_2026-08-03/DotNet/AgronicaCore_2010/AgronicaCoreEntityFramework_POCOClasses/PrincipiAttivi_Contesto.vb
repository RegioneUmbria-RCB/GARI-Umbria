...
Partial Public Class PrincipiAttivi_Contesto

    'Simple Properties
    <DataMember()>
    Public Property PrincipiAttivi_Contesto_COD As Integer
    <DataMember()>
    Public Property PrincipiAttivi_Contesto_DES As String
    <DataMember()>
