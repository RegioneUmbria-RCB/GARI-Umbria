...
Partial Public Class Analisi_Correzioni_Testata
    ...
    <DataMember()>
    Public Property ID_Correzione_Testata As Integer
    <DataMember()>
    Public Property Nome As String
    <DataMember()>
    Public Property Analisi_Parametro_Cod As Integer
    <DataMember()>
    Public Property Scala_Definizione As Short
    <DataMember()>
    Public Property Scala_Inizio As Decimal
    <DataMember()>
    Public Property Scala_Fine As Decimal
    <DataMember()>
