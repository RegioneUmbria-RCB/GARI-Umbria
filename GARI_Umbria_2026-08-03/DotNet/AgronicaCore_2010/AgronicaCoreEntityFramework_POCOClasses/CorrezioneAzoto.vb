...
Partial Public Class CorrezioneAzoto

    'Simple Properties
    <DataMember()>
    Public Property VEG_COD As Integer
    <DataMember()>
    Public Property CcN As Nullable(Of Double)
    <DataMember()>
    Public Property CcP As Nullable(Of Double)
    <DataMember()>
    Public Property CcK As Nullable(Of Double)
    <DataMember()>
    Public Property CcMg As Nullable(Of Double)
    <DataMember()>
