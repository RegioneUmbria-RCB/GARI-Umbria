...
Partial Public Class DomandaIrrigua_Testata
    ...
    <DataMember()>
    Public Property N_Protocollo As String
    <DataMember()>
    Public Property Data_Protocollo As Nullable(Of Date)
    <DataMember()>
    Public Property TipoContratto As Integer
    <DataMember()>
