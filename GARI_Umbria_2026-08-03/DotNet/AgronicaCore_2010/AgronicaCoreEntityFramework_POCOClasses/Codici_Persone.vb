...
Partial Public Class Codici_Persone
    ...
    <DataMember()>
    Public Property lunghezza As Nullable(Of Short)
    <DataMember()>
    ...
    <DataMember()>
    Public Property genitore As Nullable(Of Short)
    <DataMember()>
    Public Property creatore As String
    <DataMember()>
