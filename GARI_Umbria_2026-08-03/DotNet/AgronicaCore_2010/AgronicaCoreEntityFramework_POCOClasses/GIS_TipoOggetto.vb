...
Partial Public Class GIS_TipoOggetto

    'Simple Properties
    <DataMember()>
    Public Property GIS_TipoOggetto_Cod As Integer
    <DataMember()>
    Public Property GIS_TipoOggetto_Des As String
    <DataMember()>
    Public Property GIS_TipoOggetto_GMLElemetName As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property FeatureTypeId As Nullable(Of Integer)
