...
Partial Public Class GIS_LayerAnalysisConfigXCheckList

    'Simple Properties
    <DataMember()>
    Public Property GIS_LayerAnalysisConfig_CheckList_Cod As Integer
    <DataMember()>
    Public Property LayerAnalysisConfig_Cod As Integer
    <DataMember()>
    Public Property Applica_Risultato As Boolean
    <DataMember()>
