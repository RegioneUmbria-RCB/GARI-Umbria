...
Partial Public Class Codifica_SpecieVegetali_Artea
    ...
    <DataMember()>
    Public Property Veg_Cod_Artea As String
    <DataMember()>
    Public Property Cul_Cod_Artea As String
    <DataMember()>
    Public Property Veg_Des_Artea As String
    <DataMember()>
    Public Property Cul_Des_Artea As String
    <DataMember()>
