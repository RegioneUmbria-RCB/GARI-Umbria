...
Partial Public Class Linee_Produzioni_Validita
    ...
    <DataMember()>
    Public Property Tipo_Validita As Short
    <DataMember()>
    Public Property Descrizione_Validita As String
    <DataMember()>
    Public Property Validita_Valore As String
    <DataMember()>
