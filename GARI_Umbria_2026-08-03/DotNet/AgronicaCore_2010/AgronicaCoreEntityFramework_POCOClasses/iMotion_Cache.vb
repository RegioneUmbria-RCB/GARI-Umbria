...
Partial Public Class iMotion_Cache

    'Simple Properties
    <DataMember()>
    Public Property iMotion_Cache_COD As Integer
    <DataMember()>
    Public Property iMotion_Cache_Des As String
    <DataMember()>
    Public Property vehicle_id As Integer
    <DataMember()>
    Public Property [date] As Date
    <DataMember()>
    Public Property DatiCache As String
    <DataMember()>
