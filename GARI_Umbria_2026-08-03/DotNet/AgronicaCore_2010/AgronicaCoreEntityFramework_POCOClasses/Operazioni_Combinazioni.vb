...
Partial Public Class Operazioni_Combinazioni

    'Simple Properties
    <DataMember()>
    Public Property ID As Integer
    <DataMember()>
    Public Property Lav_Cod1 As Nullable(Of Integer)
    <DataMember()>
    Public Property Lav_Cod2 As Nullable(Of Integer)
    <DataMember()>
    Public Property Lav_Cod3 As Nullable(Of Integer)
    <DataMember()>
    Public Property Lav_Cod4 As Nullable(Of Integer)
    <DataMember()>
    Public Property Lav_Cod5 As Nullable(Of Integer)
    <DataMember()>
