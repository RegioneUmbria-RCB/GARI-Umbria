...
Partial Public Class Credenziali_Irriframe

    'Simple Properties
    <DataMember()>
    Public Property UserName_GIAS As String
    <DataMember()>
    Public Property UserName_IF As String
    <DataMember()>
    Public Property UserId_IF As Integer
    <DataMember()>
