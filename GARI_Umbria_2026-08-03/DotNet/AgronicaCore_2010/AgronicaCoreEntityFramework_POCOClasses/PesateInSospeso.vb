...
Partial Public Class PesateInSospeso
    ...
    <DataMember()>
    Public Property Lordo As Nullable(Of Integer)
    <DataMember()>
    Public Property Netto As Nullable(Of Integer)
    <DataMember()>
    Public Property Tara As Nullable(Of Integer)
    <DataMember()>
