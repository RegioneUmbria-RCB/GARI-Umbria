...
Partial Public Class UMA_RichiestexReg_Impianti

    'Simple Properties
    <DataMember()>
    Public Property Piva_Richiesta As String
    <DataMember()>
    Public Property Gruppo_Colturale As String
    <DataMember()>
    Public Property Richiesta_Cod As Integer
    <DataMember()>
    Public Property Piva_Impianto As String
    <DataMember()>
