...
Partial Public Class PDC_Tipo_Campione_Apofruit

    'Simple Properties
    <DataMember()>
    Public Property ID_Tipo_Campione As Integer
    <DataMember()>
    Public Property Codice As Integer
    <DataMember()>
    Public Property Tipo_Campione As String
    <DataMember()>
    Public Property Capitolato As String
    <DataMember()>
