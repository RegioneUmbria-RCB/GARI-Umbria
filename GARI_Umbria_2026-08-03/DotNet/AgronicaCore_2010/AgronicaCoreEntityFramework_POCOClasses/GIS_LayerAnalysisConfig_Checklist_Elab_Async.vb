...
Partial Public Class GIS_LayerAnalysisConfig_Checklist_Elab_Async

    'Simple Properties
    <DataMember()>
    Public Property GIS_LayerAnalysisConfig_Checklist_Elab_Async_Cod As Integer
    <DataMember()>
    Public Property GIS_LayerAnalysisConfig_Checklist_Type_Cod As Integer
    <DataMember()>
    Public Property Request_Payload As String
    <DataMember()>
