...
<KnownType(GetType(GIS_TipoEntita))>
Partial Public Class GIS_Entita
    ...
    <DataMember()>
    Public Overridable Property GIS_ElementiGrafici As ICollection(Of GIS_ElementiGrafici) = New HashSet(Of GIS_ElementiGrafici)
    <DataMember()>
    Public Overridable Property GIS_TipoEntita As GIS_TipoEntita
