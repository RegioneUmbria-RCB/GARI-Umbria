...
Partial Public Class StabulazionexCategoria

    'Simple Properties
    <DataMember()>
    Public Property COD_SPECIE_ZOOLOGICA_02 As String
    <DataMember()>
    Public Property COD_CATEGORIA_ANIMALE_03 As String
    <DataMember()>
    Public Property COD_TIPO_STABULAZIONE_04 As String
    <DataMember()>
    Public Property COD_DETT_STABULAZIONE_04_SUB As String
    <DataMember()>
