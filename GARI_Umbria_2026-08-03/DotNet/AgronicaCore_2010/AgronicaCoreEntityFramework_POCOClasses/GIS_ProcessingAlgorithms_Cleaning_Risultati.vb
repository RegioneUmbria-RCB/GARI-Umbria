...
Partial Public Class GIS_ProcessingAlgorithms_Cleaning_Risultati

    'Simple Properties
    <DataMember()>
    Public Property ChiaveGrafica As String
    <DataMember()>
    Public Property Algoritmo As String
    <DataMember()>
    Public Property PropostaModifica_WKT As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property Poligono_duplicato As String
    <DataMember()>
    Public Property ConfigurazioneEsecuzione As String
