...
Partial Public Class Modalita_Applicazione_XLingue_IT_ch

    'Simple Properties
    <DataMember()>
    Public Property Codice As Integer
    <DataMember()>
    Public Property Codice_Personalizzato As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property Descrizione_Personalizzata As String
    <DataMember()>
