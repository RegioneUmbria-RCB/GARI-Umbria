...
Partial Public Class ApportiAmmendante

    'Simple Properties
    <DataMember()>
    Public Property TESS_COD As Integer
    <DataMember()>
    Public Property SO_min As Nullable(Of Double)
    <DataMember()>
    Public Property SO_max As Nullable(Of Double)
    <DataMember()>
    Public Property t_ss_ha As Nullable(Of Double)
    <DataMember()>
