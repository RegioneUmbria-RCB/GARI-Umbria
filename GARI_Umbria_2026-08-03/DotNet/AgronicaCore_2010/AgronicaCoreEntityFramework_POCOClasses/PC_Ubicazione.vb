...
Partial Public Class PC_Ubicazione

    'Simple Properties
    <DataMember()>
    Public Property Regolamento_Cod As Integer
    <DataMember()>
    Public Property Ubicazione_Cod As Integer
    <DataMember()>
    Public Property Ubicazione_Des As String
    <DataMember()>
    Public Property Deposizione_Anno As Nullable(Of Double)
    <DataMember()>
