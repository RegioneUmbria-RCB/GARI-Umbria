...
Partial Public Class UMA_Richieste_Rec_Acc
    ...
    <DataMember()>
    Public Property Rec_Acc_Gasolio As Nullable(Of Double)
    <DataMember()>
    Public Property Rec_Acc_Benzina As Nullable(Of Double)
    <DataMember()>
    Public Property Rec_Acc_Gasolio_Serra As Nullable(Of Double)
    <DataMember()>
