...
Partial Public Class DataPublish_Poligoni_NonValidi

    'Simple Properties
    <DataMember()>
    Public Property Id As Integer
    <DataMember()>
    Public Property Id_Notifica_SistemaEsterno As Integer
    <DataMember()>
    Public Property CUAA As String
    <DataMember()>
    Public Property Campagna As Nullable(Of Integer)
    <DataMember()>
    Public Property Id_Appezzamento_Esterno As Nullable(Of Integer)
    <DataMember()>
    Public Property Id_Coltura_Esterno As Nullable(Of Integer)
    <DataMember()>
    Public Property Poligono_WKT As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property SRID As Nullable(Of Integer)
