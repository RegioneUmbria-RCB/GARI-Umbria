...
Partial Public Class CBI_Causali

    'Simple Properties
    <DataMember()>
    Public Property CBI_Causali_cod As Integer
    <DataMember()>
    Public Property CBI_Causali_DesBreve As String
    <DataMember()>
    Public Property CBI_Causali_DesLunga As String
    <DataMember()>
