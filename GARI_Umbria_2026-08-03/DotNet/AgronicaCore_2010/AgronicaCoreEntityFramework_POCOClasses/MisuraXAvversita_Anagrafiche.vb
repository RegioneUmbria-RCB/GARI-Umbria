...
Partial Public Class MisuraXAvversita_Anagrafiche

    'Simple Properties
    <DataMember()>
    Public Property MxAV_Cod As Integer
    <DataMember()>
    Public Property Anag_cod As Integer
    <DataMember()>
    Public Property Anag_des As String
    <DataMember()>
    Public Property Anag_valore As Double
    <DataMember()>
    Public Property DPI_FlagPrivatoPubblico As Integer
    <DataMember()>
