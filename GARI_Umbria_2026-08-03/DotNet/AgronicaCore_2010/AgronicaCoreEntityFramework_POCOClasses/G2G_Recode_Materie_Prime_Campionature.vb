...
Partial Public Class G2G_Recode_Materie_Prime_Campionature
    ...
    <DataMember()>
    Public Property From_Progressivo As Integer
    <DataMember()>
    Public Property To_Progressivo As Integer
    <DataMember()>
    Public Property From_Tipo As String
    <DataMember()>
    Public Property To_Tipo As String
    <DataMember()>
    Public Property From_Tipo_Cod As Integer
    <DataMember()>
    Public Property To_Tipo_Cod As Integer
    <DataMember()>
