...
Partial Public Class PC_Tessiture

    'Simple Properties
    <DataMember()>
    Public Property Regolamento_Cod As Integer
    <DataMember()>
    Public Property Id_Tessitura As Integer
    <DataMember()>
    Public Property Tessitura_Sim As String
    <DataMember()>
    Public Property Tessitura_Des As String
    <DataMember()>
    Public Property Id_ClasseTessitura As Nullable(Of Integer)
    <DataMember()>
    Public Property Id_GruppoTessitura As Nullable(Of Integer)
    <DataMember()>
