...
Partial Public Class Prenotazione_Piante_Certificazione_XLingue_IT_ch
    ...
    <DataMember()>
    Public Property Descrizione_Certificazione As String
    <DataMember()>
    Public Property ID_Certificazione As Integer
    <DataMember()>
