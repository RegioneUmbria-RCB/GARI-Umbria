...
Partial Public Class Limiti_N

    'Simple Properties
    <DataMember()>
    Public Property N_COD As Integer
    <DataMember()>
    Public Property N_scarsa As Nullable(Of Short)
    <DataMember()>
    Public Property N_normale As Nullable(Of Short)
    <DataMember()>
    Public Property N_elevata As Nullable(Of Short)
    <DataMember()>
