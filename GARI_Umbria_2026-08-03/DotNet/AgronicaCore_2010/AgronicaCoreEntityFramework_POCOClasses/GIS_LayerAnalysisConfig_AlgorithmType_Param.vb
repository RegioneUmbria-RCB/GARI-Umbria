...
Partial Public Class GIS_LayerAnalysisConfig_AlgorithmType_Param

    'Simple Properties
    <DataMember()>
    Public Property GIS_LayerAnalysisConfig_AlgorithmType_Param_Cod As Integer
    <DataMember()>
    Public Property GIS_LayerAnalysisConfig_AlgorithmType_Param_Des As String
    <DataMember()>
    Public Property GIS_LayerAnalysisConfig_AlgorithmType_Cod As Integer
    <DataMember()>
