...
Partial Public Class StampeReport_XLingue_IT_ch
    ...
    <DataMember()>
    Public Property Descrizione_Lunga As String
    <DataMember()>
    Public Property Id_StampeReport As Integer
    <DataMember()>
    Public Property Id_StampeReportGruppi As Integer
    <DataMember()>
    Public Property inviato As Nullable(Of Short)
    <DataMember()>
    Public Property PivaSuperuser_Permesso As String
    <DataMember()>
