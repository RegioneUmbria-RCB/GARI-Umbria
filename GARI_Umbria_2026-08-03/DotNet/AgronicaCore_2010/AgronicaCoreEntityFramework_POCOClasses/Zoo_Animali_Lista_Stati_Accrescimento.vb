...
Partial Public Class Zoo_Animali_Lista_Stati_Accrescimento
    ...
    <DataMember()>
    Public Property Giorno_Da As Nullable(Of Integer)
    <DataMember()>
    Public Property Giorno_A As Nullable(Of Integer)
