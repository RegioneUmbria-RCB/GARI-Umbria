...
Partial Public Class Traduzioni_Stampe
    ...
    <DataMember()>
    Public Property Tipo_Stampa As Integer
    <DataMember()>
    Public Property Codice_Lingua As String
    <DataMember()>
    Public Property TxtReport_Codice As Integer
    <DataMember()>
    Public Property TxtReport_Descrizione As String
    <DataMember()>
