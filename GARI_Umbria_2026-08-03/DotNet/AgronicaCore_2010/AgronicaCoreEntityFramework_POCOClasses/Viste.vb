...
Partial Public Class Viste

    'Simple Properties
    <DataMember()>
    Public Property VISTA_COD As Integer
    <DataMember()>
    Public Property DESCRIZIONE As String
    <DataMember()>
    Public Property TIP_COD1 As Integer
    <DataMember()>
    Public Property TIP_COD2 As Integer
    <DataMember()>
    Public Property TIP_COD3 As Integer
    <DataMember()>
    Public Property PAR_NOME As String
    <DataMember()>
    Public Property PAR_POS As Nullable(Of Integer)
    <DataMember()>
