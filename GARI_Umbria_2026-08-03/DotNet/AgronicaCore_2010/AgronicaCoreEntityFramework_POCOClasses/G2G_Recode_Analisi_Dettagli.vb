...
Partial Public Class G2G_Recode_Analisi_Dettagli
    ...
    <DataMember()>
    Public Property From_Analisi_Testata_Cod As Integer
    <DataMember()>
    Public Property To_Analisi_Testata_Cod As Integer
    <DataMember()>
    Public Property From_Analisi_Dettaglio_Cod As Integer
    <DataMember()>
    Public Property To_Analisi_Dettaglio_Cod As Integer
    <DataMember()>
