...
Partial Public Class PROFIS_Decodifica_TipiIVA_LavCod_CodIVA

    'Simple Properties
    <DataMember()>
    Public Property GIAS_Lav_Cod As Integer
    <DataMember()>
    Public Property GIAS_Cod_IVA As Integer
    <DataMember()>
    Public Property Profis_TipoIVA As Integer
    <DataMember()>
