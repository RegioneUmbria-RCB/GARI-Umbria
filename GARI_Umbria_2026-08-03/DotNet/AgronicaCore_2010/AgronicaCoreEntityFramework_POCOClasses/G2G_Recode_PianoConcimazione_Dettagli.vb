...
Partial Public Class G2G_Recode_PianoConcimazione_Dettagli
    ...
    <DataMember()>
    Public Property From_PC_Testata_Cod As Integer
    <DataMember()>
    Public Property To_PC_Testata_Cod As Integer
    <DataMember()>
    Public Property From_PC_Dettagli_Cod As Integer
    <DataMember()>
    Public Property To_PC_Dettagli_Cod As Integer
    <DataMember()>
