...
Partial Public Class G2G_Recode_Ricette_Dettaglio_Tecnico
    ...
    <DataMember()>
    Public Property From_Ricetta_Tecnico_Cod As Integer
    <DataMember()>
    Public Property To_Ricetta_Tecnico_Cod As Integer
    <DataMember()>
