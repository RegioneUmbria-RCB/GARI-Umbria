...
Partial Public Class CoefficenteMinSal

    'Simple Properties
    <DataMember()>
    Public Property id_sal As Integer
    <DataMember()>
    Public Property id_anno As Integer
    <DataMember()>
    Public Property coeffminsal As Nullable(Of Double)
    <DataMember()>
