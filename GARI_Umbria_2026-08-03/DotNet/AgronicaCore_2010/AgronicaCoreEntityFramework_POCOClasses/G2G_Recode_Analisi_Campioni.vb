...
Partial Public Class G2G_Recode_Analisi_Campioni
    ...
    <DataMember()>
    Public Property From_Analisi_Campione_Cod As Integer
    <DataMember()>
    Public Property To_Analisi_Campione_Cod As Integer
    <DataMember()>
