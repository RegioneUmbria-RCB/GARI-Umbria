...
Partial Public Class Materie_Prime_ParametriQualitativi
    ...
    <DataMember()>
    Public Property ChkRegistri As Short
    <DataMember()>
    Public Property ChkCalibri As Short
    <DataMember()>
    Public Property ChkRegistri_Vinificazione As Short
    <DataMember()>
    Public Property Valore_Default As Nullable(Of Double)
    <DataMember()>
