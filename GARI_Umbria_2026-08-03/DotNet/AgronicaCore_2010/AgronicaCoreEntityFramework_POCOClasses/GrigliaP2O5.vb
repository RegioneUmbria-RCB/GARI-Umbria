...
Partial Public Class GrigliaP2O5

    'Simple Properties
    <DataMember()>
    Public Property id_grigliap2o5 As Integer
    <DataMember()>
    ...
    <DataMember()>
    Public Property massimo As Nullable(Of Double)
    <DataMember()>
    Public Property dotazione As String
    <DataMember()>
