...
Partial Public Class PS_PianoSeminaTestata
    ...
    <DataMember()>
    Public Property PianoSeminaTestata_Descrizione As String
    <DataMember()>
    Public Property PianoSeminaTestata_Note As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property PS_assoc_Reg_Impianti As String
