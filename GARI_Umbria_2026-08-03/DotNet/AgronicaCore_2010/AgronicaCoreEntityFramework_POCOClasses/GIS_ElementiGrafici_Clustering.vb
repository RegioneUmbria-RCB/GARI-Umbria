...
Partial Public Class GIS_ElementiGrafici_Clustering

    'Simple Properties
    <DataMember()>
    Public Property PivaSuperUser As String
    <DataMember()>
    Public Property LayerElementoGrafico_Cod As Integer
    <DataMember()>
    Public Property ElementoGrafico_Cod As Integer
    <DataMember()>
    Public Property Centroide_GeoEntity_WKT As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property Centroide_GeoEntity As System.Data.Entity.Spatial.DbGeography
