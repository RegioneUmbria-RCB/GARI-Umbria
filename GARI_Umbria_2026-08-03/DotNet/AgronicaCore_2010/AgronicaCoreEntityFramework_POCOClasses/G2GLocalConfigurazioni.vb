...
Partial Public Class G2GLocalConfigurazioni

    'Simple Properties
    <DataMember()>
    Public Property G2GLocalConfigurazioni_COD As Integer
    <DataMember()>
    Public Property G2GLocalConfigurazioni_DES As String
    <DataMember()>
    Public Property G2GLocalConfigurazioni_CFG As String
    <DataMember()>
