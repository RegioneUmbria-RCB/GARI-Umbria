...
Partial Public Class UnitaMisura_Conversione

    'Simple Properties
    <DataMember()>
    Public Property UDM_COD_Da As Integer
    <DataMember()>
    Public Property UDM_COD_A As Integer
    <DataMember()>
    Public Property FattoreConversione As Single
    <DataMember()>
