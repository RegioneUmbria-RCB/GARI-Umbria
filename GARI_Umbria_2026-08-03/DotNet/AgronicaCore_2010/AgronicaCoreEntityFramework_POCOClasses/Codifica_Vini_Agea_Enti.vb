...
Partial Public Class Codifica_Vini_Agea_Enti

    'Simple Properties
    <DataMember()>
    Public Property ID_Ente As Integer
    <DataMember()>
    Public Property ID_DocIGT As Integer
    <DataMember()>
    Public Property Cod_Tipologia As Integer
    <DataMember()>
    Public Property ID_Agea As Integer
    <DataMember()>
