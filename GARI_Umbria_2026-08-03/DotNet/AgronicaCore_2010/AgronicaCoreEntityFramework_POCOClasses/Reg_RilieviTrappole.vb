...
Partial Public Class Reg_RilieviTrappole
    ...
    <DataMember()>
    Public Property Q_RIL As Nullable(Of Double)
    <DataMember()>
    Public Property UDM As Nullable(Of Integer)
    <DataMember()>
    Public Property ID_TESTATA_TRAPPOLE As Nullable(Of Integer)
    <DataMember()>
    Public Property ID_REG_TRAPPOLE As Nullable(Of Integer)
    <DataMember()>
