...
Partial Public Class IVA_DescrizioneEstesaTipoOperazione

    'Simple Properties
    <DataMember()>
    Public Property IVA_DETO_Cod As Integer
    <DataMember()>
    Public Property IVA_DETO_Des As String
    <DataMember()>
    Public Property IVA_Casistica As String
    <DataMember()>
    Public Property Flag_Reverse_Charge As Integer
    <DataMember()>
    Public Property Flag_Leasing As String
    <DataMember()>
