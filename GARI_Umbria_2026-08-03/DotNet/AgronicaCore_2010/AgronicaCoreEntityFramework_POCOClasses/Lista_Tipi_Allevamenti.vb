...
Partial Public Class Lista_Tipi_Allevamenti

    'Simple Properties
    <DataMember()>
    Public Property ALL_COD As Integer
    <DataMember()>
    Public Property ALL_DES As String
    <DataMember()>
    Public Property GEN_COD As Nullable(Of Integer)
    <DataMember()>
    Public Property SPE_COD As Nullable(Of Integer)
    <DataMember()>
    Public Property Efficienza_Min As Nullable(Of Double)
    <DataMember()>
