...
Partial Public Class Codifica_BDN_CategorieAnimali

    'Simple Properties
    <DataMember()>
    Public Property TIP_TIPPR_ID As Integer
    <DataMember()>
    Public Property CODICE As Nullable(Of Integer)
    <DataMember()>
    Public Property DESCRIZIONE As String
    <DataMember()>
    Public Property ORIENT_PROD_ID As Integer
    <DataMember()>
    Public Property GEN_COD As Integer
    <DataMember()>
    Public Property SPE_COD As Integer
    <DataMember()>
    Public Property IPROD_COD As Integer
    <DataMember()>
