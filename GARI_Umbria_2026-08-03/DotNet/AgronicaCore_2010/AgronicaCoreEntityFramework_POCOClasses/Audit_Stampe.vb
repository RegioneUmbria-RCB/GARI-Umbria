...
Partial Public Class Audit_Stampe
    ...
    <DataMember()>
    Public Property Audit_Stampa As Integer
    <DataMember()>
    Public Property Percorso_Report As String
    <DataMember()>
    Public Property Audit_Stampa_Des As String
    <DataMember()>
