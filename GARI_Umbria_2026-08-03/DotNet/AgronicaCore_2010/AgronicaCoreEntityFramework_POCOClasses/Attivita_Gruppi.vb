...
Partial Public Class Attivita_Gruppi
    ...
    <DataMember()>
    Public Property ID_Attivita_Gruppo As Integer
    <DataMember()>
    Public Property Desc_Gruppo As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property Tipologia_Attivita As Nullable(Of Integer)
