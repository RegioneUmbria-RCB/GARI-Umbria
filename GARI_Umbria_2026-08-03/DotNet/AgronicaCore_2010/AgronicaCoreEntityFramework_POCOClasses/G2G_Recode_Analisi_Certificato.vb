...
Partial Public Class G2G_Recode_Analisi_Certificato
    ...
    <DataMember()>
    Public Property From_Analisi_Certificato_Cod As Integer
    <DataMember()>
    Public Property To_Analisi_Certificato_Cod As Integer
    <DataMember()>
