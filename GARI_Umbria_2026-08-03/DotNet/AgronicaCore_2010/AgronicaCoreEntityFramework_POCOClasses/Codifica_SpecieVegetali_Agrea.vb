...
Partial Public Class Codifica_SpecieVegetali_Agrea
    ...
    <DataMember()>
    Public Property Veg_Cod_Agrea As String
    <DataMember()>
    Public Property Cul_Cod_Agrea As String
    <DataMember()>
    Public Property Veg_Des_Agrea As String
    <DataMember()>
    Public Property Cul_Des_Agrea As String
    <DataMember()>
