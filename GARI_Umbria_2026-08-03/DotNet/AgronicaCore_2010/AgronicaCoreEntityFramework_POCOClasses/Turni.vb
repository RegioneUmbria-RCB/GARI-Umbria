...
Partial Public Class Turni
    ...
    <DataMember()>
    Public Property Turno_Des As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property Tariffa_Base As Nullable(Of Integer)
    <DataMember()>
    Public Property Perc_Aumento_Tariffa As Nullable(Of Double)
    <DataMember()>
    Public Property Perc_Aumento_Turno As Nullable(Of Double)
    <DataMember()>
