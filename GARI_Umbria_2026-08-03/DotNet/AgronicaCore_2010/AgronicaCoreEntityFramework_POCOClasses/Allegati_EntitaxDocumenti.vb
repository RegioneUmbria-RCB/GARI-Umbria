...
Partial Public Class Allegati_EntitaxDocumenti
    ...
    <DataMember()>
    Public Property Allegati_Entita_Cod As Integer
    <DataMember()>
    ...
    <DataMember()>
    Public Property ID_PDC_Testata As Nullable(Of Integer)
    <DataMember()>
    Public Property ID_PDC_Dettagli As Nullable(Of Integer)
