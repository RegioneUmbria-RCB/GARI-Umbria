...
Partial Public Class FormeGiuridiche

    'Simple Properties
    <DataMember()>
    Public Property FG_cod As Integer
    <DataMember()>
    Public Property FG_Des As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property FlagPubblicoPrivato As Nullable(Of Short)
    <DataMember()>
    Public Property FlagPubblica As Nullable(Of Short)
