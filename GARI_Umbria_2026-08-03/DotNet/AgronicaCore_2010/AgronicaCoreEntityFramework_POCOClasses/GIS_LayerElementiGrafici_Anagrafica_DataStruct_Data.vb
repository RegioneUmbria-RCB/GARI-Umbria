...
Partial Public Class GIS_LayerElementiGrafici_Anagrafica_DataStruct_Data

    'Simple Properties
    <DataMember()>
    Public Property TipologiaLayer_Data_Cod As Integer
    <DataMember()>
    ...
    <DataMember()>
    Public Overridable Property GIS_LayerElementiGrafici_Anagrafica_DataStruct As GIS_LayerElementiGrafici_Anagrafica_DataStruct
