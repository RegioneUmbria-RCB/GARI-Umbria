...
Partial Public Class Zoo_Malattie
    ...
    <DataMember()>
    Public Property Malattia_Cod As Integer
    <DataMember()>
    Public Property Malattia_Nome As String
    <DataMember()>
    Public Property Categoria As String
    <DataMember()>
    Public Property Prevenzione As String
    <DataMember()>
    Public Property Sintomi As String
    <DataMember()>
    Public Property Decorso As String
    <DataMember()>
