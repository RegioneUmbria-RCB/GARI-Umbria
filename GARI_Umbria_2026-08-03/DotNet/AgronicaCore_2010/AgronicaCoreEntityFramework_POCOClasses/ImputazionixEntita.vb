...
Partial Public Class ImputazionixEntita
    ...
    <DataMember()>
    Public Property Filtro_Xml As String
    <DataMember()>
    Public Property Filtro_Sql As String
    <DataMember()>
    Public Property Filtro_MP_Sql As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property Filtro_Planning As String
