...
Partial Public Class Zoo_Gruppi
    ...
    <DataMember()>
    Public Property Gruppo_Cod As Integer
    <DataMember()>
    Public Property Gruppo_Sigla As String
    <DataMember()>
    Public Property Gruppo_Des As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property ChkMungitura As Short
    <DataMember()>
    Public Property ChkAlimentazione As Short
    <DataMember()>
    Public Property ChkMacellazione As Short
    <DataMember()>
    Public Property ChkFarmaci As Short
    <DataMember()>
