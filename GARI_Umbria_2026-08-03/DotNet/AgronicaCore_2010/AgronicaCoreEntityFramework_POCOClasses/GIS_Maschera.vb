...
Partial Public Class GIS_Maschera
    ...
    <DataMember()>
    Public Property Maschera_Des As String
    <DataMember()>
    Public Property LayerElementiGrafici_Raster_Cod As Integer
    <DataMember()>
    Public Property TipologiaLayer_Raster_Cod As Integer
    <DataMember()>
