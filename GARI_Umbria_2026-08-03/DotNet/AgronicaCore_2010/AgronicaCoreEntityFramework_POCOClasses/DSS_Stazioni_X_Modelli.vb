...
Partial Public Class DSS_Stazioni_X_Modelli
    ...
    <DataMember()>
    Public Property InizioPeriodo_gg As Integer
    <DataMember()>
    Public Property FinePeriodo_gg As Integer
    <DataMember()>
    Public Property Validita_minuti As Integer
    <DataMember()>
