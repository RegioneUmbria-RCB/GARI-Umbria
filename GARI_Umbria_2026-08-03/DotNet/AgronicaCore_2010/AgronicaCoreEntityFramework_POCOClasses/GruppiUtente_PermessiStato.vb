...
Partial Public Class GruppiUtente_PermessiStato
    ...
    <DataMember()>
    Public Property Visualizza As Integer
    <DataMember()>
    Public Property Modifica As Integer
    <DataMember()>
    Public Property Cancella As Integer
    <DataMember()>
