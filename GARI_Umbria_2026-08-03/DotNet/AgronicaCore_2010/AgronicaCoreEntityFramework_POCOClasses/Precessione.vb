...
Partial Public Class Precessione

    'Simple Properties
    <DataMember()>
    Public Property ID_Precessione As Integer
    <DataMember()>
    Public Property veg_cod As Integer
    <DataMember()>
    Public Property grfi_cod As Integer
    <DataMember()>
    Public Property id_terreno As Integer
    <DataMember()>
    Public Property numero As Nullable(Of Double)
    <DataMember()>
