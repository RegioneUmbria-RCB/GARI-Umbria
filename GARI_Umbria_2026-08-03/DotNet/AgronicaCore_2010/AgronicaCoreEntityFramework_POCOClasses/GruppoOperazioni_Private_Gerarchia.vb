...
Partial Public Class GruppoOperazioni_Private_Gerarchia

    'Simple Properties
    <DataMember()>
    Public Property Piva_SuperUser As String
    <DataMember()>
    Public Property Gru_Cod_Privato_Padre As Integer
    <DataMember()>
    Public Property Gru_Cod_Privato_Figlio As Integer
    <DataMember()>
