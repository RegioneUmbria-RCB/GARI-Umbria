...
Partial Public Class DatiColture_Raccolta
    ...
    <DataMember()>
    Public Property Umidita_Raccolta As Nullable(Of Double)
    <DataMember()>
    Public Property Harvest_Index As Nullable(Of Double)
    <DataMember()>
    Public Property Coefficiente_Isoumico As Nullable(Of Double)
    <DataMember()>
