...
Partial Public Class ws_Canopy_Anagrafica
    ...
    <DataMember()>
    Public Property StatoSincronizzazione As Integer
    <DataMember()>
    Public Property DescrizioneSalvataggio As String
    <DataMember()>
    Public Property MessaggiSincroCanopy As String
    <DataMember()>
    Public Property Data_Modifica_Canopy As Nullable(Of Date)
    <DataMember()>
