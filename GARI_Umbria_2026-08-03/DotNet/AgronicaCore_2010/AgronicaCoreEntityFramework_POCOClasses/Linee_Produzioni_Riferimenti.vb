...
Partial Public Class Linee_Produzioni_Riferimenti
    ...
    <DataMember()>
    Public Property Linea_Cod_Rif As Integer
    <DataMember()>
    Public Property Preparazione_Cod As Integer
    <DataMember()>
    Public Property Mat_Cod As Integer
    <DataMember()>
    Public Property Mat_Cod_Rif As Integer
    <DataMember()>
    ...
    <DataMember()>
    Public Property Codice_Generazione_Rif As Nullable(Of Integer)
    <DataMember()>
    Public Property Preparazione_Cod_Modello As Nullable(Of Integer)
