...
Partial Public Class DatiReteAcqua_StoricoPrelieviTR10
    ...
    <DataMember()>
    Public Property Settimana As Short
    <DataMember()>
    Public Property FullReturn As Decimal
    <DataMember()>
    Public Property DeficitReturn As Decimal
    <DataMember()>
    ...
    <DataMember()>
    Public Property GruppoConsegna As Short
