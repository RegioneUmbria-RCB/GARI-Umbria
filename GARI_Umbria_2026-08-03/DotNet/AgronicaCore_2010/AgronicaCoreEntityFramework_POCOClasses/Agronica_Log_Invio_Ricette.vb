...
Partial Public Class Agronica_Log_Invio_Ricette
    ...
    <DataMember()>
    Public Property ID_Ricetta_Operazione As Integer
    <DataMember()>
    Public Property ID_Ricetta_Operazione_Esterna As Nullable(Of Integer)
    <DataMember()>
