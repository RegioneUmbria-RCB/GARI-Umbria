...
Partial Public Class Farmaci_Categorie

    'Simple Properties
    <DataMember()>
    Public Property ID As Integer
    <DataMember()>
    Public Property Categoria_Codice As String
    <DataMember()>
    Public Property Categoria_Descrizione As String
    <DataMember()>
    ...
    <DataMember()>
    Public Property MacroCat_Cod As Nullable(Of Integer)
