...
Partial Public Class Macchine_Consumi
    ...
    <DataMember()>
    Public Property Potenza_Min As Nullable(Of Double)
    <DataMember()>
    Public Property Potenza_Max As Nullable(Of Double)
    <DataMember()>
    Public Property Potenza_Udm_Cod As Nullable(Of Integer)
    <DataMember()>
    Public Property Car_Cod As Integer
    <DataMember()>
