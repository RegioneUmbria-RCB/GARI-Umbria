...
Partial Public Class WTransizioniDiStatoConfigurazione

    'Simple Properties
    <DataMember()>
    Public Property Stato_Origine_Cod As Integer
    <DataMember()>
    Public Property Stato_Destinazione_cod As Integer
    <DataMember()>
    Public Property Servizio_cod As Integer
    <DataMember()>
    Public Property ProfiloAutorizzato As Integer
    <DataMember()>
    Public Property WTransizioniDiStatoConfigurazione_Des As String
    <DataMember()>
