...
Public Class FF_A_CrystalReports_CP_TraduzioniLabel_R
    Inherits AgronicaCoreDataProvider.DataProvider

    '##############################################################################################
    Public Function Leggi( _
            ByVal FF_A_CrystalReports_CP_Label_COD As Integer, _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "FF_A_CrystalReports_CP_TraduzioniLabel_R.Leggi()"
        ...
        Try
            ...
            Stb.Append(" from FF_A_CrystalReports_CP_TraduzioniLabel " & vbCrLf)
            Stb.Append(" where lingua_cod  = " & Lingua_COD & " " & vbCrLf)
            Stb.Append(" and FF_A_CrystalReports_CP_Label_COD = " & FF_A_CrystalReports_CP_Label_COD & " " & vbCrLf)
