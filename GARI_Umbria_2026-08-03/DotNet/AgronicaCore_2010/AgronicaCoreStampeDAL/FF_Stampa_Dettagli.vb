...
Public Class FF_Stampa_Dettagli_R
...
Public Class FF_Stampa_Dettagli_W
    Inherits AgronicaCoreDataProvider.DataProvider
    ...
    Public Function Scrivi( _
            ...
            , ByVal FF_Stampa_Dettagli_Des As String _
            , ByRef objParametri As AgronicaCoreDataProvider.AgronicaCoreParametri _
        ...
        Try
            ...
            '---------------------------------------------
            Stb.Length = 0
            Stb.Append(" INSERT FF_Stampa_Dettagli " + vbCrLf)

            Stb.Append("              (")
            Stb.Append("              FF_Stampa_Dettagli_Cod,            FF_Stampa_Dettagli_Des, ")
            ...
            Stb.Append("        , '" & Agro_SQL_SaveText(FF_Stampa_Dettagli_Des) & "'" & vbCrLf)
