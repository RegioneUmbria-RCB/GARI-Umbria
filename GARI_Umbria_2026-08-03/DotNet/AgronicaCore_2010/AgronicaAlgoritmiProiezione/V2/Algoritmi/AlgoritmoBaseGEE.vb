...
Imports AgronicaAlgoritmiProiezione.AgronicaAlgoritmiProiezione.V2.DTOs
...
Namespace V2.Algoritmi
    Public Class AlgoritmoBaseGEE
        ...
        Protected cf_config As DTOs.CF_Config
        ...
        Public Function Esegui(LayerAnalysisConfig_Cod As Integer, Entita_cod_1 As Integer, Entita_cod_2 As Integer, Entita_cod_Risultato As Integer, Esecuzione_cod As Integer, Esecuzione_GUID As String, ParametriEsecuzione As String, ByRef objParametri_Server As AgronicaCoreParametri, ByRef objParametri_Utenti As AgronicaCoreParametri, ByRef objParametri_Super_Server As AgronicaCoreParametri, Optional override_transazione As Boolean = False) As JArray Implements IAlgoritmoProiezione.Esegui
            Return Nothing
        End Function
        ...
        Public Function Get_CF_Config() As DTOs.CF_Config Implements IAlgoritmoProiezione.Get_CF_Config
            Return cf_config
        End Function
    End Class
End Namespace
