...
Public Class ParticelleCatastali_Vulnerabili_R
    ...
    Public Function Leggi(ByVal PROV As String, _
        ...
        Dim NomeRoutine As String = "AgronicaCoreMetaSchemaDAL.ParticelleCatastali_Vulnerabili_R.Leggi()"
        ...
        Try
            ...
            StrSQL.Length = 0
            StrSQL.Append(" SELECT * FROM ParticelleCatastali_Vulnerabili ")
    ...
    '##############################################################################################
    Public Function Vulnerabile(ByVal PROV As String,
                           ByVal COM As String,
