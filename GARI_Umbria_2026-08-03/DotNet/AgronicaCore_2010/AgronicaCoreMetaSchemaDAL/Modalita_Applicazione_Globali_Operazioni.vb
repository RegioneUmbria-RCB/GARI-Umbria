...
Public Class Modalita_Applicazione_Globali_Operazioni
    ...
    Public Function Leggi(ByVal Codice As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreMetaschemaDAL.Modalita_Applicazione_Globali_Operazioni.Leggi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" FROM  Modalita_Applicazione_Globali_Operazioni")
