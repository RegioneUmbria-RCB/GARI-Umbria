...
Public Class Codifica_SpecieVegetali_Agrea_R
    Inherits AgronicaCoreDataProvider.DataProvider

    Public Function Leggi(
                            ByVal Veg_Cod_Agrea As String,
                            ByVal Cul_Cod_Agrea As String,
        ...
        Try
            ...
            Select Case xSelezioneVariabile
                ...
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaDatiMinimi
                    ...
                    StrSQL.Length = 0
                    StrSQL.Append(" SELECT  Veg_Cod_Agrea, Cul_Cod_Agrea, Veg_Cod_Agea, Cul_Cod_Agea, ISNULL(Veg_Des_Agea, '') AS Veg_Des_Agea, ISNULL(Cul_Des_Agea, '') AS Cul_Des_Agea, ")
                    StrSQL.Append(" Veg_cod,  Cul_cod, Grfi_cod, Grva_cod, Metodo_Produzione_cod, Reg_cod, Id_cod ")
                    StrSQL.Append(" FROM    Codifica_SpecieVegetali_Agrea ")
                    ...
                    If Veg_Cod_Agrea <> "" Then
                        StrSQL.Append(" AND Veg_Cod_Agrea = '" & Agro_SQL_SaveText(Veg_Cod_Agrea) & "' ")
                    End If
                    If Cul_Cod_Agrea <> "" Then
                        StrSQL.Append(" AND Cul_Cod_Agrea = '" & Agro_SQL_SaveText(Cul_Cod_Agrea) & "' ")
                    End If
                ...
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_JoinDescrizioni
                    ...
                    StrSQL.Length = 0
                    StrSQL.Append(" SELECT  Veg_Cod_Agrea, Cul_Cod_Agrea, Veg_Cod_Agea, Cul_Cod_Agea, ISNULL(Veg_Des_Agea, '') AS Veg_Des_Agea, ISNULL(Cul_Des_Agea, '') AS Cul_Des_Agea, ")
                    StrSQL.Append(" Codifica_SpecieVegetali_Agrea.Veg_cod,  Codifica_SpecieVegetali_Agrea.Cul_cod, Codifica_SpecieVegetali_Agrea.Grfi_cod, Codifica_SpecieVegetali_Agrea.Grva_cod, Codifica_SpecieVegetali_Agrea.Metodo_Produzione_cod, Codifica_SpecieVegetali_Agrea.Reg_cod, Codifica_SpecieVegetali_Agrea.Id_cod, ")
                    ...
                    StrSQL.Append(" FROM         Codifica_SpecieVegetali_Agrea LEFT OUTER JOIN ")
                    StrSQL.Append(" Codici_Anagrafe ON Codifica_SpecieVegetali_Agrea.Id_cod = Codici_Anagrafe.codice LEFT OUTER JOIN ")
                    StrSQL.Append(" Regolamenti ON Codifica_SpecieVegetali_Agrea.Reg_cod = Regolamenti.Reg_Cod LEFT OUTER JOIN ")
                    StrSQL.Append(" GruppoFinalita ON Codifica_SpecieVegetali_Agrea.Grfi_cod = GruppoFinalita.Grfi_Cod LEFT OUTER JOIN ")
                    StrSQL.Append(" GruppoVarietale ON Codifica_SpecieVegetali_Agrea.Grva_cod = GruppoVarietale.Grva_Cod LEFT OUTER JOIN ")
                    StrSQL.Append(" Cultivar ON Codifica_SpecieVegetali_Agrea.Cul_cod = Cultivar.Cul_Cod LEFT OUTER JOIN ")
                    StrSQL.Append("  SpecieVegetali ON Codifica_SpecieVegetali_Agrea.Veg_cod = SpecieVegetali.Veg_Cod ")

                    StrSQL.Append(" WHERE   Codifica_SpecieVegetali_Agrea.Validita_Inizio <=" & Agro_SQL_SaveDate(CDate(objParametri.FinestraTemporaleFine)) & " ")
                    StrSQL.Append(" AND     Codifica_SpecieVegetali_Agrea.Validita_Fine >=" & Agro_SQL_SaveDate(CDate(objParametri.FinestraTemporaleInizio)) & " ")

                    If Veg_Cod_Agrea <> "" Then
                        StrSQL.Append(" AND Codifica_SpecieVegetali_Agrea.Veg_Cod_Agrea = '" & Agro_SQL_SaveText(Veg_Cod_Agrea) & "' ")
                    End If
                    If Cul_Cod_Agrea <> "" Then
                        StrSQL.Append(" AND Codifica_SpecieVegetali_Agrea.Cul_Cod_Agrea = '" & Agro_SQL_SaveText(Cul_Cod_Agrea) & "' ")
                    End If
                    If Veg_Cod_Agea <> "" Then
                        StrSQL.Append(" AND Codifica_SpecieVegetali_Agrea.Veg_Cod_Agea = '" & Agro_SQL_SaveText(Veg_Cod_Agea) & "' ")
                    End If
                    If Cul_Cod_Agea <> "" Then
                        StrSQL.Append(" AND Codifica_SpecieVegetali_Agrea.Cul_Cod_Agea = '" & Agro_SQL_SaveText(Cul_Cod_Agea) & "' ")
                    End If

                    If Veg_Cod <> 0 Then
                        StrSQL.Append(" AND Codifica_SpecieVegetali_Agrea.Veg_Cod = " & Agro_SQL_SaveNum(Veg_Cod) & " ")
                    End If
                    If Cul_Cod <> 0 Then
                        StrSQL.Append(" AND Codifica_SpecieVegetali_Agrea.Cul_Cod = " & Agro_SQL_SaveNum(Cul_Cod) & " ")
                    End If
                    If Id_Cod <> 0 Then
                        StrSQL.Append(" AND Codifica_SpecieVegetali_Agrea.Id_Cod = " & Agro_SQL_SaveNum(Id_Cod) & " ")
                    End If
                    ...
                    Select Case objParametri.FlagVisibilita
                        Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_SoloNonCancellati
                            StrSQL.Append(" AND   Codifica_SpecieVegetali_Agrea.Inviato >=0 ")
                        Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_SoloCancellati
                            StrSQL.Append(" AND   Codifica_SpecieVegetali_Agrea.Inviato =-1 ")
                        Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_Tutti
                            '...................................
                        Case Else
                            Throw New Exception("Parametro non corretto nella query (FlagVisibilita)")
    ...
    Public Function Specie_e_Varieta_Gias_Da_Agrea_Old(ByRef LogCodificheMancantiSpecie As String,
        ...
        DtCodifica = Leggi(Veg_Cod_Agrea,
                            "",
        ...
        Dim customLOGParamsCsv As New CustomLOGParams With {
                        ...
                        .LogFileName = $"CodificaSpecieVegetaliAgrea_VARIETA_mancanti_Excel.csv"
                    }

        Dim customLOGParamsTxt As New CustomLOGParams With {
                        .LogDescrizioneUtente = objParametri.UtenteUsername,
                        .LogDirectory = objParametri.LogDirectory,
                        .LogFileName = $"CodificaSpecieVegetaliAgrea_VARIETA_mancanti.txt"
                    }

        If Not IsNothing(DtCodifica) AndAlso DtCodifica.Rows.Count > 0 Then

            DrVar = DtCodifica.Select("Cul_Cod_Agrea='" & Cul_Cod_Agrea.ToString & "'")
            ...
            Else
                ...
                If Cul_Cod_Agrea <> "" Then
                    LogCodificheMancantiVarieta &= "Specie: " & Specie_Des_AgeaInput & ", Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) &
                        " - la varietà " & Varieta_Des_AgeaInput & " con Cul_Cod_Agrea=" & CStr(Cul_Cod_Agrea) & " non è mappata -> è stata selezionata la varietà Altre." & vbCrLf & vbCrLf
                    LogCodificheMancantiVarieta_Excel &= vbTab & vbTab & Specie_Des_AgeaInput & vbTab & CStr(Veg_Cod_Agrea) & vbTab & Varieta_Des_AgeaInput & vbTab & CStr(Cul_Cod_Agrea)
        ...
        Else
            ...
            LogCodificheMancantiSpecie &= "Nessun record presente per il Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) & "  " & Specie_Des_AgeaInput & vbCrLf & vbCrLf
            LogCodificheMancantiSpecie_Excel &= vbTab & vbTab & Specie_Des_AgeaInput & vbTab & CStr(Veg_Cod_Agrea)
    ...
    Public Function Specie_e_Varieta_Gias_Da_Agrea(ByRef LogCodificheMancantiSpecie As String,
                                              ByRef LogCodificheMancantiVarieta As String,
                                                ByVal Veg_Cod_Agrea As String,
                                                ByVal Cul_Cod_Agrea As String,
        ...
        Dim NomeRoutine As String = "Specie_e_Varieta_Gias_Da_Agrea"

        Dim Ente_Cod As Integer = enum_Planning_Fonte.Agrea
        Dim LogCodificheMancantiSpecie_Excel As String = ""
        Dim LogCodificheMancantiVarieta_Excel As String = ""
        ...
        DtCodifica = objEnteR.leggi(objParametri, Ente_Cod, Veg_Cod_Agrea, "", "", "", "", "", "", "", "")

        Dim customLOGParamsCsv As New CustomLOGParams With {
                        .LogDescrizioneUtente = objParametri.UtenteUsername,
                        .LogDirectory = objParametri.LogDirectory,
                        .LogFileName = $"CodificaSpecieVegetaliAgrea_SPECIE_mancanti_Excel.csv"
                    }

        Dim customLOGParamsTxt As New CustomLOGParams With {
                        .LogDescrizioneUtente = objParametri.UtenteUsername,
                        .LogDirectory = objParametri.LogDirectory,
                        .LogFileName = $"CodificaSpecieVegetaliAgrea_SPECIE_mancanti.txt"
                    }

        Dim customLOGParamsCsvCompleto As New CustomLOGParams With {
                        .LogDescrizioneUtente = objParametri.UtenteUsername,
                        .LogDirectory = objParametri.LogDirectory,
                        .LogFileName = $"CodificaSpecieVegetaliAgrea_SPECIE_mancanti_Excel_Completo.csv"
                    }


        If Not IsNothing(DtCodifica) AndAlso DtCodifica.Rows.Count > 0 Then

            DrVar = DtCodifica.Select("Cul_Cod_Ente='" & Cul_Cod_Agrea.ToString & "'")
            ...
            If Not DrVar Is Nothing AndAlso DrVar.Length > 0 Then
                ...
                Else
                    ...
                    LogCodificheMancantiVarieta &= "Specie: " & Specie_Des_AgeaInput & ", Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) &
                        " - la varietà " & Varieta_Des_AgeaInput & " con Cul_Cod_Agrea=" & CStr(Cul_Cod_Agrea) & " non è mappata con AGEA." & vbCrLf & vbCrLf
                    LogCodificheMancantiVarieta_Excel &= ";" & ";" & Specie_Des_AgeaInput & ";" & CStr(Veg_Cod_Agrea) & ";" & Varieta_Des_AgeaInput & ";" & CStr(Cul_Cod_Agrea)
                    LogCodificheMancantiSpecie_Excel_Completo &= ";" & ";" & Specie_Des_AgeaInput & ";" & CStr(Veg_Cod_Agrea) & ";" & Varieta_Des_AgeaInput & ";" & CStr(Cul_Cod_Agrea)
                    Scrivi_LOG(objParametri, NomeRoutine, LogCodificheMancantiVarieta_Excel, CustomLOGParams:=customLOGParamsCsv)
                    Scrivi_LOG(objParametri, NomeRoutine, LogCodificheMancantiVarieta, CustomLOGParams:=customLOGParamsTxt)
                    Scrivi_LOG(objParametri, NomeRoutine, LogCodificheMancantiSpecie_Excel_Completo, CustomLOGParams:=customLOGParamsCsvCompleto)
                End If
    ...
    Public Function Specie_e_Varieta_AGEA_Da_Agrea_Old(ByRef LogCodificheMancantiSpecie As String,
                                              ByRef LogCodificheMancantiVarieta As String,
                                                ByVal Veg_Cod_Agrea As String,
                                                ByVal Cul_Cod_Agrea As String,
                                                ByRef Veg_Cod_Agea As String,
        ...
        Dim customLOGParamsCsv As New CustomLOGParams With {
                        .LogDescrizioneUtente = objParametri.UtenteUsername,
                        .LogDirectory = objParametri.LogDirectory,
                        .LogFileName = $"CodificaSpecieVegetaliAgrea-AGEA_SPECIE_mancanti_Excel.csv"
                    }

        Dim customLOGParamsTxt As New CustomLOGParams With {
                        .LogDescrizioneUtente = objParametri.UtenteUsername,
                        .LogDirectory = objParametri.LogDirectory,
                        .LogFileName = $"CodificaSpecieVegetaliAgrea-AGEA_SPECIE_mancanti.txt"
                    }
        ...
        If Not IsNothing(DtCodifica) AndAlso DtCodifica.Rows.Count > 0 Then
            ...
            If Not DrVar Is Nothing AndAlso DrVar.Length > 0 Then
                Specie_Des_Agea = DrVar(0).Item("Veg_Des_Agea")
                If Not IsDBNull(DrVar(0).Item("Veg_Cod_Agea")) Then
                    'AndAlso IsDBNull(DrVar(0).Item("Veg_Cod_Agea")) <> "000"
                    Veg_Cod_Agea = DrVar(0).Item("Veg_Cod_Agea")
                Else
                    LogCodificheMancantiSpecie &= "Nessun record presente su AGEA per il Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) & "  " & Specie_Des_AgeaInput & vbCrLf & vbCrLf
                    LogCodificheMancantiSpecie_Excel &= vbTab & vbTab & Specie_Des_AgeaInput & vbTab & CStr(Veg_Cod_Agrea)
                    Scrivi_LOG(objParametri, NomeRoutine, LogCodificheMancantiSpecie, CustomLOGParams:=customLOGParamsTxt)
                    Scrivi_LOG(objParametri, NomeRoutine, LogCodificheMancantiSpecie_Excel, CustomLOGParams:=customLOGParamsCsv)
                    Veg_Cod_Agea = "0"
                ...
                If Not IsDBNull(DrVar(0).Item("Cul_Cod_Agea")) Then
                    'AndAlso IsDBNull(DrVar(0).Item("Cul_Cod_Agea")) <> "000"
                    Cul_Cod_Agea = DrVar(0).Item("Cul_Cod_Agea")
                Else
                    LogCodificheMancantiVarieta &= "Specie: " & Specie_Des_AgeaInput & ", Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) &
                        " - la varietà " & Varieta_Des_AgeaInput & " con Cul_Cod_Agrea=" & CStr(Cul_Cod_Agrea) & " non è mappata con AGEA -> è stata selezionata la varietà Altre." & vbCrLf & vbCrLf
                    LogCodificheMancantiVarieta_Excel &= vbTab & vbTab & Specie_Des_AgeaInput & vbTab & CStr(Veg_Cod_Agrea) & vbTab & Varieta_Des_AgeaInput & vbTab & CStr(Cul_Cod_Agrea)
                    Scrivi_LOG(objParametri, NomeRoutine, LogCodificheMancantiVarieta_Excel, CustomLOGParams:=customLOGParamsCsv)
                    Scrivi_LOG(objParametri, NomeRoutine, LogCodificheMancantiVarieta, CustomLOGParams:=customLOGParamsTxt)
                    Cul_Cod_Agea = "0"
            ...
            Else
                ...
                If Not IsDBNull(DrVar(0).Item("Veg_Cod_Agea")) AndAlso IsDBNull(DrVar(0).Item("Veg_Cod_Agea")) <> 0 Then
                    Veg_Cod_Agea = DrVar(0).Item("Veg_Cod_Agea")
                Else
                    LogCodificheMancantiSpecie &= "Nessun record presente su AGEA per il Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) & "  " & Specie_Des_AgeaInput & vbCrLf & vbCrLf
                    LogCodificheMancantiSpecie_Excel &= vbTab & vbTab & Specie_Des_AgeaInput & vbTab & CStr(Veg_Cod_Agrea)
                    ...
                    Veg_Cod_Agea = "0"
                End If
                If Not IsDBNull(DrVar(0).Item("Cul_Cod_Agea")) AndAlso IsDBNull(DrVar(0).Item("Cul_Cod_Agea")) <> 0 Then
                    Cul_Cod_Agea = DrVar(0).Item("Cul_Cod_Agea")
                Else
                    LogCodificheMancantiVarieta &= "Specie: " & Specie_Des_AgeaInput & ", Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) &
                        " - la varietà " & Varieta_Des_AgeaInput & " con Cul_Cod_Agrea=" & CStr(Cul_Cod_Agrea) & " non è mappata con AGEA -> è stata selezionata la varietà Altre." & vbCrLf & vbCrLf
        ...
        Else
            ...
            'LogCodificheMancantiSpecie &= "Nessun record presente per il Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) & "  " & Specie_Des_AgeaInput & vbCrLf & vbCrLf
            'LogCodificheMancantiSpecie_Excel &= vbTab & vbTab & Specie_Des_AgeaInput & vbTab & CStr(Veg_Cod_Agrea)
            'Scrivi_LOG(objParametri.LogDirectory, "CodificaSpecieVegetaliAgrea_SPECIE_mancanti.txt", objParametri.UtenteUsername, NomeRoutine, LogCodificheMancantiSpecie)
            'Scrivi_LOG(objParametri.LogDirectory, "CodificaSpecieVegetaliAgrea_SPECIE_mancanti_Excel.csv", objParametri.UtenteUsername, NomeRoutine, LogCodificheMancantiSpecie_Excel)
    ...
    Public Function Specie_e_Varieta_AGEA_Da_Agrea(ByRef LogCodificheMancantiSpecie As String,
                                              ByRef LogCodificheMancantiVarieta As String,
                                                ByVal Veg_Cod_Agrea As String,
                                                ByVal Cul_Cod_Agrea As String,
                                                ByRef Veg_Cod_Agea As String,
        ...
        'filtro poi se è mappata anche la varietà
        'altrimenti metto 'altre'....
        Dim objEntiR As New AgronicaCoreMetaSchemaDAL.Codifica_SpecieVegetali_Enti_2015_2020_R
        'DtCodifica = Leggi(Veg_Cod_Agrea,
        '                    "",
        '                    "", "", 0, 0, 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_JoinDescrizioni,
        '                    "", "",
        '                    objParametri)
        DtCodifica = objEntiR.leggi(objParametri, enum_Planning_Fonte.Agrea, Veg_Cod_Agrea, "", "", "", "", "", "", "", "")
        ...
        If Not IsNothing(DtCodifica) AndAlso DtCodifica.Rows.Count > 0 Then
            ...
            If Not DrVar Is Nothing AndAlso DrVar.Length > 0 Then
                ...
                End If
                If Not IsDBNull(DrVar(0).Item("Cul_Cod_Agea")) Then
                    If CInt(Cul_Cod_Agrea) <> 0 Then
                        If CInt(DrVar(0).Item("Cul_Cod_Agea")) <> 0 Then
                            Cul_Cod_Agea = DrVar(0).Item("Cul_Cod_Agea")
                        Else
                            LogCodificheMancantiVarieta &= "Specie: " & Specie_Des_AgeaInput & ", Veg_Cod_Agrea=" & CStr(Veg_Cod_Agrea) &
                        " - la varietà " & Varieta_Des_AgeaInput & " con Cul_Cod_Agrea=" & CStr(Cul_Cod_Agrea) & " non è mappata con AGEA -> è stata selezionata la varietà Altre." & vbCrLf & vbCrLf
