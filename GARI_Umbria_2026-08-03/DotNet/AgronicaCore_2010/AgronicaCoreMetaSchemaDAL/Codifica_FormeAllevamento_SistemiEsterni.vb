...
Public Class Codifica_FormeAllevamento_SistemiEsterni_R
    ...
    Public Function Leggi(ByVal ID As Integer,
                          ...
                          ByVal Foral_Cod_Esterno As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreMetaschemaDAL.Codifica_FormeAllevamento_SistemiEsterni_R.Leggi()"
        ...
        Try
            ...
            StrSQL.Append(" FROM  Codifica_FormeAllevamento_SistemiEsterni ")
            ...
            If Foral_Cod_Esterno <> "" Then
                StrSQL.Append(" AND Foral_Cod_Esterno  = '" & Agro_SQL_SaveText(Foral_Cod_Esterno) & "'   " + vbCrLf)
            End If
            ...
            Else
                StrSQL.Append(" ORDER BY Foral_Des_Esterno ASC")
            End If
