...
Public Class CBI_Causali_R
    Inherits AgronicaCoreDataProvider.DataProvider

    '##############################################################################################
    Public Function Leggi( _
            ByVal CBI_Causali_Cod As Integer, _
        ...
        '----- Descrizione
        Dim NomeRoutine As String = "AgronicaCoreMetaSchemaDAL.CBI_Causali_R.Leggi()"
        ...
        Try
            ...
            strSQL.Append(" SELECT * FROM CBI_Causali " + vbCrLf)

            If CBI_Causali_Cod <> -1 Then
                strSQL.Append(" WHERE CBI_Causali_Cod = " & CBI_Causali_Cod & vbCrLf)
            End If
