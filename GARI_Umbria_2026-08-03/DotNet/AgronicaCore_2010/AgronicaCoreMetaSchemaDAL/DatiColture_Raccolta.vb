...
Public Class DatiColture_Raccolta_R
    ...
    Public Function Leggi(Regolamento_Cod As Integer,
        ...
        Dim NomeRoutine As String = "AgronicaCoreMetaschemaDAL.DatiColture_Raccolta_R.Leggi()"
        ...
        Try
            ...
            StrSQL.AppendLine(" FROM DatiColture_Raccolta ")
