...
Public Class Codifica_Operazioni_SistemiEsterni_R
    ...
    Public Function Leggi(ByVal ID As Integer,
                          ...
                          ByVal Lav_Cod_Esterno As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreMetaschemaDAL.Codifica_Operazioni_SistemiEsterni_R.Leggi()"
        ...
        Try
            ...
            StrSQL.Append(" FROM  Codifica_Operazioni_SistemiEsterni WITH(NOLOCK)")
            ...
            If Lav_Cod_Esterno <> "" Then
                StrSQL.Append(" AND Lav_Cod_Esterno  = " & Agro_SQL_SaveText(Lav_Cod_Esterno) & "   " + vbCrLf)
            End If
            ...
            Else
                StrSQL.Append(" ORDER BY Lav_Des_Esterno ASC")
            End If
