...
Public Class PC_GrigliaSO_R
    ...
    Public Function Leggi(ByVal Regolamento_Cod As Int32,
        ...
        Dim NomeRoutine As String = "AgronicaCoreMetaSchemaDAL.PC_GrigliaSO_R.Leggi()"
        ...
        Try
            ...
            StrSQL.Append(" FROM    PC_GrigliaSO ")
            ...
            If SO <> "" Then
                StrSQL.Append(" AND   Minimo <= " & Agro_SQL_SaveNum(SO) & " ")
                StrSQL.Append(" AND   Massimo >= " & Agro_SQL_SaveNum(SO) & " ")
            End If
            ...
            Select Case objParametri.FlagVisibilita
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_SoloNonCancellati
                    StrSQL.Append(" AND   PC_GrigliaSO.Inviato >=0 ")
                Case AgronicaCoreDataProvider.AgronicaCoreParametri.enumVisibilita.Visibilita_SoloCancellati
                    StrSQL.Append(" AND   PC_GrigliaSO.Inviato =-1 ")
    ...
    Public Function Leggi_Dotazione(ByVal Regolamento_Cod As Int32,
        ...
        Dim NomeRoutine As String = "AgronicaCoreMetaSchemaDAL.PC_GrigliaSO_R.Leggi_Dotazione()"
