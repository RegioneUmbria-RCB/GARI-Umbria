...
Public Class PianoConcimazione_FosforoPotassio_W
    ...
    Public Function Scrivi(ByVal PC_Testata_Cod As Integer, _
                            ByVal PC_PK_Appezzamento As String, _
                            ByVal PC_PK_Coltura As String, _
                            ByVal PC_PK_Resa As Decimal, _
                            ByVal PC_PK_Duratadelciclo As Integer, _
                            ByVal PC_PK_Coefficientetempo As Decimal, _
                            ByVal PC_PK_Fase As String, _
                            ByVal PC_PK_Coeffcorrettivoasportazk As Decimal, _
                            ByVal PC_PK_Valutazioneasportazioni As String, _
                            ByVal PC_PK_Asportazioniunitariep2o5 As Decimal, _
                            ByVal PC_PK_Asportazioniunitariek2o As Decimal, _
                            ByVal PC_PK_Dotazioneinizialep2o5 As Decimal, _
                            ByVal PC_PK_Dotazioneinizialetestop2o5 As String, _
                            ByVal PC_PK_Dotazioneinizialek2o As Decimal, _
                            ByVal PC_PK_Dotazioneinizialetestok2o As String, _
                            ByVal PC_PK_Arricchimentop2o5 As Decimal, _
                            ByVal PC_PK_Arricchimentok2o As Decimal, _
                            ByVal PC_PK_asportazionicolturalip2o5 As Decimal, _
                            ByVal PC_PK_asportazionicolturalik2o As Decimal, _
                            ByVal PC_PK_Quotadibasep2o5 As Decimal, _
                            ByVal PC_PK_Quotadibasek2o As Decimal, _
                            ByVal PC_PK_lisciviazionipotassiop2o5 As Decimal, _
                            ByVal PC_PK_lisciviazionipotassiok2o As Decimal, _
                            ByVal PC_PK_asportazioniannifuturianticipatep2o5 As Decimal, _
                            ByVal PC_PK_asportazioniannifuturianticipatek2o As Decimal, _
                            ByVal PC_PK_daprecedentiapportiorganicip2o5 As Decimal, _
                            ByVal PC_PK_daprecedentiapportiorganicipk2o As Decimal, _
                            ByVal PC_PK_daprecedentiapportiorganicip2o5tempo As Decimal, _
                            ByVal PC_PK_daprecedentiapportiorganicipk2otempo As Decimal, _
                            ByVal PC_PK_Fabbisognop2o5 As Decimal, _
                            ByVal PC_PK_Fabbisognok2o As Decimal, _
                            ByVal PC_PK_Limitemassimop2o5 As Decimal, _
                            ByVal PC_PK_Limitemassimok2o As Decimal, _
                            ByVal PC_PK_Quantitamassimap2o5 As Decimal, _
                            ByVal PC_PK_Quantitamassimak2o As Decimal, _
                            ByVal PC_PK_Kgchemodificanoiltenorep2o5 As Decimal, _
                            ByVal PC_PK_Kgchemodificanoiltenorek2o As Decimal, _
                            ByVal PC_PK_Dotazfinalep2o5 As Decimal, _
                            ByVal PC_PK_Dotazfinalek2o As Decimal, _
                            ByVal PC_PK_Distribuzionep2o5 As String, _
                            ByVal PC_PK_Distribuzionek2o As String, _
                            ByVal PC_PK_Notep2o5 As String, _
                            ByVal PC_PK_Note1p2o5 As String, _
                            ByVal PC_PK_Piva As String, _
                            ByVal PC_PK_Ragsoc As String, _
                            ByVal PC_PK_AreaVulnerabile As String, _
                            ByVal PC_PK_Anno As Integer, _
                            ByVal PC_PK_Areaomogenea As String, _
                            ByVal PC_PK_Precessione As String, _
                            ByVal PC_PK_ColturaPrincipale As String, _
                            ByVal PC_PK_Finalita As String, _
                            ByVal PC_PK_Ciclo As String, _
                            ByVal PC_PK_Condizionidelterreno As String, _
                            ByVal PC_PK_Argilla As Decimal, _
                            ByVal PC_PK_P2o5 As Decimal, _
                            ByVal PC_PK_K2o As Decimal, _
                            ByVal PC_PK_Caco3 As Decimal, _
                            ByVal PC_PK_N As Decimal, _
                            ByVal PC_PK_Tessitura As String, _
