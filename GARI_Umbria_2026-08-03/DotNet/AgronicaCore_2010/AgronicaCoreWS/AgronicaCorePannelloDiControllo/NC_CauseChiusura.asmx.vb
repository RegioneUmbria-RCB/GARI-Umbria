...
Public Class NC_ScriptService_CauseChiusura
    ...
    Public Function Leggi(objP_server As String) As RispostaStandard
        ...
        Dim NC_R As New NC_CauseChiusura_R
        Dim lista As List(Of NC_CauseChiusura) = NC_R.leggi_NC_CauseChiusura(objParametri_Server)

        Dim listaJSON As New JArray()
        For Each i As NC_CauseChiusura In lista
            listaJSON.Add(New JObject(New JProperty("nome", i.Nome), New JProperty("id_causachiusura", i.ID_CausaChiusura)))
        Next
    ...
    Public Function Modifica(objP_server As String, nome As String, id As Integer) As RispostaStandard
        ...
        Dim NC_W As New NC_CauseChiusura_W
