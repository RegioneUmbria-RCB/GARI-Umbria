...
Public Class NC_ScriptService_Rischi
    ...
    Public Function Leggi(objP_server As String) As RispostaStandard
        ...
        Dim NC_R As New NC_Rischi_R
        Dim lista As List(Of NC_Rischi) = NC_R.leggi_NC_Rischi(objParametri_Server)

        Dim listaJSON As New JArray()
        For Each i As NC_Rischi In lista
            listaJSON.Add(New JObject(New JProperty("nome", i.Nome), New JProperty("id_rischio", i.ID_Rischio)))
        Next
