...
Public Class NC_ScriptService_LineeImpianti
    ...
    Public Function Leggi(objP_server As String) As RispostaStandard
        ...
        Dim NC_R As New NC_LineeImpianti_R
        Dim lista As List(Of NC_LineeImpianti) = NC_R.leggi_NC_LineeImpianti(objParametri_Server)

        Dim listaJSON As New JArray()
        For Each i As NC_LineeImpianti In lista
            listaJSON.Add(New JObject(New JProperty("nome", i.Nome), New JProperty("id_lineaimpianto", i.ID_LineaImpianto)))
        Next
    ...
    Public Function Modifica(objP_server As String, nome As String, id As Integer) As RispostaStandard
        ...
        Dim NC_W As New NC_LineeImpianti_W
