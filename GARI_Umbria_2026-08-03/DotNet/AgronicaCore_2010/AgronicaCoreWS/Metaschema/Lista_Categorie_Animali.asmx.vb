...
Public Class Lista_Categorie_Animali
	...
	Public Function get_Lista_Categorie_Animali_NG(InData As CoreWS_Generic(Of get_Lista_Categorie_Animali)) As RispostaStandard
		...
		Try
			...
			Dim strP As String = "get_Lista_Categorie_Animali" & InData.InData.gen_cod & "_" & InData.InData.spe_cod & "_" & InData.InData.ipro_cod & "_" & linguaCodiceISO
	...
	<WebMethod(EnableSession:=True)>
	<Script.Services.ScriptMethod()>
	Public Function get_Lista_Categorie_Animali(gen_cod As Integer, spe_cod As Integer, ipro_cod As Integer, objP_server As String, objP_utenti As String) As RispostaStandard
		Dim r As New RispostaStandard
		...
		Try
			...
			Dim strP As String = "get_Lista_Categorie_Animali" & gen_cod & "_" & spe_cod & "_" & ipro_cod & "_" & linguaCodiceISO
