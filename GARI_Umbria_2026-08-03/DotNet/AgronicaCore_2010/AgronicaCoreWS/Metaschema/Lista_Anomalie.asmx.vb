...
Public Class Lista_Anomalie
	...
	Public Function get_Lista_Anomalie(objP_server As String, objP_utenti As String) As RispostaStandard
		...
		Try
			...
			Dim strP As String = "get_Lista_Anomalie" & "_" & linguaCodiceISO
