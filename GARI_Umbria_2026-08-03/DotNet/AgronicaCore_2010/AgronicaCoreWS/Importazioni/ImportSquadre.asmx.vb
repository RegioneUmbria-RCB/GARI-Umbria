...
Public Class ImportSquadre
    ...
    Public Function ImportSquadreDemetra(InData As Object) As Api_Response
        ...
        Try
            ...
            Dim datiRequest As AnagraficaWrapper(Of Squadra) = JsonConvert.DeserializeObject(Of AnagraficaWrapper(Of Squadra))(datiStr)

            errorMessage = ""

            Dim objDemetraSquadreBIZ_import As New AgronicaCoreDemetraBIZ.ImportSquadre

            objDemetraSquadreBIZ_import.ImportSquadre(cuaaRequest, datiRequest, errorMessage, objParametri_Super_Server, objParametri_Server, objParametri_Utenti)
