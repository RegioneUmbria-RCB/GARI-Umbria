...
Public Class UMAConfigurazioneAllevamenti
    ...
    Public Function UMAConfigurazioneAllevamenti_LeggiTabella(ByRef objParametri As AgronicaCoreParametri) As DataTable
        ...
        Try
            Dim configurazioneAllevamenti As DataTable = AgronicaDAL.LeggiUMAConfigurazioneAllevamenti(objParametri)
    ...
    Public Function UMAConfigurazioneAllevamenti_SalvaGriglia(ByRef objParametri As AgronicaCoreParametri,
        ...
        Try
            ...
            If righeInserite.Count() > 0 OrElse righeModificate.Count() > 0 Then
                ControlliValidita_UMAConfigurazioneAllevamenti(righeInserite, righeModificate, objParametri, efConnString, Errori)
            End If
    ...
    Public Shared Function ElencoAllevamenti() As RispostaStandard
        ...
        Try
            ...
            Dim handleTipiAllevamenti As New UMA_Allevamenti_R()
    ...
    Public Shared Sub ControlliValidita_UMAConfigurazioneAllevamenti(ByVal righeInserite As List(Of UMAConfigurazioneAllevamentiDto),
        ...
        If String.IsNullOrEmpty(Errori) AndAlso Not righeInserite Is Nothing AndAlso righeInserite.Count > 0 Then
            For Each l In righeInserite
                ...
                If exists Then
                    Errori = "L'elemento existe già in database: UMA_All_Cod='" & l.UMA_All_Cod & "'"
                    Return
                End If
            Next
        End If
