...
Public Class UMALavorazioniAlternative
    ...
    Public Function LavorazionAlternative_LeggiTabella(ByRef objParametri As AgronicaCoreParametri) As DataTable
        ...
        Try
            Dim lavAlternative As DataTable = AgronicaDAL.LeggiLavorazioniAlternative(objParametri)
    ...
    Public Function LavorazioniAlternative_SalvaGriglia(ByRef objParametri As AgronicaCoreParametri,
        ...
        Using scope As New TransactionScope()
            Try
                ...
                Dim AgronicaDAL As New AgronicaCoreAnagrafeDAL.UMALavorazioniAlternative_W
    ...
    Public Function Dropdown_LavUMA_Lav_UMA_Des(objParametri_Server As AgronicaCoreParametri) As DataTable
        ...
        Dim biz As New AgronicaCoreAnagrafeDAL.UMALAvorazioniAlternative_R
    ...
    Public Shared Sub ControlliValidita_UMALavorazioniAlternative(ByVal righeInserite As List(Of UMALavorazioniAlteranativeDto),
        ...
        If String.IsNullOrEmpty(Errori) AndAlso Not righeInserite Is Nothing AndAlso righeInserite.Count > 0 Then
            For Each l In righeInserite
                ...
                If exists Then
                    Errori = "L'elemento existe già in database: Macrouso UMA Descrizione='" & l.Macrouso_UMA_Des & "', Lavorazione UMA Descrizione='" & l.LavUMA_Lav_UMA_Des & "',  Alt Lavorazione UMA Descrizione='" & l.LavUMAAlt_Lav_UMA_Des & "'"
                    Return
                End If
            Next
        End If
