...
Public Class Interscambio_Contatti_R
    ...
    Public Function Leggi_Tabella_Interscambio_ChiaveGIAS(Sistema_Cod As Integer,
        ...
        Dim objReadDAL As New AgronicaCoreInterscambioDAL.Interscambio_Contatti_R

        Return objReadDAL.Leggi(Sistema_Cod, Piva, Cod_Contatto, Cod_Risum, "", AGRODATAINIZIO, AGRODATAFINE, "", "", objParametri_Server)
    ...
    Public Function Leggi_Tabella_Interscambio_ChiaveEsterna(Sistema_Cod As Integer,
        ...
        Return objReadDAL.Leggi(Sistema_Cod, String.Empty, String.Empty, 0, Codice_Esterno, AGRODATAINIZIO, AGRODATAFINE, "", "", objParametri_Server)
...
Public Class Interscambio_Contatti_W
    ...
    Public Sub Scrivi_Tabella_Interscambio(Sistema_Cod As Integer,
        ...
        If String.IsNullOrEmpty(Piva) OrElse String.IsNullOrEmpty(Cod_Contatto) Then
            Throw New Exception(String.Format(My.Resources.AgronicaCoreInterscambioBIZ.ChiaveGiasNonValida, Piva, Cod_Contatto))
        End If

        'non controllo che ci sia chiave doppia in quanto l'indice sul DB lo garantisce
        Dim objReadBIZ As New Interscambio_Contatti_R
        ...
        Dim Codice_Gias As String = Piva + "_" + Cod_Contatto

        'se entrambe non sono presenti nella tabella di interscambio, scrivo
        If checkExistsChiaveEsterna = False Then

            Dim objWriteDAL As New AgronicaCoreInterscambioDAL.Interscambio_Contatti_W
