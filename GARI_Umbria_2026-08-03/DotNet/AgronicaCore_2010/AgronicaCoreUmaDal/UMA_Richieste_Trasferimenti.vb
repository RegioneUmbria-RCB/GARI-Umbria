...
Public Class UMA_Richieste_Trasferimenti_R
    ...
    Public Function Leggi(ByVal piva As String,
        ...
        Dim nomeRoutine As String = "AgronicaCoreUmaDAL.UMA_Richieste_Trasferimenti_R.Leggi()"
        ...
        Try
            ...
            stb.AppendLine(" SELECT  I.rag_soc, IC.val_cod as CUAA, t.* ")
            stb.AppendLine(" , case when Tipo_Richiesta=0 then 'C/PROPRIO' else 'C/TERZI' end as Tipo_Richiesta_Des ")
            stb.AppendLine(" , case when Confermato_Tipo_Rich=0 then 'C/PROPRIO' when Confermato_Tipo_Rich =-1  then 'C/TERZI' else '' end as Confermato_Tipo_Rich_Des ")
    ...
    Public Function LeggiTotali(ByVal piva As String,
        ...
        Dim nomeRoutine As String = "AgronicaCoreUmaDAL.UMA_Richieste_Trasferimenti_R.LeggiTotali()"
        ...
        Try
            ...
            stb.AppendLine(" FROM UMA_Richieste_Trasferimenti ")
            stb.AppendLine($" WHERE Piva_SuperUser = '{Agro_SQL_SaveText(objParametri.PivaSuperUser)}' ")
...
End Class
Public Class UMA_Richieste_Trasferimenti_W

    Inherits DataProvider

    Public Function AggiungiNuovi(listLav As List(Of RichiesteTrasferimenti),
                                  objParametri As AgronicaCoreParametri) As Boolean

        Dim NomeRoutine As String = "AgronicaCoreUmaDAL.UMA_Richieste_Trasferimenti.AggiungiNuovi()"
        Dim MessaggioErrore As String = ""
        ...
        Try
            For Each l In listLav
                ...
                StrSQL.Append("INSERT INTO UMA_Richieste_Trasferimenti ( ")
                StrSQL.Append("       Piva_SuperUser                ,  ")
                StrSQL.Append("       Piva                          ,  ")
                StrSQL.Append("       Richiesta_Cod                 ,  ")
                StrSQL.Append("       Piva_Ricevente                ,  ")
                StrSQL.Append("       Tipo_Richiesta                ,  ")
                ...
                StrSQL.Append("       Confermato_Tipo_Rich          ,  ")
                ...
                StrSQL.Append("  ,       '" & Agro_SQL_SaveText(l.Piva_Ricevente) & "' ")
                StrSQL.Append("  ,       " & Agro_SQL_SaveNum(l.Tipo_Richiesta) & " ")
                ...
                StrSQL.Append("  ,       " & Agro_SQL_SaveNum(l.Confermato_Tipo_Rich) & " ")
    ...
    Public Function Aggiorna(listLav As List(Of RichiesteTrasferimenti),
                             objParametri As AgronicaCoreParametri) As Boolean

        Dim NomeRoutine As String = "AgronicaCoreUmaDAL.UMA_Richieste_Trasferimenti.Aggiorna()"
        Dim MessaggioErrore As String = ""
        Dim StrSQL As New System.Text.StringBuilder
        Dim xRisp As Boolean = False
        ...
        Try
            For Each l In listLav
                ...
                StrSQL.Append("UPDATE UMA_Richieste_Trasferimenti SET ")
                StrSQL.Append("        Piva_Ricevente           = '" & Agro_SQL_SaveText(l.Piva_Ricevente) & "' ")
                StrSQL.Append(",       Tipo_Richiesta           =  " & Agro_SQL_SaveNum(l.Tipo_Richiesta) & " ")
                ...
                StrSQL.Append(",       Confermato_Tipo_Rich     =  " & Agro_SQL_SaveNum(l.Confermato_Tipo_Rich) & " ")
                ...
                StrSQL.Append(" and    Piva_Ricevente           = '" & Agro_SQL_SaveText(l.Piva_Ricevente) & "' ")
                StrSQL.Append(" and    Tipo_Richiesta           =  " & Agro_SQL_SaveNum(l.Tipo_Richiesta) & " ")
    ...
    Public Function Azzera_Confermato(ByVal piva As String,
        ...
        Dim NomeRoutine As String = "AgronicaCoreUmaDAL.UMA_Richieste_Trasferimenti.Azzera_Confermato()"
        Dim MessaggioErrore As String = ""
        Dim StrSQL As New System.Text.StringBuilder
        Dim xRisp As Boolean = False
    ...
    Public Function Rimuovi(listLav As List(Of RichiesteTrasferimenti),
                                  objParametri As AgronicaCoreParametri) As Boolean
        Dim NomeRoutine As String = "AgronicaCoreUmaDAL.UMA_Richieste_Trasferimenti.Rimuovi()"
        Dim MessaggioErrore As String = ""
        Dim StrSQL As New System.Text.StringBuilder
        Dim xRisp As Boolean = False
        ...
        Try
            For Each l In listLav
                ...
                StrSQL.Append("DELETE FROM  UMA_Richieste_Trasferimenti ")
                StrSQL.Append(" WHERE ")
    ...
    Class RichiesteTrasferimenti
        ...
        Public Property Confermato_Tipo_Rich As Integer
