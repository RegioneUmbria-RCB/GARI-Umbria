...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="Esercizio">
    ...
    <Esercizio
     OP       = "{@lotto}"    
     specie_esercizio_codice="{@specie_esercizio_codice_aboca}"
     specie_esercizio_descr="{@specie_esercizio_descr_aboca}"
      num_op_collegamento="{@num_op_collegamento}"
  ...
  <xsl:template match="Impianto">        
    ...
    <Impianto
     progetto= "{@cod_impianto}"
     specie   = "{@descrizione_specie_gias}"   
     varieta   = "{@descrizione_varieta_gias}"
     destinazione_uso="{@descrizione_destuso_gias}"
  ...
  <xsl:template match="Appezzamento">
    ...
    <Appezzamento
      ...
      codice_appezzamento_aboca="{@rif_qdc_app}"
