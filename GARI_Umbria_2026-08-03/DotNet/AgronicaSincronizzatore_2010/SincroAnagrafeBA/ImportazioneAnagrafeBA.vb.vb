...
#Region "Importazione"
    ...
    '    Dim ws_AnaColdi As New SincroAnagrafeBA.SSAWS_SSAHttpService(SSAWS_Uri)


    '    Dim ws_AnaResponse As SincroAnagrafeBA.cercaAnagraficaResponse
    '    Dim gA As New SincroAnagrafeBA.cercaAnagrafica
    ...
    '    ContractDescription = System.ServiceModel.Description.ContractDescription.GetContract(GetType(SincroAnagrafeBA.NsFascicolo.IFascicolo), GetType(SincroAnagrafeBA.NsFascicolo.Fascicolo))
    ...
    '    'Dim ws_FascicoloColdi As New SincroAnagrafeBA.NsFascicolo.FascicoloClient(Endpoint)
    '    'Dim ws_fasciResponse As SincroAnagrafeBA.NsFascicolo.getFascicoloResponse
    '    'Dim gF As New SincroAnagrafeBA.NsFascicolo.getFascicolo

    '    Dim ws_FascicoloColdi As New SincroAnagrafeBA.FascicoloWS_FascicoloHttpService(FascicoloWS_Uri)
    '    Dim ws_fasciResponse As SincroAnagrafeBA.getFascicoloNewResponse
    '    Dim gF As New SincroAnagrafeBA.getFascicoloNew

    '    Dim gS As New SincroAnagrafeBA.getSchedeFascicolo
    '    Dim Schede() As SincroAnagrafeBA.SchedaValidazione

    '    Dim NomeRoutine As String = "Cerca Anagrafica"
    '    Dim MsgOK As String = ""

    '    gA.in = New SincroAnagrafeBA.MsgGetAnagrafica
    '    gA.in.intestazione = New SincroAnagrafeBA.Intestazione
    '    gA.in.intestazione.operatore = New SincroAnagrafeBA.Operatore
    ...
    '    'gF.filtro = SincroAnagrafeBA.NsFascicolo.FiltroGetFascicolo.all
    ...
    Private Function _3_CaricaDati_WS_BA(ByVal PIVA As String, _
        ...
        Dim gS As New SincroAnagrafeBA.getSchedeFascicolo
        'Dim Schede() As SincroAnagrafeBA.SchedaValidazione
        Dim ws_SchedeResponse As SincroAnagrafeBA.getSchedeFascicoloResponse
                                        ...
                                        If ws_fasciResponse IsNot Nothing AndAlso _
                                            ...
                                            If ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1.Length > 0 Then
                                                ...
                                                For i = 0 To ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1.Length - 1
                                                    ...
                                                    Prov = If(IsNothing(ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Provincia.Trim), "", ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Provincia.Trim)
                                                    Com = If(IsNothing(ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Comune.Trim), "", ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Comune.Trim)
                                                    Sezione = If(IsNothing(ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Sezione.Trim), "", ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Sezione.Trim)
                                                    Foglio = If(IsNothing(ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Foglio.Trim), 0, ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Foglio.Trim)
                                                    strNumero = If(IsNothing(ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Particella.Trim), 0, ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Particella.Trim)
                                                    Subalterno = If(IsNothing(ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Subalterno.Trim), "", ws_fasciResponse.out.fascicolo.fascicolo.ISWSTerritorio1(i).Subalterno.Trim)
    ...
    Private Sub _5_Crea_Stringa_Catasto(ByVal PIVA As String, _
        ...
        For i = 0 To DtParticelle.Rows.Count - 1
            ...
            ' non precarico tutto perchè dopo l'aggiunta del veneto i record sono più di 150.000
    ...
    Private Function _8_Ribalta_Pianificazione(ByVal Programmazione_Cod As Integer, _
        ...
        Try
            ...
            If Ribalta_Limiti Then
                ...
                DtPE = objPE.LeggiParticelle_Da_Programmazione("", 0, Programmazione_Cod, 0, AgronicaCoreDataProvider.AgronicaCoreParametri.enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", ObjParametri_Server)
            End If
...
#Region "Util"
    ...
    Private Sub SerializeObject(ByVal filename As String, ByVal ws_fasciResponse As SincroAnagrafeBA.getFascicoloNewResponse)
        Console.WriteLine("Writing With Stream")

        Dim serializer As New XmlSerializer(GetType(SincroAnagrafeBA.getFascicoloNewResponse))
