...
#Region "Funzioni"
    ...
    '#############################################
    Public Sub Inserisci_DT_Particelle(ByRef DT As DataTable,
                                           ByVal Flag_Presente As String,
                                           ...
                                           ByVal Prov As String,
                                            ...
                                            ByVal SupCatastale As String,
                                            ByVal SupCatastaleNEW As String,
                                            ByVal Possesso As String,
                                            ByVal PossessoNEW As String,
                                            ByVal SupCondotta As String,
                                            ByVal SupCondottaNEW As String,
                                            ByVal Macrouso As String,
                                            ByVal MacrousoNEW As String,
                                            ByVal SupMacrouso As String,
                                            ByVal SupMacrousoNEW As String,
                                            ByVal Zona As String,
                                            ByVal ZonaNEW As String,
                                            ByVal Utilizzi As String,
    ...
    Public Sub Genera_Log_Catasto(ByRef objParametri_Server As AgronicaCoreParametri,
                                  ByRef LogCatasto As StringBuilder,
                                  ByRef DT As DataTable,
                                  ByVal ListParticelle As List(Of cls_ParticellaVerifica),
        ...
        If Not IsNothing(ListParticelle) AndAlso ListParticelle.Count > 0 Then
            ...
            DT_ImpPart = objImpPart.Leggi3(0,
                                              Piva,
                                              0,
                                              0,
                                              "",
                                              ...
                                              "",
                                               "",
                                               " ImpresexParticelle.Piva, ImpresexParticelle.Sa_Cod, ImpresexParticelle.Validita_Inizio, ImpresexParticelle.Validita_Fine",
                                                objParametri_Server)

            DT_Macrousi = objMacrousi.Leggi(Piva,
                                            "",
                                            "",
                                            "",
                                            0,
                                            ...
                                            "",
                                            " Prov, Com, Sezione, Foglio, Numero, Subalterno, Macrouso_Des",
                                            objParametri_Server)

            DT_Zone = objZone.Leggi(0,
                                    "",
                                    "",
                                    "",
                                    0,
                                    ...
                                    enumSelezioneVariabile.Selezione_JoinDescrizioni,
                                    "",
                                    " ParticelleCatastali.Prov, ParticelleCatastali.Com, ParticelleCatastali.Sezione, ParticelleCatastali.Foglio, ParticelleCatastali.Numero, ParticelleCatastali.Subalterno, Descrizione ",
                                    objParametri_Server)


            DT_Utilizzi = objUtilizzi.Leggi(Piva,
                                            "",
                                            "",
                                            "",
                                            0,
                                            ...
                                            enumSelezioneVariabile.Selezione_JoinDescrizioni,
                                            "",
                                            " Prov, Com, Sezione, Foglio, Numero, Subalterno, Macrouso_Cod, Veg_Des_Agea, Cul_Des_Agea ",
                                            objParametri_Server)
            ...
            For i = 0 To ListParticelle.Count - 1
                ...
                If Not IsNothing(objParticella) Then
                    ...
                    objIstat.ComuneProvinciaSigla_from_codISTAT(objParticella.Prov,
                                                            objParticella.Com,
                                                            sigla_prov,
                                                            pro_des,
                                                            com_des,
                    ...
                    DrImpPart = DT_ImpPart.Select(" Prov = '" & objParticella.Prov & "'" &
                                                  " AND Com = '" & objParticella.Com & "'" &
                                                  " AND Sezione = '" & objParticella.Sezione & "'" &
                                                  " AND Foglio = " & objParticella.Foglio & "" &
                                                  " AND Numero = " & objParticella.Numero & "" &
                    ...
                    If Not IsNothing(DrImpPart) AndAlso DrImpPart.Length > 0 Then
                        ...
                        For j = 0 To DrImpPart.Length - 1
                            ...
                            With DrImpPart(j)
                                ...
                                SupCatastale = UtilityProvider.Ettari_from_EttariAreCentiare(.Item("Ettari"), .Item("Are"), .Item("Centiare"))

                                If SupCatastale <> objParticella.SupCatastale Then
                                    flag_modifica = True
                                End If

                                If Sa_Cod_Temp = 0 OrElse Sa_Cod_Temp <> .Item("sa_cod") Then
                                    'primo giro o cambio centro
                                    sa_nome &= .Item("sa_nome") & " "
                                    Sa_Cod_Temp = .Item("sa_cod")
                                End If

                                If (Inizio_Temp = CDate("12/12/1902") AndAlso Fine_Temp = CDate("12/12/1903")) OrElse
                                    (Inizio_Temp <> .Item("Validita_Inizio") AndAlso Fine_Temp <> .Item("Validita_Fine")) Then
                                               ...
                                               True,
                                                 ...
                                                 sa_nome,
                                                  ...
                                                  com_des,
                                                    objParticella.Prov,
                                                    objParticella.Com,
                                                    objParticella.Sezione,
                                                    objParticella.Foglio,
                                                    objParticella.Numero,
                                                    objParticella.Subalterno,
                                                    SupCatastale,
                                                   objParticella.SupCatastale,
                                                   Possesso,
                                                   objParticella.TitoloDatePossesso,
                                                   0,
                                                   objParticella.SupCondotta,
                                                    "",
                                                   objParticella.Macrouso,
                                                   "",
                                                   objParticella.SupMacrouso,
                                                  "",
                                                   objParticella.Zona,
                                                 "",
...
Public Class cls_SincronizzatoreCatasto
    ...
    '#####################################################################################################
    Public Sub Gestione_Sincronizzazione_Anagrafica(ByRef objParametri_Server As AgronicaCoreParametri,
                                                    ...
                                                    allegatiDocumentiXML As String)
    ...
    Public Sub Gestione_Sincronizzazione_Catasto(
                                                    ByVal TipoImport As enum_TipoImportazioneAnagrafe,
                                                    ByRef objParametri_Server As AgronicaCoreParametri,
                                                    ByRef XmlDoc As XmlDocument,
                                                    ByRef XMLImpresa As XmlElement,
                                                    ByRef XMLCentro As XmlElement,
                                                    ByRef Str_Particelle As StringBuilder,
                                                    ByRef Str_ParticelleEsistenti As StringBuilder,
                                                    ByRef Str_ParticelleMancanti As StringBuilder,
                                                    ByRef Str_ParticelleUtilizzi As StringBuilder,
                                                    ByRef Str_ParticelleZone As StringBuilder,
                                                    ByRef Str_ParticelleMacrousi As StringBuilder,
                                                    ByRef num_ParticelleEsistenti As Integer,
                                                    ByRef num_ParticelleMancanti As Integer,
                                                    ByRef HT_ZoneXPart As Hashtable,
                                                    ByRef HT_MacrousiXPart As Hashtable,
                                                    ByRef HT_CodificaZoneMancanti As Hashtable,
                                                    ByVal TipoOperazione As enum_TipoOperazioneDB,
                                                    ByVal CodiceChiaveCliente As Integer,
                                                    ByVal ValCod_CodiceChiaveCliente As String,
                                                    ...
                                                    ByVal Numero As String,
                                                    ByVal Subalterno As String,
                                                    ByVal SupCatastale As Double,
                                                    ByVal TitoloPossesso As Integer,
                                                    ByVal supConduzione As Double,
                                                    ByVal PossessoInizio As Date,
                                                    ByVal PossessoFine As Date,
                                                    ByVal Vet_CodZona() As String,
                                                    ByVal ListaMacrouso As List(Of MacrousoObject),
                                                    ByVal objXML As AgronicaCoreXML.AnagrafeXML,
                                                    ByVal objImpresexParticelle As AgronicaCoreAnagrafeDAL.ImpresexParticelle2_R,
                                                    ByVal objCentri As AgronicaCoreAnagrafeDAL.CentriAziendali_Read,
                                                    ByVal objCodifica As AgronicaCoreAnagrafeDAL.CAC_Codifica_Zone,
                                                    ByVal objZonexParticelle As AgronicaCoreAnagrafeDAL.ZonexParticelle_R,
                                                    ByVal objMacrousixParticelle As AgronicaCoreAnagrafeDAL.ParticelleCatastalixMacrousi_R,
                                                    ByVal objPartxMacrousixUtilizzi As AgronicaCoreAnagrafeDAL.ParticelleCatastalixMacrousixUtilizzo_R,
        ...
        Dim XmlParticella_MetodoProduzione As XmlElement
        ...
        Dim objCodificheAgrea As New AgronicaCoreMetaSchemaDAL.Codifica_SpecieVegetali_Agrea_R
        Dim Specie_Cod_Utilizzo As String
        Dim Varieta_Cod_Utilizzo As String
        ...
        'Dim objParticelleCatastali_MetodoProduzione As New AgronicaCoreAnagrafeDAL.ParticelleCatastali_MetodoProduzione_R
        ...
        Try
            ...
            If IsNothing(Sezione) OrElse Sezione = "" Then
                strSezione = "0"
            Else
                strSezione = Sezione
            End If

            If IsNothing(Subalterno) OrElse Subalterno = "" OrElse Subalterno = "000" Then
                strSubalterno = "0"
            Else
            ...
            '    'qui non ci entra più, poiché non ricavo più SaCodByIdAziendaFascicolo 
            ...
            '    'controllo che sia diverso da 0 perché la query fa il where secco sul sa_cod (senza controllo <>0)
            ...
            If TipoOperazione = enum_TipoOperazioneDB.Modifica Then
                ...
                Else
                    ...
                    ''non cerco le particelle attive alla data di oggi, perché magari alcune sono chiuse e le devo estendere
                    ...
                    DT_SaCod = objImpresexParticelle.DistinctCentri_Particella(
                                                        Piva,
                                                        0,
                                                        PROV,
                                                        COM,
                    ...
                    If Not IsNothing(DT_SaCod) AndAlso DT_SaCod.Rows.Count > 0 Then
                        ...
                        Sup_Catastale_OLD = UtilityProvider.Ettari_from_EttariAreCentiare(
                    ...
                    Else
                        ...
                        ''perché devo battezzare un centro in cui salvare la particella
            ...
            If TipoOperazione_Particella = enum_TipoOperazioneDB.Scrittura AndAlso
            ...
            If Flag_Scrivi_Particelle Then
                ...
                For z = 0 To vet_SaCod.Length - 1
                    ...
                    If TipoOperazione = enum_TipoOperazioneDB.Modifica Then
                        ...
                        If sacod <> 0 Then
                            ...
                            Dt_Centri = objCentri.Leggi(Piva, sacod,
                                                        enumSelezioneVariabile.Selezione_JoinDescrizioni,
                                                        "", "",
                                                        objParametri_Server)
                        ...
                        Else
                            'il sa_cod è 0 perché l'impresa non è presente in archivio
                            ...
                            Dt_Centri = objImpresexParticelle.LeggiJoinCentriIndirizzi(
                                                                0,
                                                                Piva,
                                                                0,
                                                                0,
                        ...
                        Else
                            ...
                            If TipoOperazione = enum_TipoOperazioneDB.Modifica AndAlso sacod = 0 Then
                            ...
                            Else
                                ...
                                XMLCentro = objXML.Xml_Pubblico_CentroAziendale(enum_TipoOperazioneDB.Lettura,
                                                                   sacod,
                                                                   sa_nome,
                                                                   Titolo_Possesso,
                                                                   sup_bosco, sup_prati,
                    ...
                    'Dim DTMetodo = objParticelleCatastali_MetodoProduzione.Leggi(PROV, COM, Sezione, Foglio, Numero, Subalterno, -1, AGRODATAINIZIO, AGRODATAFINE, enumSelezioneVariabile.Selezione_TabellaCompleta, "", "", objParametri_Server)

                    'If (DTMetodo.Rows.Count > 0) AndAlso DTMetodo.Rows(0)("MetodoProduzione_Cod") = 1 Then

                    'End If

                    XmlParticella_MetodoProduzione = objXML.Xml_Pubblico_Particella_MetodoProduzione(TipoOperazione_Particella,
                                                                                                     "0",
                                                                                                     COM,
                                                                                                     PROV,
                                                                                                     strSezione,
                    ...
                    XmlParticella.AppendChild(XmlParticella_MetodoProduzione)

                    XMLCentro.AppendChild(XmlParticella)

                    If TipoOperazione_Particella = enum_TipoOperazioneDB.Modifica AndAlso
                    ...
                    If Not IsNothing(Vet_CodZona) AndAlso Vet_CodZona.Length > 0 Then
                        ...
                        For j = 0 To Vet_CodZona.Length - 1
                            ...
                            CodiceZonaGIAS = objCodifica.ConvertiZona(Cod_Zona_Origine,
                                                                      "", objParametri_Server)
                            If CodiceZonaGIAS <> 0 Then

                                chiave_zonexpart = PROV & "|" &
                                                  COM & "|" &
                                                  strSezione & "|" &
                                                  Foglio & "|" &
                                                  Numero & "|" &
                                ...
                                If Not HT_ZoneXPart.Contains(chiave_zonexpart) Then
                                    ...
                                    If TipoOperazione_Particella = enum_TipoOperazioneDB.Modifica Then
                                        bEsisteZona = False
                                        bEsisteZona = objZonexParticelle.Esiste_ZonaxParticella(PROV,
                                                                                              COM,
                                                                                              strSezione,
                                                                                              Foglio,
                                                                                              Numero,
                                    ...
                                    XmlZona = objXML.Xml_Pubblico_Zona(TipoOpZonaxParticella,
                                                                       CodiceZonaGIAS.ToString,
                                                                       "0",
                                                                       XmlDoc)
                    ...
                    If Not IsNothing(ListaMacrouso) AndAlso ListaMacrouso.Count > 0 Then
                        ...
                        For j = 0 To ListaMacrouso.Count - 1
                            ...
                            If Not IsNothing(Macrouso) Then
                                ...
                                If CodiceMacrousoGIAS <> "" AndAlso CodiceMacrousoGIAS <> "0" Then

                                    chiave_macrousoxpart = PROV & "|" &
                                                            COM & "|" &
                                                            strSezione & "|" &
                                                            Foglio & "|" &
                                                            Numero & "|" &
                                    ...
                                    If Not HT_MacrousiXPart.Contains(chiave_macrousoxpart) Then
                                        ...
                                        If TipoOperazione_Particella = enum_TipoOperazioneDB.Modifica Then
                                            ...
                                            bEsisteMacrouso = objMacrousixParticelle.Esiste_ParticelleCatastalixMacrousi(Piva,
                                                                                                                         PROV,
                                                                                                                         COM,
                                                                                                                         strSezione,
                                                                                                                         Foglio,
                                        ...
                                        XmlMacrouso = objXML.Xml_Pubblico_Macrouso(TipoOpMacrousixParticella,
                                                                                   Piva,
                                                                                   CodiceMacrousoGIAS.ToString,
                                                                                   SupMacrouso.ToString,
                                        ...
                                        If Not IsNothing(Macrouso.Utilizzo) AndAlso Macrouso.Utilizzo.Count > 0 Then
                                            ...
                                            For y = 0 To Macrouso.Utilizzo.Count - 1
                                                ...
                                                objCodificheAgrea.Specie_e_Varieta_AGEA_Da_Agrea(LogCodificheMancantiSpecie,
                                                                                                 LogCodificheMancantiVarieta,
                                                                                                 Macrouso.Utilizzo(y).SpecieCod,
                                                                                                 Macrouso.Utilizzo(y).VarietaCod,
                                                                                                 Specie_Cod_Utilizzo,
                                                                                                 Varieta_Cod_Utilizzo,
                                                                                                 specie_Des_Agea,
                                                                                                 Varieta_Des_Agea, "", "", objParametri_Server)

                                                'Specie_Cod_Utilizzo = Macrouso.Utilizzo(y).SpecieCod
                                                'Varieta_Cod_Utilizzo = Macrouso.Utilizzo(y).VarietaCod
                                                ...
                                                If TipoOpMacrousixParticella = enum_TipoOperazioneDB.Modifica Then
                                                    ...
                                                    EsisteMacrousoxUtil = objPartxMacrousixUtilizzi.Esiste_PartxMacrousoxUtilizzo(
                                                                                                                Piva,
                                                                                                                PROV,
                                                                                                                COM,
                                                                                                                strSezione,
                                                ...
                                                If EsisteMacrousoxUtil Then
                                                    TipoOp_PartxMacrousoxUtil = enum_TipoOperazioneDB.Modifica
                                                End If

                                                XmlUtilizzo = objXML.Xml_Pubblico_Utilizzo(TipoOp_PartxMacrousoxUtil,
                                                                                           Piva,
                                                                                           Specie_Cod_Utilizzo.ToString,
                                                                                           Varieta_Cod_Utilizzo.ToString,
                                                                                           Format(Utilizzo_Sup, "0.0000"),
                                                                                           #1/1/1900#, #12/31/2100#, "#", XmlDoc)
