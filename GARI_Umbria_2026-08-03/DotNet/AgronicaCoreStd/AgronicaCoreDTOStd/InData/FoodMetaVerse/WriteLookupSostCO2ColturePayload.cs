...
{
    public class WriteLookupSostCO2ColturePayload
    {
        /// <summary>FK a Lookup_Sost_CO2_Colture_Chiavi.id_invocazione (anche PK di questa tabella)</summary>
        ...
        public WriteLookupSostCO2ColturePayload() { }

        public WriteLookupSostCO2ColturePayload(string idInvocazione, string jsonRichiesta, string jsonRisposta)
        {
