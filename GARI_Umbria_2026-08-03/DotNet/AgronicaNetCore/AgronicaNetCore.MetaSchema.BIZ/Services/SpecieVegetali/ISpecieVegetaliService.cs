...
namespace AgronicaNetCore.MetaSchema.BIZ.Services.SpecieVegetali
{
    ...
    {
        Task<DtConVisibilita_OUT> SpecieVegetali_GestioneFiltroUtente_LeggiAsync(LeggiSpecieVegetali_IN leggiSpecie_IN, AgronicaCoreParametriUtenti objParametriUtenti, AgronicaCoreParametriServer objParametriServer);

        Task<DataTable> Cultivar_GestioneFiltroUtente_LeggiAsync(Cultivar_GestioneFiltroUtente_Leggi_IN leggiCultivar_IN, AgronicaCoreParametriUtenti objParametriUtenti, AgronicaCoreParametriServer objParametriServer);
        ...
        Task<DataTable> LeggiVarietaFilteredAsync(string piva, int culCod, int vegCod, AgronicaCoreParametriServer objParametriServer);
    }
}
