...
namespace AgronicaNetCore.MeteoSuite.BIZ.Services.DatiMeteo.Acquisizione
{
    ...
    /// </summary>
    public interface IValidazioneDatiMeteoService
    {
        /// <summary>
        ...
        ValidazioneDatiMeteoResult ValidateMeteoRainDataH(MeteoRainDataH meteoData);
        ...
        /// </returns>
        string DetermineOverallRainDataStatus(List<MeteoRainDataH> dataPoints, List<ValidazioneDatiMeteoResult> validationResults);
    }
}
