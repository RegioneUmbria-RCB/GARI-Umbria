...
{
    public class MisureIndiciMaturitaPersonalizzateApp : BaseServiceAppBIZ, ILetturaTabellaComuneApp
    {
        private readonly ILoggingService _loggingService;
        private readonly IndiciMaturitaApp _core;

        public MisureIndiciMaturitaPersonalizzateApp(
        ...
        {
            var (_, misure, _) = await _core.GetOrFetchAsync(true, parameters);
            return misure;
        }
    }
}
