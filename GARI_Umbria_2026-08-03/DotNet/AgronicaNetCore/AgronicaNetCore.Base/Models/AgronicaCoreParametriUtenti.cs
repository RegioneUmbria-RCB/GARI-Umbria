...
{
    public class AgronicaCoreParametriUtenti : AgronicaCoreParametri
    {
        public AgronicaCoreParametriUtenti() : base() { }

        public AgronicaCoreParametriUtenti(string pivaSuperUser, string usernameOperazione, string utenteUsername, string utenteCodFiscale, string superUserUsername,
