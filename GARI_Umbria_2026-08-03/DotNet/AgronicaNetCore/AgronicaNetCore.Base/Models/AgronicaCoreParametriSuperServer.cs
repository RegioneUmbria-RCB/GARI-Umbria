...
{
    public class AgronicaCoreParametriSuperServer : AgronicaCoreParametri
    {
        public AgronicaCoreParametriSuperServer() : base() { }

        public AgronicaCoreParametriSuperServer(string pivaSuperUser, string usernameOperazione, string utenteUsername, string utenteCodFiscale, string superUserUsername,
