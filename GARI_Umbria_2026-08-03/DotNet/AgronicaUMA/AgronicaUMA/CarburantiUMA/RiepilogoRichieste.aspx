<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/UmaBootstrap.Master" CodeBehind="RiepilogoRichieste.aspx.vb" 
    Inherits="AgronicaUMA.RiepilogoRichieste" %>
                                ...
                                <div class="panel-group elencoRichieste" style="display: none;">
                                    <div class="row" id="legendaFisso">
                                        <div class="col-lg-12" style="padding-bottom: 15px">
                                            <h5>I litri carburante richiesti sono già stati decurtati a norma di legge</h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div style="overflow: auto; margin-top: 10px; margin-bottom: 70px;">
                                            <div id="tab_griglia_riepilogoRichieste"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentScript" runat="server">
    ...
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("RiepilogoRichieste_globali.js") %>" ></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("RiepilogoRichieste.js") %>" ></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("RiepilogoRichieste_jQueryDocReady.js") %>" ></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("RiepilogoRichieste_ws_client.js") %>" ></script>
