...
Type.registerNamespace("AgronicaControlli_2010");

AgronicaControlli_2010.ClientControl1 = function(element) {
    AgronicaControlli_2010.ClientControl1.initializeBase(this, [element]);
}

AgronicaControlli_2010.ClientControl1.prototype = {
    initialize: function() {
        AgronicaControlli_2010.ClientControl1.callBaseMethod(this, 'initialize');
        
        // Aggiungere qui l'inizializzazione personalizzata
    },
    dispose: function() {        
        //Aggiungere qui le azioni di eliminazione personalizzate
        AgronicaControlli_2010.ClientControl1.callBaseMethod(this, 'dispose');
    }
}
AgronicaControlli_2010.ClientControl1.registerClass('AgronicaControlli_2010.ClientControl1', Sys.UI.Control);
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFPZ1Ay4bA1GF
// SIG // 0qKczqv8FxorF+LaoIISMTCCBGAwggNMoAMCAQICCi6r
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSFFWNNWO2k
// SIG // jGdfwUaea2D4lC1t1zBOBgorBgEEAYI3AgEMMUAwPqAk
// SIG // gCIAQwBsAGkAZQBuAHQAQwBvAG4AdAByAG8AbAAxAC4A
// SIG // agBzoRaAFGh0dHA6Ly9taWNyb3NvZnQuY29tMA0GCSqG
// SIG // SIb3DQEBAQUABIIBAE24bDlh5oHxpW7K0CCXGtgdH+mk
// SIG // cKHRkg3S0o2Jbd2ALiwuEgXCQVO/Hru8fQz9IrEVjYE1
// SIG // Qh8gVTNe5kefJumtkKlraGWOEDL3qvUZ7Ww7qgz5QN2R
// SIG // On4E344hXW256VrVkmdwTbUyzlVGPLG/y2IiFRlUGK3m
// SIG // n65I9zwIJDAwnzaUZcjImaDHp6s+kgMTUi8eADT+EYRS
// SIG // sY88k6CHi8BPCbTzFRtHMbNCN9LXqPBKKw7/mZmsS5P6
// SIG // EKwxcsfThNF/fvX8AGMlldgvw7WPKoYWUuEXpL/QIxkQ
// SIG // 8arnevYaqkAAfJUR6h13h6pMFmOKcSDHXseo05lfXmjK
// SIG // RxMxsfuhggIfMIICGwYJKoZIhvcNAQkGMYICDDCCAggC
...
// SIG // CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xMDA0
// SIG // MjIxMjI5NTVaMCMGCSqGSIb3DQEJBDEWBBRl5AvZtXSP
// SIG // m2CHH8CKdEc5QOTZwTANBgkqhkiG9w0BAQUFAASCAQCV
// SIG // Qe1k3G423QrOQCCmeG5nIIuCN+YhylKlFIoBYNlTFC7Z
// SIG // 9Qi8ndY2HdOggHHTkA3GzQfQRzAPuSiiQ6LcvX3zJk2H
// SIG // 7ePDKNRsb2HanKp8dh0Mt8MdBsJaCW4251nJ7i5RHFcE
// SIG // jQTCnP+b49iIOKOkyRS2CYgIqTajYrvQBpwduPmt694Y
// SIG // noGpndUAF3fdAMIqW46SaPSsBBHCx1KpitEdINb+IgmM
// SIG // sBC6qcEGTuc3TkL+eqNIR1nOwvcCRfTVyIi1+fuTUhpi
// SIG // jUX61ru3dPGW7SwDhsL9d2WkufO44lSmEv3aZv6jpw+o
// SIG // +k3GyTXs8VJV18bpc/pnHQIUYVIOV8W9
// SIG // End signature block

//Funzione per Renderizzare il nodo
function GetNameofPage() {
    var pa = new String(window.location.pathname);
    var p2 = pa.split('/');
