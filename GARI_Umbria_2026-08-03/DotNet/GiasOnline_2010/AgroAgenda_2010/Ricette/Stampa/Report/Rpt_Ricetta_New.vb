...
Public Class Rpt_Ricetta_New
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgroAgenda_2010.Rpt_Ricetta_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Ricetta_New
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Ricetta_New = New Rpt_Ricetta_New()
        rpt.Site = Me.Site
        Return rpt
    End Function
