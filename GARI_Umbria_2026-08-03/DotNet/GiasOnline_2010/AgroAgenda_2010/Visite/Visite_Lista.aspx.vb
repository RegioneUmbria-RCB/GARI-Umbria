...
Public Class Visite_Lista
    Inherits System.Web.UI.Page

    Public SincroDatiApp As Boolean = False
    Public CaricaDatiApp As Boolean = True
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim impostazione = Leggi_impostazioni.ImpostazioneValore1_from_ImpostazioneCod(enum_Impostazioni_Utenti.SUPERUSER_GiasAPP_VISITE, objParametri_Utenti, 2)
        Dim permesso = objPermessi.Controlla_Permessi_Utente(objParametri_Utenti.UtenteUsername, enum_Id_Servizio.GiasOnline, enum_Security_Attivita.GiasAPP_VISITE, enum_Security_Operazione.Lettura, Date.Now, "", objParametri_Utenti)
        hf_AbilitazioneVisiteAPP.Value = If(permesso, "1", impostazione)
        ...
        If Not CaricaDatiApp Then
            hf_AbilitazioneVisiteAPP.Value = "0"
        End If
    ...
    Public Shared Function nuova_operazione() As AgronicaCoreVarieBIZ.RispostaStandard
        ...
        Dim TargetUrl As String = ottieniLinkNuovaOperazione()
        r.RispostaOK = True
    ...
    Public Shared Function ottieniLinkNuovaOperazione() As String
        Dim objParametriAgenda As New AgronicaCoreModello.ParametriAgenda_Temp.ParametriAgenda
    ...
    Public Shared Function infomodifica_operazione_singola(ByVal type As Integer, ByVal id_agenda As String, ByVal piva As String, ByVal lav_cod As String) As AgronicaCoreVarieBIZ.RispostaStandard
        ...
        Dim OpUtil As New AgronicaCoreModello.Utility_Operazioni
        Dim TargetUrl As String = OpUtil.LinkPagina_from_LavCod_NEW(lav_cod, objParametriAgenda, PaginaSitoAgendaOrigine:=enum_PagineAgenda_2010.Pagina_Visite_Lista, fromBootstrapToBootstrap:=True)
