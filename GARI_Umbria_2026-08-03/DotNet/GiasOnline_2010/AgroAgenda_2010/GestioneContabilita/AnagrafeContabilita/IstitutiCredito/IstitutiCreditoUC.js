function PopolaIstitutiCredito(IDControllo) {

    var funzioniCRUD = {
        funzioneRead: Leggi_IstitutiCredito,
        funzioneSubmit: { funzione: SubmitIstitutiCredito },
    ...
    var campiKendoModel = {
        ...
        Istituto_Des: { editable: true, type: "string", defaultValue: "" },
    ...
    var colonneKendoGrid = [
        {
            field: "Istituto_Des", title: TraduzioneMultiResx(resxObj, "Descrizione", "Descrizione"), filterable: { multi: true, search: true }
        }
    ];
