...
function popolaParamEntrata(IDControllo) {
    ...
    var colonneKendoGrid = [
        {
            field: "Veg_Des", title: TraduzioneMultiResx(resxObj, "Specie", "Specie"), editor: Specie_DropDownEditor, filterable: { multi: true, search: true }
        },
        {
            field: "Cul_Des", title: TraduzioneMultiResx(resxObj, "Varietà", "Varietà"), editor: val_codDropDownEditor, filterable: { multi: true, search: true }
        },
        {
            field: "Regolamento_Des", title: TraduzioneMultiResx(resxObj, "Regolamento", "Regolamento"), editor: Regolamento_CodDropDownEditor, filterable: { multi: true, search: true }
        },
        {
            field: "FormulaFissaLiquidazione_Des", title: TraduzioneMultiResx(resxObj, "FormulaDaApplicareInLiquidazione", "Formula da applicare in liquidazione"), editor: FormulaLiq_DropDownEditor, filterable: { multi: true, search: true }
        },
        {
            field: "Riferimento_Prezzi_Des", title: TraduzioneMultiResx(resxObj, "RiferimentoPrezzo", "Riferimento Prezzo"), editor: RifPrezzo_codDropDownEditor, filterable: { multi: true, search: true }
        },
        {
            field: "Percentuale_Degrado", title: TraduzioneMultiResx(resxObj, "PercentualeDegrado", "% Degrado"), format: "{0:n}", attributes: {
...
function Specie_DropDownEditor(container, options) {
    ...
    creaDropDownEditor(container, "Veg_Des", "Veg_Cod", elencoSpecie, changeParamSpecie);
}

function changeParamSpecie(e) {
...
function val_codDropDownEditor(container, options) {
    var elencoVarieta = RicercaVarieta(piva, options.model.Veg_Cod);
    creaDropDownEditor(container, "Cul_Des", "Cul_Cod", elencoVarieta, changeParamVarieta);
}
...
function RifPrezzo_codDropDownEditor(container, options) {
    ...
    creaDropDownEditor(container, "Riferimento_Prezzi_Des", "Riferimento_Prezzi_Cod", ElencoRiferimentoPrezzi, changeParamRifPrezzo);  
}

function changeParamVarieta(e)
{
    var dataItem = e.sender.dataItem();
    var grid = $("#tab_parametri_specie_varieta").data("kendoGrid");
    var model = grid.dataItem(this.element.closest("tr"));
...
function changeParamRifPrezzo(e) {
    var dataItem = e.sender.dataItem();
    var grid = $("#tab_parametri_specie_varieta").data("kendoGrid");
    var model = grid.dataItem(this.element.closest("tr"));
...
function FormulaLiq_DropDownEditor(container, options) {
    ...
    creaDropDownEditor(container, "FormulaFissaLiquidazione_Des", "FormulaFissaLiquidazione_Cod", formulaLiq, changeParamFormulaLiq); 
}

function changeParamFormulaLiq(e) {
    var dataItem = e.sender.dataItem();
    var grid = $("#tab_parametri_specie_varieta").data("kendoGrid");
    var model = grid.dataItem(this.element.closest("tr"));
...
function Regolamento_CodDropDownEditor(container, options) {
    ...
    creaDropDownEditor(container, "Regolamento_Des", "Regolamento_Cod", ElencoRegolamento, changeParamRegolamento); 
}

function changeParamRegolamento(e) {
    var dataItem = e.sender.dataItem();
    var grid = $("#tab_parametri_specie_varieta").data("kendoGrid");
    var model = grid.dataItem(this.element.closest("tr"));
