...
Public Class GestioneCelleUC
    ...
    Friend Shared Function LeggiReparti(ByVal piva As String) As RispostaStandard
        ...
        Try
            ...
            Dim DT As DataTable = objReparti.LeggiReparti(piva, objParametri_Server)
    ...
    Friend Shared Function Leggi_Celle(ByVal piva As String) As RispostaStandard
        Dim r As New RispostaStandard
        ...
        Try
            Dim objCelle As New AgronicaCoreAnagrafeDAL.Cantina_Vasche_R
            Dim DT As DataTable = objCelle.Leggi_Celle(piva, 0, "", "", objParametri_Server)
            DT.Columns.Add("IdParam", GetType(String))

            For Each row As DataRow In DT.Rows
                row("IdParam") = row("PIVA") & "_" & row("Sa_Cod") & "_" & row("Piano_Cod") & "_" & row("Vas_Cod")
            Next
    ...
    Friend Shared Function AggiornaDaGrigliaCelle(ByVal piva As String,
        ...
        Try
            Dim objReparti As New AgronicaCoreAnagrafeDAL.Cantina_Insiemi_W
