...
Public Class ParametriQualitativiUC
    ...
    Friend Shared Function Leggi_ParametriQualitativi(piva As String) As RispostaStandard
        ...
        Try
            ...
            DT = objOModuli_Referenze_Config_Dettagli.LeggiParametriQualitativi(piva, objParametri_Server, " Tipo <> 2")

            DT.Columns("Tipo").ColumnName = "Tipo_Cod"
            DT.Columns.Add("IdParam", GetType(String))
            DT.Columns.Add("Tipo_Des", GetType(String))
            ...
            Dim attivaMinMax As Integer() = {3, 4} ' attivazione per Tipo: 3 => Numero; 4 => Caratteri
            Dim attivaDecimali As Integer() = {3} ' attivazione per Tipo: 3 => Numero
            For Each row As DataRow In DT.Rows
                row("IdParam") = row("piva") & "_" & row("Tabella_Cod") & "_" & row("Modulo_Generazione")
    ...
    Friend Shared Function AggiornaDaGrigliaParametriQualitativi(ByVal piva As String, ByVal righeInserite As String, ByVal righeModificate As String, ByVal righeCancellate As String, ByVal tutteleRighe As String) As RispostaStandard
        ...
        Try
            Dim testata = New AgronicaCoreAnagrafeDAL.OTabelle_W
