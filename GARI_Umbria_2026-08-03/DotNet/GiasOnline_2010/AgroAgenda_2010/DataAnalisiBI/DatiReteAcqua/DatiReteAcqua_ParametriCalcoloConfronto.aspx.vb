...
Public Class DatiReteAcqua_ParametriCalcoloConfronto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ModalView As Boolean = HttpContext.Current.Session("ckViewModal")
        Me.Master.flag_MostraHeader = Not (ModalView)
        Me.Master.flag_MostraFooter = Not (ModalView)
        ...
        UtenteAbilitatoLettura = objPermessi.Controlla_Permessi_Utente(
                                            ...
                                            enum_Security_Attivita.ReteAcqua_Parametri,
    ...
    Private Sub DatiReteAcqua_ParametriCalcoloConfronto_Init(sender As Object, e As EventArgs) Handles Me.Init
