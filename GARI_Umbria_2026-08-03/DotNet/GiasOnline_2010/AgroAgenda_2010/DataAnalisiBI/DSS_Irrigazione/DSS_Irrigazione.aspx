<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/AgendaBootstrap.Master" 
    CodeBehind="DSS_Irrigazione.aspx.vb" Inherits="AgroAgenda_2010.DSS_Irrigazione" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <link href="DSS_Irrigazione.css?<% =Application("GiasVersioneCorrente")%>" rel="stylesheet"/>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentScript" runat="server">
    ...
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("DSS_Irrigazione_jQueryDocReady.js") %>"></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("DSS_Irrigazione.js") %>"></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("DSS_Irrigazione_ws_client.js") %>"></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("DSS_Irrigazione_WBResult.js") %>"></script>
