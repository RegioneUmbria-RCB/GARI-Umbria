<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/AgendaBootstrap.Master" 
    CodeBehind="DSS_Irrigazione_APP.aspx.vb" Inherits="AgroAgenda_2010.DSS_Irrigazione_APP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <link href="DSS_Irrigazione_APP.css?<% =Application("GiasVersioneCorrente")%>" rel="stylesheet"/>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentScript" runat="server">
    ...
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("DSS_Irrigazione_APP_jQueryDocReady.js") %>"></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("DSS_Irrigazione_APP.js") %>"></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("../DSS_Irrigazione/DSS_Irrigazione_ws_client.js") %>"></script>
    <script type="text/javascript" src="<%= AgronicaControlli_2010.Minify.LinkJsMin("../DSS_Irrigazione/DSS_Irrigazione_WBResult.js") %>"></script>
