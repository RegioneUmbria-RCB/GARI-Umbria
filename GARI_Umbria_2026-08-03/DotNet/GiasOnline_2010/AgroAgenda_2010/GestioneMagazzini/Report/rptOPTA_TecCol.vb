...
Public Class rptOPTA_TecCol
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgroAgenda_2010.rptOPTA_TecCol.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOPTA_TecCol
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOPTA_TecCol = New rptOPTA_TecCol()
        rpt.Site = Me.Site
        Return rpt
    End Function
