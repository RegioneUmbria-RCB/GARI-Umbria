...
Public Class rptOPTA_Colore
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgroAgenda_2010.rptOPTA_Colore.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOPTA_Colore
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOPTA_Colore = New rptOPTA_Colore()
        rpt.Site = Me.Site
        Return rpt
    End Function
