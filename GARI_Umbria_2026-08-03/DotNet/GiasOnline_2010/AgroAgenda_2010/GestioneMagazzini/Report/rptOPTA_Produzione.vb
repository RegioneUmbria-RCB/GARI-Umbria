...
Public Class rptOPTA_Produzione
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgroAgenda_2010.rptOPTA_Produzione.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOPTA_Produzione
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOPTA_Produzione = New rptOPTA_Produzione()
        rpt.Site = Me.Site
        Return rpt
    End Function
