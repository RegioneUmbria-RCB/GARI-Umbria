...
Public Class rptOPTA_Raccolta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgroAgenda_2010.rptOPTA_Raccolta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOPTA_Raccolta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOPTA_Raccolta = New rptOPTA_Raccolta()
        rpt.Site = Me.Site
        Return rpt
    End Function
