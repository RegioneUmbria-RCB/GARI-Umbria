...
Public Class RichiesteCancellazioni
    ...
    Public Shared Function Cancellazione(ByVal Email As String) As RispostaStandard
        ...
        Try
            ...
            Dim msg As String =
                "<h2>RICHIESTA CANCELLAZIONE UTENTE APP</h2><br/><h4>La tua richiesta è stata registrata</h4><br/><h4>Riceverai una mail di conferma di avvenuta cancellazione</h4><br><table><tr><th>Email</th><td>$email</td></tr></table>"

            msg = msg.Replace("$email", Email)

            Dim err = invia(objParametri_server, "service@agronicagroup.it", Email, "", "ufficiotecnico@diagramgroup.it", "Richiesta cancellazione utente app", msg, True, Nothing, "", "", "", "", "")
            If err <> "" Then
