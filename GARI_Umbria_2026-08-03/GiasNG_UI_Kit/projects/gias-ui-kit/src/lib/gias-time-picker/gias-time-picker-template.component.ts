...
import { FormatSettings, TimePickerComponent } from '@progress/kendo-angular-dateinputs';
...
@Component({
  standalone: false,
  selector: 'gias-time-picker-template',
  templateUrl: './gias-time-picker-template.component.html',
  styleUrls: ['./gias-time-picker-template.component.css'],
  viewProviders: [{
...
export class GiasTimePickerTemplateComponent implements OnInit {
  @ViewChild('datetimepicker') dateTimePicker: TimePickerComponent;
