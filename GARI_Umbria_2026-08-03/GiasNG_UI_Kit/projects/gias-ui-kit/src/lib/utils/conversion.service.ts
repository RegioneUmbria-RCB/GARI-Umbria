...
import { GIAS_MASTER_SERVICE_TOKEN, IGiasMasterService } from './gias-master.service';
import { AGRODATAINIZIO } from './models';
...
export class ConversionService {
  ...
  ConversionDateInObject<T>(object: T): T {
    ...
    if (this.giasMasterService.serverTimeZoneOffset != undefined && this.giasMasterService.serverTimeZoneOffset != "") {
      this.serverTimeZone = this.giasMasterService.serverTimeZoneOffset;
    }
      ...
      if (object[val] != null && object[val] !== undefined) {
        ...
        if (typeof object[val] == 'string' && (<string>object[val]).includes('Date(')) {
          ...
          if (dateVal != null && dateVal != undefined && (dateVal.getHours() != 0 || dateVal.getMinutes() != 0 || dateVal.getSeconds() != 0 || dateVal.getMilliseconds() != 0)) {
            ...
            dateVal = data;
          } else if ((<string>object[val]).length > 20 && ((<string>object[val])[19] == '+' || (<string>object[val])[19] == '-')) {
  ...
  ConversionDateInObjectNew<T>(object: T): T {
    ...
    fieldArray.forEach((val, i) => {
      ...
      if (object[val] != null && object[val] !== undefined) {
        ...
        if (typeof object[val] == 'string' && moment(<string>object[val], moment.ISO_8601, true).isValid() && isNaN(+object[val])) {
  ...
  private returnDateObjectField(object: any): { dateField: string[], objectField: string[] } {
    ...
    fieldArray.forEach((val, i) => {
      if (object[val] != null && object[val] !== undefined) {
        ...
        if (typeof object[val] == 'string' && moment(<string>object[val], moment.ISO_8601, true).isValid() && isNaN(+object[val])) {
          if ((this.giasMasterService.serverTimeZoneOffset == Intl.DateTimeFormat().resolvedOptions().timeZone) && (val.toString().toLowerCase() == 'data_creazione' || val.toString().toLowerCase() == 'data_modifica')) {

          } else {
            dateField.push(val);
          }
        } else if (typeof object[val] == 'string' && this.verifyMyDate(object[val]) && isNaN(+object[val])) {
          if ((this.giasMasterService.serverTimeZoneOffset == Intl.DateTimeFormat().resolvedOptions().timeZone) && (val.toString().toLowerCase() == 'data_creazione' || val.toString().toLowerCase() == 'data_modifica')) {
  ...
  public convertStringToDate(inputVal: string): Date {
    ...
    if (this.giasMasterService.serverTimeZoneOffset == Intl.DateTimeFormat().resolvedOptions().timeZone) {
      return dateVal;
    }
    if (dateVal != null && (dateVal.getHours() != 0 || dateVal.getMinutes() != 0 || dateVal.getSeconds() != 0 || dateVal.getMilliseconds() != 0)) {
