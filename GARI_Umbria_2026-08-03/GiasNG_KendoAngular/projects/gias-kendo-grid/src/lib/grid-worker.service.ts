...
export const GRID_WORKER_URL = new InjectionToken<string>('GRID_WORKER_URL');

@Injectable()
export class GridWorkerService implements IGridWorkerService {
  public resultsStore = {};
  ...
  constructor(
    ...
    @Inject(GRID_WORKER_URL) private gridWorkerUrl: string
  ) { }
